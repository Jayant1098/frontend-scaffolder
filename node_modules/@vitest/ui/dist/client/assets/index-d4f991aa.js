var lx=Object.defineProperty;var ax=(t,n,r)=>n in t?lx(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r;var Ni=(t,n,r)=>(ax(t,typeof n!="symbol"?n+"":n,r),r);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const u of a)if(u.type==="childList")for(const f of u.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&o(f)}).observe(document,{childList:!0,subtree:!0});function r(a){const u={};return a.integrity&&(u.integrity=a.integrity),a.referrerpolicy&&(u.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?u.credentials="include":a.crossorigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function o(a){if(a.ep)return;a.ep=!0;const u=r(a);fetch(a.href,u)}})();function Af(t,n){const r=Object.create(null),o=t.split(",");for(let a=0;a<o.length;a++)r[o[a]]=!0;return n?a=>!!r[a.toLowerCase()]:a=>!!r[a]}function kn(t){if(Ht(t)){const n={};for(let r=0;r<t.length;r++){const o=t[r],a=qe(o)?hx(o):kn(o);if(a)for(const u in a)n[u]=a[u]}return n}else{if(qe(t))return t;if(xe(t))return t}}const cx=/;(?![^(]*\))/g,ux=/:([^]+)/,fx=/\/\*.*?\*\//gs;function hx(t){const n={};return t.replace(fx,"").split(cx).forEach(r=>{if(r){const o=r.split(ux);o.length>1&&(n[o[0].trim()]=o[1].trim())}}),n}function ve(t){let n="";if(qe(t))n=t;else if(Ht(t))for(let r=0;r<t.length;r++){const o=ve(t[r]);o&&(n+=o+" ")}else if(xe(t))for(const r in t)t[r]&&(n+=r+" ");return n.trim()}const dx="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",px=Af(dx);function jv(t){return!!t||t===""}const Xt=t=>qe(t)?t:t==null?"":Ht(t)||xe(t)&&(t.toString===Xv||!Wt(t.toString))?JSON.stringify(t,Gv,2):String(t),Gv=(t,n)=>n&&n.__v_isRef?Gv(t,n.value):Mo(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((r,[o,a])=>(r[`${o} =>`]=a,r),{})}:Vv(n)?{[`Set(${n.size})`]:[...n.values()]}:xe(n)&&!Ht(n)&&!Yv(n)?String(n):n,we={},Ao=[],Xn=()=>{},gx=()=>!1,vx=/^on[^a-z]/,Ja=t=>vx.test(t),Mf=t=>t.startsWith("onUpdate:"),Ye=Object.assign,Nf=(t,n)=>{const r=t.indexOf(n);r>-1&&t.splice(r,1)},mx=Object.prototype.hasOwnProperty,ne=(t,n)=>mx.call(t,n),Ht=Array.isArray,Mo=t=>Qa(t)==="[object Map]",Vv=t=>Qa(t)==="[object Set]",Wt=t=>typeof t=="function",qe=t=>typeof t=="string",Of=t=>typeof t=="symbol",xe=t=>t!==null&&typeof t=="object",Kv=t=>xe(t)&&Wt(t.then)&&Wt(t.catch),Xv=Object.prototype.toString,Qa=t=>Xv.call(t),yx=t=>Qa(t).slice(8,-1),Yv=t=>Qa(t)==="[object Object]",Pf=t=>qe(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,va=Af(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),tc=t=>{const n=Object.create(null);return r=>n[r]||(n[r]=t(r))},bx=/-(\w)/g,hr=tc(t=>t.replace(bx,(n,r)=>r?r.toUpperCase():"")),wx=/\B([A-Z])/g,Zi=tc(t=>t.replace(wx,"-$1").toLowerCase()),ec=tc(t=>t.charAt(0).toUpperCase()+t.slice(1)),wu=tc(t=>t?`on${ec(t)}`:""),Xs=(t,n)=>!Object.is(t,n),ma=(t,n)=>{for(let r=0;r<t.length;r++)t[r](n)},Aa=(t,n,r)=>{Object.defineProperty(t,n,{configurable:!0,enumerable:!1,value:r})},Io=t=>{const n=parseFloat(t);return isNaN(n)?t:n};let Lp;const xx=()=>Lp||(Lp=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let Mn;class _x{constructor(n=!1){this.detached=n,this.active=!0,this.effects=[],this.cleanups=[],this.parent=Mn,!n&&Mn&&(this.index=(Mn.scopes||(Mn.scopes=[])).push(this)-1)}run(n){if(this.active){const r=Mn;try{return Mn=this,n()}finally{Mn=r}}}on(){Mn=this}off(){Mn=this.parent}stop(n){if(this.active){let r,o;for(r=0,o=this.effects.length;r<o;r++)this.effects[r].stop();for(r=0,o=this.cleanups.length;r<o;r++)this.cleanups[r]();if(this.scopes)for(r=0,o=this.scopes.length;r<o;r++)this.scopes[r].stop(!0);if(!this.detached&&this.parent&&!n){const a=this.parent.scopes.pop();a&&a!==this&&(this.parent.scopes[this.index]=a,a.index=this.index)}this.parent=void 0,this.active=!1}}}function Sx(t,n=Mn){n&&n.active&&n.effects.push(t)}function kx(){return Mn}function Cx(t){Mn&&Mn.cleanups.push(t)}const $f=t=>{const n=new Set(t);return n.w=0,n.n=0,n},Zv=t=>(t.w&pi)>0,Jv=t=>(t.n&pi)>0,Tx=({deps:t})=>{if(t.length)for(let n=0;n<t.length;n++)t[n].w|=pi},Lx=t=>{const{deps:n}=t;if(n.length){let r=0;for(let o=0;o<n.length;o++){const a=n[o];Zv(a)&&!Jv(a)?a.delete(t):n[r++]=a,a.w&=~pi,a.n&=~pi}n.length=r}},qu=new WeakMap;let Fs=0,pi=1;const Hu=30;let Gn;const Wi=Symbol(""),Bu=Symbol("");class Df{constructor(n,r=null,o){this.fn=n,this.scheduler=r,this.active=!0,this.deps=[],this.parent=void 0,Sx(this,o)}run(){if(!this.active)return this.fn();let n=Gn,r=fi;for(;n;){if(n===this)return;n=n.parent}try{return this.parent=Gn,Gn=this,fi=!0,pi=1<<++Fs,Fs<=Hu?Tx(this):Ep(this),this.fn()}finally{Fs<=Hu&&Lx(this),pi=1<<--Fs,Gn=this.parent,fi=r,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Gn===this?this.deferStop=!0:this.active&&(Ep(this),this.onStop&&this.onStop(),this.active=!1)}}function Ep(t){const{deps:n}=t;if(n.length){for(let r=0;r<n.length;r++)n[r].delete(t);n.length=0}}let fi=!0;const Qv=[];function Zo(){Qv.push(fi),fi=!1}function Jo(){const t=Qv.pop();fi=t===void 0?!0:t}function Pn(t,n,r){if(fi&&Gn){let o=qu.get(t);o||qu.set(t,o=new Map);let a=o.get(r);a||o.set(r,a=$f()),tm(a)}}function tm(t,n){let r=!1;Fs<=Hu?Jv(t)||(t.n|=pi,r=!Zv(t)):r=!t.has(Gn),r&&(t.add(Gn),Gn.deps.push(t))}function Dr(t,n,r,o,a,u){const f=qu.get(t);if(!f)return;let h=[];if(n==="clear")h=[...f.values()];else if(r==="length"&&Ht(t)){const d=Io(o);f.forEach((g,v)=>{(v==="length"||v>=d)&&h.push(g)})}else switch(r!==void 0&&h.push(f.get(r)),n){case"add":Ht(t)?Pf(r)&&h.push(f.get("length")):(h.push(f.get(Wi)),Mo(t)&&h.push(f.get(Bu)));break;case"delete":Ht(t)||(h.push(f.get(Wi)),Mo(t)&&h.push(f.get(Bu)));break;case"set":Mo(t)&&h.push(f.get(Wi));break}if(h.length===1)h[0]&&Wu(h[0]);else{const d=[];for(const g of h)g&&d.push(...g);Wu($f(d))}}function Wu(t,n){const r=Ht(t)?t:[...t];for(const o of r)o.computed&&Ap(o);for(const o of r)o.computed||Ap(o)}function Ap(t,n){(t!==Gn||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const Ex=Af("__proto__,__v_isRef,__isVue"),em=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Of)),Ax=Rf(),Mx=Rf(!1,!0),Nx=Rf(!0),Mp=Ox();function Ox(){const t={};return["includes","indexOf","lastIndexOf"].forEach(n=>{t[n]=function(...r){const o=ue(this);for(let u=0,f=this.length;u<f;u++)Pn(o,"get",u+"");const a=o[n](...r);return a===-1||a===!1?o[n](...r.map(ue)):a}}),["push","pop","shift","unshift","splice"].forEach(n=>{t[n]=function(...r){Zo();const o=ue(this)[n].apply(this,r);return Jo(),o}}),t}function Rf(t=!1,n=!1){return function(o,a,u){if(a==="__v_isReactive")return!t;if(a==="__v_isReadonly")return t;if(a==="__v_isShallow")return n;if(a==="__v_raw"&&u===(t?n?Kx:sm:n?om:im).get(o))return o;const f=Ht(o);if(!t&&f&&ne(Mp,a))return Reflect.get(Mp,a,u);const h=Reflect.get(o,a,u);return(Of(a)?em.has(a):Ex(a))||(t||Pn(o,"get",a),n)?h:Ee(h)?f&&Pf(a)?h:h.value:xe(h)?t?lm(h):On(h):h}}const Px=nm(),$x=nm(!0);function nm(t=!1){return function(r,o,a,u){let f=r[o];if(Fo(f)&&Ee(f)&&!Ee(a))return!1;if(!t&&(!Ma(a)&&!Fo(a)&&(f=ue(f),a=ue(a)),!Ht(r)&&Ee(f)&&!Ee(a)))return f.value=a,!0;const h=Ht(r)&&Pf(o)?Number(o)<r.length:ne(r,o),d=Reflect.set(r,o,a,u);return r===ue(u)&&(h?Xs(a,f)&&Dr(r,"set",o,a):Dr(r,"add",o,a)),d}}function Dx(t,n){const r=ne(t,n);t[n];const o=Reflect.deleteProperty(t,n);return o&&r&&Dr(t,"delete",n,void 0),o}function Rx(t,n){const r=Reflect.has(t,n);return(!Of(n)||!em.has(n))&&Pn(t,"has",n),r}function zx(t){return Pn(t,"iterate",Ht(t)?"length":Wi),Reflect.ownKeys(t)}const rm={get:Ax,set:Px,deleteProperty:Dx,has:Rx,ownKeys:zx},Ix={get:Nx,set(t,n){return!0},deleteProperty(t,n){return!0}},Fx=Ye({},rm,{get:Mx,set:$x}),zf=t=>t,nc=t=>Reflect.getPrototypeOf(t);function na(t,n,r=!1,o=!1){t=t.__v_raw;const a=ue(t),u=ue(n);r||(n!==u&&Pn(a,"get",n),Pn(a,"get",u));const{has:f}=nc(a),h=o?zf:r?Hf:Ys;if(f.call(a,n))return h(t.get(n));if(f.call(a,u))return h(t.get(u));t!==a&&t.get(n)}function ra(t,n=!1){const r=this.__v_raw,o=ue(r),a=ue(t);return n||(t!==a&&Pn(o,"has",t),Pn(o,"has",a)),t===a?r.has(t):r.has(t)||r.has(a)}function ia(t,n=!1){return t=t.__v_raw,!n&&Pn(ue(t),"iterate",Wi),Reflect.get(t,"size",t)}function Np(t){t=ue(t);const n=ue(this);return nc(n).has.call(n,t)||(n.add(t),Dr(n,"add",t,t)),this}function Op(t,n){n=ue(n);const r=ue(this),{has:o,get:a}=nc(r);let u=o.call(r,t);u||(t=ue(t),u=o.call(r,t));const f=a.call(r,t);return r.set(t,n),u?Xs(n,f)&&Dr(r,"set",t,n):Dr(r,"add",t,n),this}function Pp(t){const n=ue(this),{has:r,get:o}=nc(n);let a=r.call(n,t);a||(t=ue(t),a=r.call(n,t)),o&&o.call(n,t);const u=n.delete(t);return a&&Dr(n,"delete",t,void 0),u}function $p(){const t=ue(this),n=t.size!==0,r=t.clear();return n&&Dr(t,"clear",void 0,void 0),r}function oa(t,n){return function(o,a){const u=this,f=u.__v_raw,h=ue(f),d=n?zf:t?Hf:Ys;return!t&&Pn(h,"iterate",Wi),f.forEach((g,v)=>o.call(a,d(g),d(v),u))}}function sa(t,n,r){return function(...o){const a=this.__v_raw,u=ue(a),f=Mo(u),h=t==="entries"||t===Symbol.iterator&&f,d=t==="keys"&&f,g=a[t](...o),v=r?zf:n?Hf:Ys;return!n&&Pn(u,"iterate",d?Bu:Wi),{next(){const{value:b,done:w}=g.next();return w?{value:b,done:w}:{value:h?[v(b[0]),v(b[1])]:v(b),done:w}},[Symbol.iterator](){return this}}}}function ei(t){return function(...n){return t==="delete"?!1:this}}function qx(){const t={get(u){return na(this,u)},get size(){return ia(this)},has:ra,add:Np,set:Op,delete:Pp,clear:$p,forEach:oa(!1,!1)},n={get(u){return na(this,u,!1,!0)},get size(){return ia(this)},has:ra,add:Np,set:Op,delete:Pp,clear:$p,forEach:oa(!1,!0)},r={get(u){return na(this,u,!0)},get size(){return ia(this,!0)},has(u){return ra.call(this,u,!0)},add:ei("add"),set:ei("set"),delete:ei("delete"),clear:ei("clear"),forEach:oa(!0,!1)},o={get(u){return na(this,u,!0,!0)},get size(){return ia(this,!0)},has(u){return ra.call(this,u,!0)},add:ei("add"),set:ei("set"),delete:ei("delete"),clear:ei("clear"),forEach:oa(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(u=>{t[u]=sa(u,!1,!1),r[u]=sa(u,!0,!1),n[u]=sa(u,!1,!0),o[u]=sa(u,!0,!0)}),[t,r,n,o]}const[Hx,Bx,Wx,Ux]=qx();function If(t,n){const r=n?t?Ux:Wx:t?Bx:Hx;return(o,a,u)=>a==="__v_isReactive"?!t:a==="__v_isReadonly"?t:a==="__v_raw"?o:Reflect.get(ne(r,a)&&a in o?r:o,a,u)}const jx={get:If(!1,!1)},Gx={get:If(!1,!0)},Vx={get:If(!0,!1)},im=new WeakMap,om=new WeakMap,sm=new WeakMap,Kx=new WeakMap;function Xx(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Yx(t){return t.__v_skip||!Object.isExtensible(t)?0:Xx(yx(t))}function On(t){return Fo(t)?t:Ff(t,!1,rm,jx,im)}function Zx(t){return Ff(t,!1,Fx,Gx,om)}function lm(t){return Ff(t,!0,Ix,Vx,sm)}function Ff(t,n,r,o,a){if(!xe(t)||t.__v_raw&&!(n&&t.__v_isReactive))return t;const u=a.get(t);if(u)return u;const f=Yx(t);if(f===0)return t;const h=new Proxy(t,f===2?o:r);return a.set(t,h),h}function No(t){return Fo(t)?No(t.__v_raw):!!(t&&t.__v_isReactive)}function Fo(t){return!!(t&&t.__v_isReadonly)}function Ma(t){return!!(t&&t.__v_isShallow)}function am(t){return No(t)||Fo(t)}function ue(t){const n=t&&t.__v_raw;return n?ue(n):t}function qf(t){return Aa(t,"__v_skip",!0),t}const Ys=t=>xe(t)?On(t):t,Hf=t=>xe(t)?lm(t):t;function cm(t){fi&&Gn&&(t=ue(t),tm(t.dep||(t.dep=$f())))}function um(t,n){t=ue(t),t.dep&&Wu(t.dep)}function Ee(t){return!!(t&&t.__v_isRef===!0)}function Kt(t){return fm(t,!1)}function fl(t){return fm(t,!0)}function fm(t,n){return Ee(t)?t:new Jx(t,n)}class Jx{constructor(n,r){this.__v_isShallow=r,this.dep=void 0,this.__v_isRef=!0,this._rawValue=r?n:ue(n),this._value=r?n:Ys(n)}get value(){return cm(this),this._value}set value(n){const r=this.__v_isShallow||Ma(n)||Fo(n);n=r?n:ue(n),Xs(n,this._rawValue)&&(this._rawValue=n,this._value=r?n:Ys(n),um(this))}}function j(t){return Ee(t)?t.value:t}const Qx={get:(t,n,r)=>j(Reflect.get(t,n,r)),set:(t,n,r,o)=>{const a=t[n];return Ee(a)&&!Ee(r)?(a.value=r,!0):Reflect.set(t,n,r,o)}};function hm(t){return No(t)?t:new Proxy(t,Qx)}function t1(t){const n=Ht(t)?new Array(t.length):{};for(const r in t)n[r]=Bf(t,r);return n}class e1{constructor(n,r,o){this._object=n,this._key=r,this._defaultValue=o,this.__v_isRef=!0}get value(){const n=this._object[this._key];return n===void 0?this._defaultValue:n}set value(n){this._object[this._key]=n}}function Bf(t,n,r){const o=t[n];return Ee(o)?o:new e1(t,n,r)}var dm;class n1{constructor(n,r,o,a){this._setter=r,this.dep=void 0,this.__v_isRef=!0,this[dm]=!1,this._dirty=!0,this.effect=new Df(n,()=>{this._dirty||(this._dirty=!0,um(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!a,this.__v_isReadonly=o}get value(){const n=ue(this);return cm(n),(n._dirty||!n._cacheable)&&(n._dirty=!1,n._value=n.effect.run()),n._value}set value(n){this._setter(n)}}dm="__v_isReadonly";function r1(t,n,r=!1){let o,a;const u=Wt(t);return u?(o=t,a=Xn):(o=t.get,a=t.set),new n1(o,a,u||!a,r)}function hi(t,n,r,o){let a;try{a=o?t(...o):t()}catch(u){hl(u,n,r)}return a}function Fn(t,n,r,o){if(Wt(t)){const u=hi(t,n,r,o);return u&&Kv(u)&&u.catch(f=>{hl(f,n,r)}),u}const a=[];for(let u=0;u<t.length;u++)a.push(Fn(t[u],n,r,o));return a}function hl(t,n,r,o=!0){const a=n?n.vnode:null;if(n){let u=n.parent;const f=n.proxy,h=r;for(;u;){const g=u.ec;if(g){for(let v=0;v<g.length;v++)if(g[v](t,f,h)===!1)return}u=u.parent}const d=n.appContext.config.errorHandler;if(d){hi(d,null,10,[t,f,h]);return}}i1(t,r,a,o)}function i1(t,n,r,o=!0){console.error(t)}let Zs=!1,Uu=!1;const en=[];let ar=0;const Oo=[];let Er=null,Ii=0;const pm=Promise.resolve();let Wf=null;function Qo(t){const n=Wf||pm;return t?n.then(this?t.bind(this):t):n}function o1(t){let n=ar+1,r=en.length;for(;n<r;){const o=n+r>>>1;Js(en[o])<t?n=o+1:r=o}return n}function Uf(t){(!en.length||!en.includes(t,Zs&&t.allowRecurse?ar+1:ar))&&(t.id==null?en.push(t):en.splice(o1(t.id),0,t),gm())}function gm(){!Zs&&!Uu&&(Uu=!0,Wf=pm.then(ym))}function s1(t){const n=en.indexOf(t);n>ar&&en.splice(n,1)}function vm(t){Ht(t)?Oo.push(...t):(!Er||!Er.includes(t,t.allowRecurse?Ii+1:Ii))&&Oo.push(t),gm()}function Dp(t,n=Zs?ar+1:0){for(;n<en.length;n++){const r=en[n];r&&r.pre&&(en.splice(n,1),n--,r())}}function mm(t){if(Oo.length){const n=[...new Set(Oo)];if(Oo.length=0,Er){Er.push(...n);return}for(Er=n,Er.sort((r,o)=>Js(r)-Js(o)),Ii=0;Ii<Er.length;Ii++)Er[Ii]();Er=null,Ii=0}}const Js=t=>t.id==null?1/0:t.id,l1=(t,n)=>{const r=Js(t)-Js(n);if(r===0){if(t.pre&&!n.pre)return-1;if(n.pre&&!t.pre)return 1}return r};function ym(t){Uu=!1,Zs=!0,en.sort(l1);const n=Xn;try{for(ar=0;ar<en.length;ar++){const r=en[ar];r&&r.active!==!1&&hi(r,null,14)}}finally{ar=0,en.length=0,mm(),Zs=!1,Wf=null,(en.length||Oo.length)&&ym()}}function a1(t,n,...r){if(t.isUnmounted)return;const o=t.vnode.props||we;let a=r;const u=n.startsWith("update:"),f=u&&n.slice(7);if(f&&f in o){const v=`${f==="modelValue"?"model":f}Modifiers`,{number:b,trim:w}=o[v]||we;w&&(a=r.map(S=>qe(S)?S.trim():S)),b&&(a=r.map(Io))}let h,d=o[h=wu(n)]||o[h=wu(hr(n))];!d&&u&&(d=o[h=wu(Zi(n))]),d&&Fn(d,t,6,a);const g=o[h+"Once"];if(g){if(!t.emitted)t.emitted={};else if(t.emitted[h])return;t.emitted[h]=!0,Fn(g,t,6,a)}}function bm(t,n,r=!1){const o=n.emitsCache,a=o.get(t);if(a!==void 0)return a;const u=t.emits;let f={},h=!1;if(!Wt(t)){const d=g=>{const v=bm(g,n,!0);v&&(h=!0,Ye(f,v))};!r&&n.mixins.length&&n.mixins.forEach(d),t.extends&&d(t.extends),t.mixins&&t.mixins.forEach(d)}return!u&&!h?(xe(t)&&o.set(t,null),null):(Ht(u)?u.forEach(d=>f[d]=null):Ye(f,u),xe(t)&&o.set(t,f),f)}function rc(t,n){return!t||!Ja(n)?!1:(n=n.slice(2).replace(/Once$/,""),ne(t,n[0].toLowerCase()+n.slice(1))||ne(t,Zi(n))||ne(t,n))}let Xe=null,ic=null;function Na(t){const n=Xe;return Xe=t,ic=t&&t.type.__scopeId||null,n}function wm(t){ic=t}function xm(){ic=null}const c1=t=>Zt;function Zt(t,n=Xe,r){if(!n||t._n)return t;const o=(...a)=>{o._d&&Gp(-1);const u=Na(n);let f;try{f=t(...a)}finally{Na(u),o._d&&Gp(1)}return f};return o._n=!0,o._c=!0,o._d=!0,o}function xu(t){const{type:n,vnode:r,proxy:o,withProxy:a,props:u,propsOptions:[f],slots:h,attrs:d,emit:g,render:v,renderCache:b,data:w,setupState:S,ctx:M,inheritAttrs:A}=t;let E,T;const L=Na(t);try{if(r.shapeFlag&4){const P=a||o;E=jn(v.call(P,P,b,u,S,w,M)),T=d}else{const P=n;E=jn(P.length>1?P(u,{attrs:d,slots:h,emit:g}):P(u,null)),T=n.props?d:f1(d)}}catch(P){Us.length=0,hl(P,t,1),E=zt(Cn)}let $=E;if(T&&A!==!1){const P=Object.keys(T),{shapeFlag:G}=$;P.length&&G&7&&(f&&P.some(Mf)&&(T=h1(T,f)),$=gi($,T))}return r.dirs&&($=gi($),$.dirs=$.dirs?$.dirs.concat(r.dirs):r.dirs),r.transition&&($.transition=r.transition),E=$,Na(L),E}function u1(t){let n;for(let r=0;r<t.length;r++){const o=t[r];if(tl(o)){if(o.type!==Cn||o.children==="v-if"){if(n)return;n=o}}else return}return n}const f1=t=>{let n;for(const r in t)(r==="class"||r==="style"||Ja(r))&&((n||(n={}))[r]=t[r]);return n},h1=(t,n)=>{const r={};for(const o in t)(!Mf(o)||!(o.slice(9)in n))&&(r[o]=t[o]);return r};function d1(t,n,r){const{props:o,children:a,component:u}=t,{props:f,children:h,patchFlag:d}=n,g=u.emitsOptions;if(n.dirs||n.transition)return!0;if(r&&d>=0){if(d&1024)return!0;if(d&16)return o?Rp(o,f,g):!!f;if(d&8){const v=n.dynamicProps;for(let b=0;b<v.length;b++){const w=v[b];if(f[w]!==o[w]&&!rc(g,w))return!0}}}else return(a||h)&&(!h||!h.$stable)?!0:o===f?!1:o?f?Rp(o,f,g):!0:!!f;return!1}function Rp(t,n,r){const o=Object.keys(n);if(o.length!==Object.keys(t).length)return!0;for(let a=0;a<o.length;a++){const u=o[a];if(n[u]!==t[u]&&!rc(r,u))return!0}return!1}function jf({vnode:t,parent:n},r){for(;n&&n.subTree===t;)(t=n.vnode).el=r,n=n.parent}const p1=t=>t.__isSuspense,g1={name:"Suspense",__isSuspense:!0,process(t,n,r,o,a,u,f,h,d,g){t==null?m1(n,r,o,a,u,f,h,d,g):y1(t,n,r,o,a,f,h,d,g)},hydrate:b1,create:Gf,normalize:w1},v1=g1;function Qs(t,n){const r=t.props&&t.props[n];Wt(r)&&r()}function m1(t,n,r,o,a,u,f,h,d){const{p:g,o:{createElement:v}}=d,b=v("div"),w=t.suspense=Gf(t,a,o,n,b,r,u,f,h,d);g(null,w.pendingBranch=t.ssContent,b,null,o,w,u,f),w.deps>0?(Qs(t,"onPending"),Qs(t,"onFallback"),g(null,t.ssFallback,n,r,o,null,u,f),Po(w,t.ssFallback)):w.resolve()}function y1(t,n,r,o,a,u,f,h,{p:d,um:g,o:{createElement:v}}){const b=n.suspense=t.suspense;b.vnode=n,n.el=t.el;const w=n.ssContent,S=n.ssFallback,{activeBranch:M,pendingBranch:A,isInFallback:E,isHydrating:T}=b;if(A)b.pendingBranch=w,cr(w,A)?(d(A,w,b.hiddenContainer,null,a,b,u,f,h),b.deps<=0?b.resolve():E&&(d(M,S,r,o,a,null,u,f,h),Po(b,S))):(b.pendingId++,T?(b.isHydrating=!1,b.activeBranch=A):g(A,a,b),b.deps=0,b.effects.length=0,b.hiddenContainer=v("div"),E?(d(null,w,b.hiddenContainer,null,a,b,u,f,h),b.deps<=0?b.resolve():(d(M,S,r,o,a,null,u,f,h),Po(b,S))):M&&cr(w,M)?(d(M,w,r,o,a,b,u,f,h),b.resolve(!0)):(d(null,w,b.hiddenContainer,null,a,b,u,f,h),b.deps<=0&&b.resolve()));else if(M&&cr(w,M))d(M,w,r,o,a,b,u,f,h),Po(b,w);else if(Qs(n,"onPending"),b.pendingBranch=w,b.pendingId++,d(null,w,b.hiddenContainer,null,a,b,u,f,h),b.deps<=0)b.resolve();else{const{timeout:L,pendingId:$}=b;L>0?setTimeout(()=>{b.pendingId===$&&b.fallback(S)},L):L===0&&b.fallback(S)}}function Gf(t,n,r,o,a,u,f,h,d,g,v=!1){const{p:b,m:w,um:S,n:M,o:{parentNode:A,remove:E}}=g,T=Io(t.props&&t.props.timeout),L={vnode:t,parent:n,parentComponent:r,isSVG:f,container:o,hiddenContainer:a,anchor:u,deps:0,pendingId:0,timeout:typeof T=="number"?T:-1,activeBranch:null,pendingBranch:null,isInFallback:!0,isHydrating:v,isUnmounted:!1,effects:[],resolve($=!1){const{vnode:P,activeBranch:G,pendingBranch:V,pendingId:rt,effects:J,parentComponent:dt,container:gt}=L;if(L.isHydrating)L.isHydrating=!1;else if(!$){const U=G&&V.transition&&V.transition.mode==="out-in";U&&(G.transition.afterLeave=()=>{rt===L.pendingId&&w(V,gt,z,0)});let{anchor:z}=L;G&&(z=M(G),S(G,dt,L,!0)),U||w(V,gt,z,0)}Po(L,V),L.pendingBranch=null,L.isInFallback=!1;let kt=L.parent,ut=!1;for(;kt;){if(kt.pendingBranch){kt.effects.push(...J),ut=!0;break}kt=kt.parent}ut||vm(J),L.effects=[],Qs(P,"onResolve")},fallback($){if(!L.pendingBranch)return;const{vnode:P,activeBranch:G,parentComponent:V,container:rt,isSVG:J}=L;Qs(P,"onFallback");const dt=M(G),gt=()=>{!L.isInFallback||(b(null,$,rt,dt,V,null,J,h,d),Po(L,$))},kt=$.transition&&$.transition.mode==="out-in";kt&&(G.transition.afterLeave=gt),L.isInFallback=!0,S(G,V,null,!0),kt||gt()},move($,P,G){L.activeBranch&&w(L.activeBranch,$,P,G),L.container=$},next(){return L.activeBranch&&M(L.activeBranch)},registerDep($,P){const G=!!L.pendingBranch;G&&L.deps++;const V=$.vnode.el;$.asyncDep.catch(rt=>{hl(rt,$,0)}).then(rt=>{if($.isUnmounted||L.isUnmounted||L.pendingId!==$.suspenseId)return;$.asyncResolved=!0;const{vnode:J}=$;Ju($,rt,!1),V&&(J.el=V);const dt=!V&&$.subTree.el;P($,J,A(V||$.subTree.el),V?null:M($.subTree),L,f,d),dt&&E(dt),jf($,J.el),G&&--L.deps===0&&L.resolve()})},unmount($,P){L.isUnmounted=!0,L.activeBranch&&S(L.activeBranch,r,$,P),L.pendingBranch&&S(L.pendingBranch,r,$,P)}};return L}function b1(t,n,r,o,a,u,f,h,d){const g=n.suspense=Gf(n,o,r,t.parentNode,document.createElement("div"),null,a,u,f,h,!0),v=d(t,g.pendingBranch=n.ssContent,r,g,u,f);return g.deps===0&&g.resolve(),v}function w1(t){const{shapeFlag:n,children:r}=t,o=n&32;t.ssContent=zp(o?r.default:r),t.ssFallback=o?zp(r.fallback):zt(Cn)}function zp(t){let n;if(Wt(t)){const r=qo&&t._c;r&&(t._d=!1,at()),t=t(),r&&(t._d=!0,n=In,Fm())}return Ht(t)&&(t=u1(t)),t=jn(t),n&&!t.dynamicChildren&&(t.dynamicChildren=n.filter(r=>r!==t)),t}function x1(t,n){n&&n.pendingBranch?Ht(t)?n.effects.push(...t):n.effects.push(t):vm(t)}function Po(t,n){t.activeBranch=n;const{vnode:r,parentComponent:o}=t,a=r.el=n.el;o&&o.subTree===r&&(o.vnode.el=a,jf(o,a))}function ya(t,n){if(We){let r=We.provides;const o=We.parent&&We.parent.provides;o===r&&(r=We.provides=Object.create(o)),r[t]=n}}function Pr(t,n,r=!1){const o=We||Xe;if(o){const a=o.parent==null?o.vnode.appContext&&o.vnode.appContext.provides:o.parent.provides;if(a&&t in a)return a[t];if(arguments.length>1)return r&&Wt(n)?n.call(o.proxy):n}}function Vf(t,n){return Kf(t,null,n)}const la={};function Fe(t,n,r){return Kf(t,n,r)}function Kf(t,n,{immediate:r,deep:o,flush:a,onTrack:u,onTrigger:f}=we){const h=We;let d,g=!1,v=!1;if(Ee(t)?(d=()=>t.value,g=Ma(t)):No(t)?(d=()=>t,o=!0):Ht(t)?(v=!0,g=t.some($=>No($)||Ma($)),d=()=>t.map($=>{if(Ee($))return $.value;if(No($))return qi($);if(Wt($))return hi($,h,2)})):Wt(t)?n?d=()=>hi(t,h,2):d=()=>{if(!(h&&h.isUnmounted))return b&&b(),Fn(t,h,3,[w])}:d=Xn,n&&o){const $=d;d=()=>qi($())}let b,w=$=>{b=T.onStop=()=>{hi($,h,4)}},S;if(el)if(w=Xn,n?r&&Fn(n,h,3,[d(),v?[]:void 0,w]):d(),a==="sync"){const $=d_();S=$.__watcherHandles||($.__watcherHandles=[])}else return Xn;let M=v?new Array(t.length).fill(la):la;const A=()=>{if(!!T.active)if(n){const $=T.run();(o||g||(v?$.some((P,G)=>Xs(P,M[G])):Xs($,M)))&&(b&&b(),Fn(n,h,3,[$,M===la?void 0:v&&M[0]===la?[]:M,w]),M=$)}else T.run()};A.allowRecurse=!!n;let E;a==="sync"?E=A:a==="post"?E=()=>xn(A,h&&h.suspense):(A.pre=!0,h&&(A.id=h.uid),E=()=>Uf(A));const T=new Df(d,E);n?r?A():M=T.run():a==="post"?xn(T.run.bind(T),h&&h.suspense):T.run();const L=()=>{T.stop(),h&&h.scope&&Nf(h.scope.effects,T)};return S&&S.push(L),L}function _1(t,n,r){const o=this.proxy,a=qe(t)?t.includes(".")?_m(o,t):()=>o[t]:t.bind(o,o);let u;Wt(n)?u=n:(u=n.handler,r=n);const f=We;Ho(this);const h=Kf(a,u.bind(o),r);return f?Ho(f):Ui(),h}function _m(t,n){const r=n.split(".");return()=>{let o=t;for(let a=0;a<r.length&&o;a++)o=o[r[a]];return o}}function qi(t,n){if(!xe(t)||t.__v_skip||(n=n||new Set,n.has(t)))return t;if(n.add(t),Ee(t))qi(t.value,n);else if(Ht(t))for(let r=0;r<t.length;r++)qi(t[r],n);else if(Vv(t)||Mo(t))t.forEach(r=>{qi(r,n)});else if(Yv(t))for(const r in t)qi(t[r],n);return t}function S1(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return dl(()=>{t.isMounted=!0}),Lm(()=>{t.isUnmounting=!0}),t}const zn=[Function,Array],k1={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:zn,onEnter:zn,onAfterEnter:zn,onEnterCancelled:zn,onBeforeLeave:zn,onLeave:zn,onAfterLeave:zn,onLeaveCancelled:zn,onBeforeAppear:zn,onAppear:zn,onAfterAppear:zn,onAppearCancelled:zn},setup(t,{slots:n}){const r=cc(),o=S1();let a;return()=>{const u=n.default&&Cm(n.default(),!0);if(!u||!u.length)return;let f=u[0];if(u.length>1){for(const A of u)if(A.type!==Cn){f=A;break}}const h=ue(t),{mode:d}=h;if(o.isLeaving)return _u(f);const g=Ip(f);if(!g)return _u(f);const v=ju(g,h,o,r);Gu(g,v);const b=r.subTree,w=b&&Ip(b);let S=!1;const{getTransitionKey:M}=g.type;if(M){const A=M();a===void 0?a=A:A!==a&&(a=A,S=!0)}if(w&&w.type!==Cn&&(!cr(g,w)||S)){const A=ju(w,h,o,r);if(Gu(w,A),d==="out-in")return o.isLeaving=!0,A.afterLeave=()=>{o.isLeaving=!1,r.update.active!==!1&&r.update()},_u(f);d==="in-out"&&g.type!==Cn&&(A.delayLeave=(E,T,L)=>{const $=km(o,w);$[String(w.key)]=w,E._leaveCb=()=>{T(),E._leaveCb=void 0,delete v.delayedLeave},v.delayedLeave=L})}return f}}},Sm=k1;function km(t,n){const{leavingVNodes:r}=t;let o=r.get(n.type);return o||(o=Object.create(null),r.set(n.type,o)),o}function ju(t,n,r,o){const{appear:a,mode:u,persisted:f=!1,onBeforeEnter:h,onEnter:d,onAfterEnter:g,onEnterCancelled:v,onBeforeLeave:b,onLeave:w,onAfterLeave:S,onLeaveCancelled:M,onBeforeAppear:A,onAppear:E,onAfterAppear:T,onAppearCancelled:L}=n,$=String(t.key),P=km(r,t),G=(J,dt)=>{J&&Fn(J,o,9,dt)},V=(J,dt)=>{const gt=dt[1];G(J,dt),Ht(J)?J.every(kt=>kt.length<=1)&&gt():J.length<=1&&gt()},rt={mode:u,persisted:f,beforeEnter(J){let dt=h;if(!r.isMounted)if(a)dt=A||h;else return;J._leaveCb&&J._leaveCb(!0);const gt=P[$];gt&&cr(t,gt)&&gt.el._leaveCb&&gt.el._leaveCb(),G(dt,[J])},enter(J){let dt=d,gt=g,kt=v;if(!r.isMounted)if(a)dt=E||d,gt=T||g,kt=L||v;else return;let ut=!1;const U=J._enterCb=z=>{ut||(ut=!0,z?G(kt,[J]):G(gt,[J]),rt.delayedLeave&&rt.delayedLeave(),J._enterCb=void 0)};dt?V(dt,[J,U]):U()},leave(J,dt){const gt=String(t.key);if(J._enterCb&&J._enterCb(!0),r.isUnmounting)return dt();G(b,[J]);let kt=!1;const ut=J._leaveCb=U=>{kt||(kt=!0,dt(),U?G(M,[J]):G(S,[J]),J._leaveCb=void 0,P[gt]===t&&delete P[gt])};P[gt]=t,w?V(w,[J,ut]):ut()},clone(J){return ju(J,n,r,o)}};return rt}function _u(t){if(oc(t))return t=gi(t),t.children=null,t}function Ip(t){return oc(t)?t.children?t.children[0]:void 0:t}function Gu(t,n){t.shapeFlag&6&&t.component?Gu(t.component.subTree,n):t.shapeFlag&128?(t.ssContent.transition=n.clone(t.ssContent),t.ssFallback.transition=n.clone(t.ssFallback)):t.transition=n}function Cm(t,n=!1,r){let o=[],a=0;for(let u=0;u<t.length;u++){let f=t[u];const h=r==null?f.key:String(r)+String(f.key!=null?f.key:u);f.type===ce?(f.patchFlag&128&&a++,o=o.concat(Cm(f.children,n,h))):(n||f.type!==Cn)&&o.push(h!=null?gi(f,{key:h}):f)}if(a>1)for(let u=0;u<o.length;u++)o[u].patchFlag=-2;return o}function re(t){return Wt(t)?{setup:t,name:t.name}:t}const Bs=t=>!!t.type.__asyncLoader,oc=t=>t.type.__isKeepAlive;function C1(t,n){Tm(t,"a",n)}function T1(t,n){Tm(t,"da",n)}function Tm(t,n,r=We){const o=t.__wdc||(t.__wdc=()=>{let a=r;for(;a;){if(a.isDeactivated)return;a=a.parent}return t()});if(sc(n,o,r),r){let a=r.parent;for(;a&&a.parent;)oc(a.parent.vnode)&&L1(o,n,r,a),a=a.parent}}function L1(t,n,r,o){const a=sc(n,t,o,!0);Xf(()=>{Nf(o[n],a)},r)}function sc(t,n,r=We,o=!1){if(r){const a=r[t]||(r[t]=[]),u=n.__weh||(n.__weh=(...f)=>{if(r.isUnmounted)return;Zo(),Ho(r);const h=Fn(n,r,t,f);return Ui(),Jo(),h});return o?a.unshift(u):a.push(u),u}}const qr=t=>(n,r=We)=>(!el||t==="sp")&&sc(t,(...o)=>n(...o),r),E1=qr("bm"),dl=qr("m"),A1=qr("bu"),M1=qr("u"),Lm=qr("bum"),Xf=qr("um"),N1=qr("sp"),O1=qr("rtg"),P1=qr("rtc");function $1(t,n=We){sc("ec",t,n)}function pn(t,n){const r=Xe;if(r===null)return t;const o=uc(r)||r.proxy,a=t.dirs||(t.dirs=[]);for(let u=0;u<n.length;u++){let[f,h,d,g=we]=n[u];f&&(Wt(f)&&(f={mounted:f,updated:f}),f.deep&&qi(h),a.push({dir:f,instance:o,value:h,oldValue:void 0,arg:d,modifiers:g}))}return t}function Oi(t,n,r,o){const a=t.dirs,u=n&&n.dirs;for(let f=0;f<a.length;f++){const h=a[f];u&&(h.oldValue=u[f].value);let d=h.dir[o];d&&(Zo(),Fn(d,r,8,[t.el,h,t,n]),Jo())}}const Em="components",D1="directives";function Vi(t,n){return Am(Em,t,!0,n)||t}const R1=Symbol();function Ji(t){return Am(D1,t)}function Am(t,n,r=!0,o=!1){const a=Xe||We;if(a){const u=a.type;if(t===Em){const h=a_(u,!1);if(h&&(h===n||h===hr(n)||h===ec(hr(n))))return u}const f=Fp(a[t]||u[t],n)||Fp(a.appContext[t],n);return!f&&o?u:f}}function Fp(t,n){return t&&(t[n]||t[hr(n)]||t[ec(hr(n))])}function Vn(t,n,r,o){let a;const u=r&&r[o];if(Ht(t)||qe(t)){a=new Array(t.length);for(let f=0,h=t.length;f<h;f++)a[f]=n(t[f],f,void 0,u&&u[f])}else if(typeof t=="number"){a=new Array(t);for(let f=0;f<t;f++)a[f]=n(f+1,f,void 0,u&&u[f])}else if(xe(t))if(t[Symbol.iterator])a=Array.from(t,(f,h)=>n(f,h,void 0,u&&u[h]));else{const f=Object.keys(t);a=new Array(f.length);for(let h=0,d=f.length;h<d;h++){const g=f[h];a[h]=n(t[g],g,h,u&&u[h])}}else a=[];return r&&(r[o]=a),a}function Yn(t,n,r={},o,a){if(Xe.isCE||Xe.parent&&Bs(Xe.parent)&&Xe.parent.isCE)return n!=="default"&&(r.name=n),zt("slot",r,o&&o());let u=t[n];u&&u._c&&(u._d=!1),at();const f=u&&Mm(u(r)),h=Qt(ce,{key:r.key||f&&f.key||`_${n}`},f||(o?o():[]),f&&t._===1?64:-2);return!a&&h.scopeId&&(h.slotScopeIds=[h.scopeId+"-s"]),u&&u._c&&(u._d=!0),h}function Mm(t){return t.some(n=>tl(n)?!(n.type===Cn||n.type===ce&&!Mm(n.children)):!0)?t:null}const Vu=t=>t?Bm(t)?uc(t)||t.proxy:Vu(t.parent):null,Ws=Ye(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Vu(t.parent),$root:t=>Vu(t.root),$emit:t=>t.emit,$options:t=>Yf(t),$forceUpdate:t=>t.f||(t.f=()=>Uf(t.update)),$nextTick:t=>t.n||(t.n=Qo.bind(t.proxy)),$watch:t=>_1.bind(t)}),Su=(t,n)=>t!==we&&!t.__isScriptSetup&&ne(t,n),z1={get({_:t},n){const{ctx:r,setupState:o,data:a,props:u,accessCache:f,type:h,appContext:d}=t;let g;if(n[0]!=="$"){const S=f[n];if(S!==void 0)switch(S){case 1:return o[n];case 2:return a[n];case 4:return r[n];case 3:return u[n]}else{if(Su(o,n))return f[n]=1,o[n];if(a!==we&&ne(a,n))return f[n]=2,a[n];if((g=t.propsOptions[0])&&ne(g,n))return f[n]=3,u[n];if(r!==we&&ne(r,n))return f[n]=4,r[n];Ku&&(f[n]=0)}}const v=Ws[n];let b,w;if(v)return n==="$attrs"&&Pn(t,"get",n),v(t);if((b=h.__cssModules)&&(b=b[n]))return b;if(r!==we&&ne(r,n))return f[n]=4,r[n];if(w=d.config.globalProperties,ne(w,n))return w[n]},set({_:t},n,r){const{data:o,setupState:a,ctx:u}=t;return Su(a,n)?(a[n]=r,!0):o!==we&&ne(o,n)?(o[n]=r,!0):ne(t.props,n)||n[0]==="$"&&n.slice(1)in t?!1:(u[n]=r,!0)},has({_:{data:t,setupState:n,accessCache:r,ctx:o,appContext:a,propsOptions:u}},f){let h;return!!r[f]||t!==we&&ne(t,f)||Su(n,f)||(h=u[0])&&ne(h,f)||ne(o,f)||ne(Ws,f)||ne(a.config.globalProperties,f)},defineProperty(t,n,r){return r.get!=null?t._.accessCache[n]=0:ne(r,"value")&&this.set(t,n,r.value,null),Reflect.defineProperty(t,n,r)}};let Ku=!0;function I1(t){const n=Yf(t),r=t.proxy,o=t.ctx;Ku=!1,n.beforeCreate&&qp(n.beforeCreate,t,"bc");const{data:a,computed:u,methods:f,watch:h,provide:d,inject:g,created:v,beforeMount:b,mounted:w,beforeUpdate:S,updated:M,activated:A,deactivated:E,beforeDestroy:T,beforeUnmount:L,destroyed:$,unmounted:P,render:G,renderTracked:V,renderTriggered:rt,errorCaptured:J,serverPrefetch:dt,expose:gt,inheritAttrs:kt,components:ut,directives:U,filters:z}=n;if(g&&F1(g,o,null,t.appContext.config.unwrapInjectedRef),f)for(const W in f){const et=f[W];Wt(et)&&(o[W]=et.bind(r))}if(a){const W=a.call(r,r);xe(W)&&(t.data=On(W))}if(Ku=!0,u)for(const W in u){const et=u[W],wt=Wt(et)?et.bind(r,r):Wt(et.get)?et.get.bind(r,r):Xn,At=!Wt(et)&&Wt(et.set)?et.set.bind(r):Xn,qt=_t({get:wt,set:At});Object.defineProperty(o,W,{enumerable:!0,configurable:!0,get:()=>qt.value,set:Bt=>qt.value=Bt})}if(h)for(const W in h)Nm(h[W],o,r,W);if(d){const W=Wt(d)?d.call(r):d;Reflect.ownKeys(W).forEach(et=>{ya(et,W[et])})}v&&qp(v,t,"c");function H(W,et){Ht(et)?et.forEach(wt=>W(wt.bind(r))):et&&W(et.bind(r))}if(H(E1,b),H(dl,w),H(A1,S),H(M1,M),H(C1,A),H(T1,E),H($1,J),H(P1,V),H(O1,rt),H(Lm,L),H(Xf,P),H(N1,dt),Ht(gt))if(gt.length){const W=t.exposed||(t.exposed={});gt.forEach(et=>{Object.defineProperty(W,et,{get:()=>r[et],set:wt=>r[et]=wt})})}else t.exposed||(t.exposed={});G&&t.render===Xn&&(t.render=G),kt!=null&&(t.inheritAttrs=kt),ut&&(t.components=ut),U&&(t.directives=U)}function F1(t,n,r=Xn,o=!1){Ht(t)&&(t=Xu(t));for(const a in t){const u=t[a];let f;xe(u)?"default"in u?f=Pr(u.from||a,u.default,!0):f=Pr(u.from||a):f=Pr(u),Ee(f)&&o?Object.defineProperty(n,a,{enumerable:!0,configurable:!0,get:()=>f.value,set:h=>f.value=h}):n[a]=f}}function qp(t,n,r){Fn(Ht(t)?t.map(o=>o.bind(n.proxy)):t.bind(n.proxy),n,r)}function Nm(t,n,r,o){const a=o.includes(".")?_m(r,o):()=>r[o];if(qe(t)){const u=n[t];Wt(u)&&Fe(a,u)}else if(Wt(t))Fe(a,t.bind(r));else if(xe(t))if(Ht(t))t.forEach(u=>Nm(u,n,r,o));else{const u=Wt(t.handler)?t.handler.bind(r):n[t.handler];Wt(u)&&Fe(a,u,t)}}function Yf(t){const n=t.type,{mixins:r,extends:o}=n,{mixins:a,optionsCache:u,config:{optionMergeStrategies:f}}=t.appContext,h=u.get(n);let d;return h?d=h:!a.length&&!r&&!o?d=n:(d={},a.length&&a.forEach(g=>Oa(d,g,f,!0)),Oa(d,n,f)),xe(n)&&u.set(n,d),d}function Oa(t,n,r,o=!1){const{mixins:a,extends:u}=n;u&&Oa(t,u,r,!0),a&&a.forEach(f=>Oa(t,f,r,!0));for(const f in n)if(!(o&&f==="expose")){const h=q1[f]||r&&r[f];t[f]=h?h(t[f],n[f]):n[f]}return t}const q1={data:Hp,props:Ri,emits:Ri,methods:Ri,computed:Ri,beforeCreate:un,created:un,beforeMount:un,mounted:un,beforeUpdate:un,updated:un,beforeDestroy:un,beforeUnmount:un,destroyed:un,unmounted:un,activated:un,deactivated:un,errorCaptured:un,serverPrefetch:un,components:Ri,directives:Ri,watch:B1,provide:Hp,inject:H1};function Hp(t,n){return n?t?function(){return Ye(Wt(t)?t.call(this,this):t,Wt(n)?n.call(this,this):n)}:n:t}function H1(t,n){return Ri(Xu(t),Xu(n))}function Xu(t){if(Ht(t)){const n={};for(let r=0;r<t.length;r++)n[t[r]]=t[r];return n}return t}function un(t,n){return t?[...new Set([].concat(t,n))]:n}function Ri(t,n){return t?Ye(Ye(Object.create(null),t),n):n}function B1(t,n){if(!t)return n;if(!n)return t;const r=Ye(Object.create(null),t);for(const o in n)r[o]=un(t[o],n[o]);return r}function W1(t,n,r,o=!1){const a={},u={};Aa(u,ac,1),t.propsDefaults=Object.create(null),Om(t,n,a,u);for(const f in t.propsOptions[0])f in a||(a[f]=void 0);r?t.props=o?a:Zx(a):t.type.props?t.props=a:t.props=u,t.attrs=u}function U1(t,n,r,o){const{props:a,attrs:u,vnode:{patchFlag:f}}=t,h=ue(a),[d]=t.propsOptions;let g=!1;if((o||f>0)&&!(f&16)){if(f&8){const v=t.vnode.dynamicProps;for(let b=0;b<v.length;b++){let w=v[b];if(rc(t.emitsOptions,w))continue;const S=n[w];if(d)if(ne(u,w))S!==u[w]&&(u[w]=S,g=!0);else{const M=hr(w);a[M]=Yu(d,h,M,S,t,!1)}else S!==u[w]&&(u[w]=S,g=!0)}}}else{Om(t,n,a,u)&&(g=!0);let v;for(const b in h)(!n||!ne(n,b)&&((v=Zi(b))===b||!ne(n,v)))&&(d?r&&(r[b]!==void 0||r[v]!==void 0)&&(a[b]=Yu(d,h,b,void 0,t,!0)):delete a[b]);if(u!==h)for(const b in u)(!n||!ne(n,b)&&!0)&&(delete u[b],g=!0)}g&&Dr(t,"set","$attrs")}function Om(t,n,r,o){const[a,u]=t.propsOptions;let f=!1,h;if(n)for(let d in n){if(va(d))continue;const g=n[d];let v;a&&ne(a,v=hr(d))?!u||!u.includes(v)?r[v]=g:(h||(h={}))[v]=g:rc(t.emitsOptions,d)||(!(d in o)||g!==o[d])&&(o[d]=g,f=!0)}if(u){const d=ue(r),g=h||we;for(let v=0;v<u.length;v++){const b=u[v];r[b]=Yu(a,d,b,g[b],t,!ne(g,b))}}return f}function Yu(t,n,r,o,a,u){const f=t[r];if(f!=null){const h=ne(f,"default");if(h&&o===void 0){const d=f.default;if(f.type!==Function&&Wt(d)){const{propsDefaults:g}=a;r in g?o=g[r]:(Ho(a),o=g[r]=d.call(null,n),Ui())}else o=d}f[0]&&(u&&!h?o=!1:f[1]&&(o===""||o===Zi(r))&&(o=!0))}return o}function Pm(t,n,r=!1){const o=n.propsCache,a=o.get(t);if(a)return a;const u=t.props,f={},h=[];let d=!1;if(!Wt(t)){const v=b=>{d=!0;const[w,S]=Pm(b,n,!0);Ye(f,w),S&&h.push(...S)};!r&&n.mixins.length&&n.mixins.forEach(v),t.extends&&v(t.extends),t.mixins&&t.mixins.forEach(v)}if(!u&&!d)return xe(t)&&o.set(t,Ao),Ao;if(Ht(u))for(let v=0;v<u.length;v++){const b=hr(u[v]);Bp(b)&&(f[b]=we)}else if(u)for(const v in u){const b=hr(v);if(Bp(b)){const w=u[v],S=f[b]=Ht(w)||Wt(w)?{type:w}:Object.assign({},w);if(S){const M=jp(Boolean,S.type),A=jp(String,S.type);S[0]=M>-1,S[1]=A<0||M<A,(M>-1||ne(S,"default"))&&h.push(b)}}}const g=[f,h];return xe(t)&&o.set(t,g),g}function Bp(t){return t[0]!=="$"}function Wp(t){const n=t&&t.toString().match(/^\s*function (\w+)/);return n?n[1]:t===null?"null":""}function Up(t,n){return Wp(t)===Wp(n)}function jp(t,n){return Ht(n)?n.findIndex(r=>Up(r,t)):Wt(n)&&Up(n,t)?0:-1}const $m=t=>t[0]==="_"||t==="$stable",Zf=t=>Ht(t)?t.map(jn):[jn(t)],j1=(t,n,r)=>{if(n._n)return n;const o=Zt((...a)=>Zf(n(...a)),r);return o._c=!1,o},Dm=(t,n,r)=>{const o=t._ctx;for(const a in t){if($m(a))continue;const u=t[a];if(Wt(u))n[a]=j1(a,u,o);else if(u!=null){const f=Zf(u);n[a]=()=>f}}},Rm=(t,n)=>{const r=Zf(n);t.slots.default=()=>r},G1=(t,n)=>{if(t.vnode.shapeFlag&32){const r=n._;r?(t.slots=ue(n),Aa(n,"_",r)):Dm(n,t.slots={})}else t.slots={},n&&Rm(t,n);Aa(t.slots,ac,1)},V1=(t,n,r)=>{const{vnode:o,slots:a}=t;let u=!0,f=we;if(o.shapeFlag&32){const h=n._;h?r&&h===1?u=!1:(Ye(a,n),!r&&h===1&&delete a._):(u=!n.$stable,Dm(n,a)),f=n}else n&&(Rm(t,n),f={default:1});if(u)for(const h in a)!$m(h)&&!(h in f)&&delete a[h]};function zm(){return{app:null,config:{isNativeTag:gx,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let K1=0;function X1(t,n){return function(o,a=null){Wt(o)||(o=Object.assign({},o)),a!=null&&!xe(a)&&(a=null);const u=zm(),f=new Set;let h=!1;const d=u.app={_uid:K1++,_component:o,_props:a,_container:null,_context:u,_instance:null,version:p_,get config(){return u.config},set config(g){},use(g,...v){return f.has(g)||(g&&Wt(g.install)?(f.add(g),g.install(d,...v)):Wt(g)&&(f.add(g),g(d,...v))),d},mixin(g){return u.mixins.includes(g)||u.mixins.push(g),d},component(g,v){return v?(u.components[g]=v,d):u.components[g]},directive(g,v){return v?(u.directives[g]=v,d):u.directives[g]},mount(g,v,b){if(!h){const w=zt(o,a);return w.appContext=u,v&&n?n(w,g):t(w,g,b),h=!0,d._container=g,g.__vue_app__=d,uc(w.component)||w.component.proxy}},unmount(){h&&(t(null,d._container),delete d._container.__vue_app__)},provide(g,v){return u.provides[g]=v,d}};return d}}function Zu(t,n,r,o,a=!1){if(Ht(t)){t.forEach((w,S)=>Zu(w,n&&(Ht(n)?n[S]:n),r,o,a));return}if(Bs(o)&&!a)return;const u=o.shapeFlag&4?uc(o.component)||o.component.proxy:o.el,f=a?null:u,{i:h,r:d}=t,g=n&&n.r,v=h.refs===we?h.refs={}:h.refs,b=h.setupState;if(g!=null&&g!==d&&(qe(g)?(v[g]=null,ne(b,g)&&(b[g]=null)):Ee(g)&&(g.value=null)),Wt(d))hi(d,h,12,[f,v]);else{const w=qe(d),S=Ee(d);if(w||S){const M=()=>{if(t.f){const A=w?ne(b,d)?b[d]:v[d]:d.value;a?Ht(A)&&Nf(A,u):Ht(A)?A.includes(u)||A.push(u):w?(v[d]=[u],ne(b,d)&&(b[d]=v[d])):(d.value=[u],t.k&&(v[t.k]=d.value))}else w?(v[d]=f,ne(b,d)&&(b[d]=f)):S&&(d.value=f,t.k&&(v[t.k]=f))};f?(M.id=-1,xn(M,r)):M()}}}const xn=x1;function Y1(t){return Z1(t)}function Z1(t,n){const r=xx();r.__VUE__=!0;const{insert:o,remove:a,patchProp:u,createElement:f,createText:h,createComment:d,setText:g,setElementText:v,parentNode:b,nextSibling:w,setScopeId:S=Xn,insertStaticContent:M}=t,A=(O,F,Z,nt=null,ot=null,pt=null,lt=!1,vt=null,xt=!!F.dynamicChildren)=>{if(O===F)return;O&&!cr(O,F)&&(nt=K(O),Bt(O,ot,pt,!0),O=null),F.patchFlag===-2&&(xt=!1,F.dynamicChildren=null);const{type:ct,ref:$t,shapeFlag:Nt}=F;switch(ct){case lc:E(O,F,Z,nt);break;case Cn:T(O,F,Z,nt);break;case ku:O==null&&L(F,Z,nt,lt);break;case ce:ut(O,F,Z,nt,ot,pt,lt,vt,xt);break;default:Nt&1?G(O,F,Z,nt,ot,pt,lt,vt,xt):Nt&6?U(O,F,Z,nt,ot,pt,lt,vt,xt):(Nt&64||Nt&128)&&ct.process(O,F,Z,nt,ot,pt,lt,vt,xt,Ct)}$t!=null&&ot&&Zu($t,O&&O.ref,pt,F||O,!F)},E=(O,F,Z,nt)=>{if(O==null)o(F.el=h(F.children),Z,nt);else{const ot=F.el=O.el;F.children!==O.children&&g(ot,F.children)}},T=(O,F,Z,nt)=>{O==null?o(F.el=d(F.children||""),Z,nt):F.el=O.el},L=(O,F,Z,nt)=>{[O.el,O.anchor]=M(O.children,F,Z,nt,O.el,O.anchor)},$=({el:O,anchor:F},Z,nt)=>{let ot;for(;O&&O!==F;)ot=w(O),o(O,Z,nt),O=ot;o(F,Z,nt)},P=({el:O,anchor:F})=>{let Z;for(;O&&O!==F;)Z=w(O),a(O),O=Z;a(F)},G=(O,F,Z,nt,ot,pt,lt,vt,xt)=>{lt=lt||F.type==="svg",O==null?V(F,Z,nt,ot,pt,lt,vt,xt):dt(O,F,ot,pt,lt,vt,xt)},V=(O,F,Z,nt,ot,pt,lt,vt)=>{let xt,ct;const{type:$t,props:Nt,shapeFlag:Pt,transition:Rt,dirs:jt}=O;if(xt=O.el=f(O.type,pt,Nt&&Nt.is,Nt),Pt&8?v(xt,O.children):Pt&16&&J(O.children,xt,null,nt,ot,pt&&$t!=="foreignObject",lt,vt),jt&&Oi(O,null,nt,"created"),Nt){for(const Jt in Nt)Jt!=="value"&&!va(Jt)&&u(xt,Jt,null,Nt[Jt],pt,O.children,nt,ot,tt);"value"in Nt&&u(xt,"value",null,Nt.value),(ct=Nt.onVnodeBeforeMount)&&sr(ct,nt,O)}rt(xt,O,O.scopeId,lt,nt),jt&&Oi(O,null,nt,"beforeMount");const te=(!ot||ot&&!ot.pendingBranch)&&Rt&&!Rt.persisted;te&&Rt.beforeEnter(xt),o(xt,F,Z),((ct=Nt&&Nt.onVnodeMounted)||te||jt)&&xn(()=>{ct&&sr(ct,nt,O),te&&Rt.enter(xt),jt&&Oi(O,null,nt,"mounted")},ot)},rt=(O,F,Z,nt,ot)=>{if(Z&&S(O,Z),nt)for(let pt=0;pt<nt.length;pt++)S(O,nt[pt]);if(ot){let pt=ot.subTree;if(F===pt){const lt=ot.vnode;rt(O,lt,lt.scopeId,lt.slotScopeIds,ot.parent)}}},J=(O,F,Z,nt,ot,pt,lt,vt,xt=0)=>{for(let ct=xt;ct<O.length;ct++){const $t=O[ct]=vt?oi(O[ct]):jn(O[ct]);A(null,$t,F,Z,nt,ot,pt,lt,vt)}},dt=(O,F,Z,nt,ot,pt,lt)=>{const vt=F.el=O.el;let{patchFlag:xt,dynamicChildren:ct,dirs:$t}=F;xt|=O.patchFlag&16;const Nt=O.props||we,Pt=F.props||we;let Rt;Z&&Pi(Z,!1),(Rt=Pt.onVnodeBeforeUpdate)&&sr(Rt,Z,F,O),$t&&Oi(F,O,Z,"beforeUpdate"),Z&&Pi(Z,!0);const jt=ot&&F.type!=="foreignObject";if(ct?gt(O.dynamicChildren,ct,vt,Z,nt,jt,pt):lt||et(O,F,vt,null,Z,nt,jt,pt,!1),xt>0){if(xt&16)kt(vt,F,Nt,Pt,Z,nt,ot);else if(xt&2&&Nt.class!==Pt.class&&u(vt,"class",null,Pt.class,ot),xt&4&&u(vt,"style",Nt.style,Pt.style,ot),xt&8){const te=F.dynamicProps;for(let Jt=0;Jt<te.length;Jt++){const ae=te[Jt],Yt=Nt[ae],mn=Pt[ae];(mn!==Yt||ae==="value")&&u(vt,ae,Yt,mn,ot,O.children,Z,nt,tt)}}xt&1&&O.children!==F.children&&v(vt,F.children)}else!lt&&ct==null&&kt(vt,F,Nt,Pt,Z,nt,ot);((Rt=Pt.onVnodeUpdated)||$t)&&xn(()=>{Rt&&sr(Rt,Z,F,O),$t&&Oi(F,O,Z,"updated")},nt)},gt=(O,F,Z,nt,ot,pt,lt)=>{for(let vt=0;vt<F.length;vt++){const xt=O[vt],ct=F[vt],$t=xt.el&&(xt.type===ce||!cr(xt,ct)||xt.shapeFlag&70)?b(xt.el):Z;A(xt,ct,$t,null,nt,ot,pt,lt,!0)}},kt=(O,F,Z,nt,ot,pt,lt)=>{if(Z!==nt){if(Z!==we)for(const vt in Z)!va(vt)&&!(vt in nt)&&u(O,vt,Z[vt],null,lt,F.children,ot,pt,tt);for(const vt in nt){if(va(vt))continue;const xt=nt[vt],ct=Z[vt];xt!==ct&&vt!=="value"&&u(O,vt,ct,xt,lt,F.children,ot,pt,tt)}"value"in nt&&u(O,"value",Z.value,nt.value)}},ut=(O,F,Z,nt,ot,pt,lt,vt,xt)=>{const ct=F.el=O?O.el:h(""),$t=F.anchor=O?O.anchor:h("");let{patchFlag:Nt,dynamicChildren:Pt,slotScopeIds:Rt}=F;Rt&&(vt=vt?vt.concat(Rt):Rt),O==null?(o(ct,Z,nt),o($t,Z,nt),J(F.children,Z,$t,ot,pt,lt,vt,xt)):Nt>0&&Nt&64&&Pt&&O.dynamicChildren?(gt(O.dynamicChildren,Pt,Z,ot,pt,lt,vt),(F.key!=null||ot&&F===ot.subTree)&&Im(O,F,!0)):et(O,F,Z,$t,ot,pt,lt,vt,xt)},U=(O,F,Z,nt,ot,pt,lt,vt,xt)=>{F.slotScopeIds=vt,O==null?F.shapeFlag&512?ot.ctx.activate(F,Z,nt,lt,xt):z(F,Z,nt,ot,pt,lt,xt):k(O,F,xt)},z=(O,F,Z,nt,ot,pt,lt)=>{const vt=O.component=i_(O,nt,ot);if(oc(O)&&(vt.ctx.renderer=Ct),o_(vt),vt.asyncDep){if(ot&&ot.registerDep(vt,H),!O.el){const xt=vt.subTree=zt(Cn);T(null,xt,F,Z)}return}H(vt,O,F,Z,ot,pt,lt)},k=(O,F,Z)=>{const nt=F.component=O.component;if(d1(O,F,Z))if(nt.asyncDep&&!nt.asyncResolved){W(nt,F,Z);return}else nt.next=F,s1(nt.update),nt.update();else F.el=O.el,nt.vnode=F},H=(O,F,Z,nt,ot,pt,lt)=>{const vt=()=>{if(O.isMounted){let{next:$t,bu:Nt,u:Pt,parent:Rt,vnode:jt}=O,te=$t,Jt;Pi(O,!1),$t?($t.el=jt.el,W(O,$t,lt)):$t=jt,Nt&&ma(Nt),(Jt=$t.props&&$t.props.onVnodeBeforeUpdate)&&sr(Jt,Rt,$t,jt),Pi(O,!0);const ae=xu(O),Yt=O.subTree;O.subTree=ae,A(Yt,ae,b(Yt.el),K(Yt),O,ot,pt),$t.el=ae.el,te===null&&jf(O,ae.el),Pt&&xn(Pt,ot),(Jt=$t.props&&$t.props.onVnodeUpdated)&&xn(()=>sr(Jt,Rt,$t,jt),ot)}else{let $t;const{el:Nt,props:Pt}=F,{bm:Rt,m:jt,parent:te}=O,Jt=Bs(F);if(Pi(O,!1),Rt&&ma(Rt),!Jt&&($t=Pt&&Pt.onVnodeBeforeMount)&&sr($t,te,F),Pi(O,!0),Nt&&Lt){const ae=()=>{O.subTree=xu(O),Lt(Nt,O.subTree,O,ot,null)};Jt?F.type.__asyncLoader().then(()=>!O.isUnmounted&&ae()):ae()}else{const ae=O.subTree=xu(O);A(null,ae,Z,nt,O,ot,pt),F.el=ae.el}if(jt&&xn(jt,ot),!Jt&&($t=Pt&&Pt.onVnodeMounted)){const ae=F;xn(()=>sr($t,te,ae),ot)}(F.shapeFlag&256||te&&Bs(te.vnode)&&te.vnode.shapeFlag&256)&&O.a&&xn(O.a,ot),O.isMounted=!0,F=Z=nt=null}},xt=O.effect=new Df(vt,()=>Uf(ct),O.scope),ct=O.update=()=>xt.run();ct.id=O.uid,Pi(O,!0),ct()},W=(O,F,Z)=>{F.component=O;const nt=O.vnode.props;O.vnode=F,O.next=null,U1(O,F.props,nt,Z),V1(O,F.children,Z),Zo(),Dp(),Jo()},et=(O,F,Z,nt,ot,pt,lt,vt,xt=!1)=>{const ct=O&&O.children,$t=O?O.shapeFlag:0,Nt=F.children,{patchFlag:Pt,shapeFlag:Rt}=F;if(Pt>0){if(Pt&128){At(ct,Nt,Z,nt,ot,pt,lt,vt,xt);return}else if(Pt&256){wt(ct,Nt,Z,nt,ot,pt,lt,vt,xt);return}}Rt&8?($t&16&&tt(ct,ot,pt),Nt!==ct&&v(Z,Nt)):$t&16?Rt&16?At(ct,Nt,Z,nt,ot,pt,lt,vt,xt):tt(ct,ot,pt,!0):($t&8&&v(Z,""),Rt&16&&J(Nt,Z,nt,ot,pt,lt,vt,xt))},wt=(O,F,Z,nt,ot,pt,lt,vt,xt)=>{O=O||Ao,F=F||Ao;const ct=O.length,$t=F.length,Nt=Math.min(ct,$t);let Pt;for(Pt=0;Pt<Nt;Pt++){const Rt=F[Pt]=xt?oi(F[Pt]):jn(F[Pt]);A(O[Pt],Rt,Z,null,ot,pt,lt,vt,xt)}ct>$t?tt(O,ot,pt,!0,!1,Nt):J(F,Z,nt,ot,pt,lt,vt,xt,Nt)},At=(O,F,Z,nt,ot,pt,lt,vt,xt)=>{let ct=0;const $t=F.length;let Nt=O.length-1,Pt=$t-1;for(;ct<=Nt&&ct<=Pt;){const Rt=O[ct],jt=F[ct]=xt?oi(F[ct]):jn(F[ct]);if(cr(Rt,jt))A(Rt,jt,Z,null,ot,pt,lt,vt,xt);else break;ct++}for(;ct<=Nt&&ct<=Pt;){const Rt=O[Nt],jt=F[Pt]=xt?oi(F[Pt]):jn(F[Pt]);if(cr(Rt,jt))A(Rt,jt,Z,null,ot,pt,lt,vt,xt);else break;Nt--,Pt--}if(ct>Nt){if(ct<=Pt){const Rt=Pt+1,jt=Rt<$t?F[Rt].el:nt;for(;ct<=Pt;)A(null,F[ct]=xt?oi(F[ct]):jn(F[ct]),Z,jt,ot,pt,lt,vt,xt),ct++}}else if(ct>Pt)for(;ct<=Nt;)Bt(O[ct],ot,pt,!0),ct++;else{const Rt=ct,jt=ct,te=new Map;for(ct=jt;ct<=Pt;ct++){const ye=F[ct]=xt?oi(F[ct]):jn(F[ct]);ye.key!=null&&te.set(ye.key,ct)}let Jt,ae=0;const Yt=Pt-jt+1;let mn=!1,Ln=0;const He=new Array(Yt);for(ct=0;ct<Yt;ct++)He[ct]=0;for(ct=Rt;ct<=Nt;ct++){const ye=O[ct];if(ae>=Yt){Bt(ye,ot,pt,!0);continue}let nn;if(ye.key!=null)nn=te.get(ye.key);else for(Jt=jt;Jt<=Pt;Jt++)if(He[Jt-jt]===0&&cr(ye,F[Jt])){nn=Jt;break}nn===void 0?Bt(ye,ot,pt,!0):(He[nn-jt]=ct+1,nn>=Ln?Ln=nn:mn=!0,A(ye,F[nn],Z,null,ot,pt,lt,vt,xt),ae++)}const to=mn?J1(He):Ao;for(Jt=to.length-1,ct=Yt-1;ct>=0;ct--){const ye=jt+ct,nn=F[ye],bt=ye+1<$t?F[ye+1].el:nt;He[ct]===0?A(null,nn,Z,bt,ot,pt,lt,vt,xt):mn&&(Jt<0||ct!==to[Jt]?qt(nn,Z,bt,2):Jt--)}}},qt=(O,F,Z,nt,ot=null)=>{const{el:pt,type:lt,transition:vt,children:xt,shapeFlag:ct}=O;if(ct&6){qt(O.component.subTree,F,Z,nt);return}if(ct&128){O.suspense.move(F,Z,nt);return}if(ct&64){lt.move(O,F,Z,Ct);return}if(lt===ce){o(pt,F,Z);for(let Nt=0;Nt<xt.length;Nt++)qt(xt[Nt],F,Z,nt);o(O.anchor,F,Z);return}if(lt===ku){$(O,F,Z);return}if(nt!==2&&ct&1&&vt)if(nt===0)vt.beforeEnter(pt),o(pt,F,Z),xn(()=>vt.enter(pt),ot);else{const{leave:Nt,delayLeave:Pt,afterLeave:Rt}=vt,jt=()=>o(pt,F,Z),te=()=>{Nt(pt,()=>{jt(),Rt&&Rt()})};Pt?Pt(pt,jt,te):te()}else o(pt,F,Z)},Bt=(O,F,Z,nt=!1,ot=!1)=>{const{type:pt,props:lt,ref:vt,children:xt,dynamicChildren:ct,shapeFlag:$t,patchFlag:Nt,dirs:Pt}=O;if(vt!=null&&Zu(vt,null,Z,O,!0),$t&256){F.ctx.deactivate(O);return}const Rt=$t&1&&Pt,jt=!Bs(O);let te;if(jt&&(te=lt&&lt.onVnodeBeforeUnmount)&&sr(te,F,O),$t&6)Q(O.component,Z,nt);else{if($t&128){O.suspense.unmount(Z,nt);return}Rt&&Oi(O,null,F,"beforeUnmount"),$t&64?O.type.remove(O,F,Z,ot,Ct,nt):ct&&(pt!==ce||Nt>0&&Nt&64)?tt(ct,F,Z,!1,!0):(pt===ce&&Nt&384||!ot&&$t&16)&&tt(xt,F,Z),nt&&Gt(O)}(jt&&(te=lt&&lt.onVnodeUnmounted)||Rt)&&xn(()=>{te&&sr(te,F,O),Rt&&Oi(O,null,F,"unmounted")},Z)},Gt=O=>{const{type:F,el:Z,anchor:nt,transition:ot}=O;if(F===ce){ie(Z,nt);return}if(F===ku){P(O);return}const pt=()=>{a(Z),ot&&!ot.persisted&&ot.afterLeave&&ot.afterLeave()};if(O.shapeFlag&1&&ot&&!ot.persisted){const{leave:lt,delayLeave:vt}=ot,xt=()=>lt(Z,pt);vt?vt(O.el,pt,xt):xt()}else pt()},ie=(O,F)=>{let Z;for(;O!==F;)Z=w(O),a(O),O=Z;a(F)},Q=(O,F,Z)=>{const{bum:nt,scope:ot,update:pt,subTree:lt,um:vt}=O;nt&&ma(nt),ot.stop(),pt&&(pt.active=!1,Bt(lt,O,F,Z)),vt&&xn(vt,F),xn(()=>{O.isUnmounted=!0},F),F&&F.pendingBranch&&!F.isUnmounted&&O.asyncDep&&!O.asyncResolved&&O.suspenseId===F.pendingId&&(F.deps--,F.deps===0&&F.resolve())},tt=(O,F,Z,nt=!1,ot=!1,pt=0)=>{for(let lt=pt;lt<O.length;lt++)Bt(O[lt],F,Z,nt,ot)},K=O=>O.shapeFlag&6?K(O.component.subTree):O.shapeFlag&128?O.suspense.next():w(O.anchor||O.el),st=(O,F,Z)=>{O==null?F._vnode&&Bt(F._vnode,null,null,!0):A(F._vnode||null,O,F,null,null,null,Z),Dp(),mm(),F._vnode=O},Ct={p:A,um:Bt,m:qt,r:Gt,mt:z,mc:J,pc:et,pbc:gt,n:K,o:t};let pe,Lt;return n&&([pe,Lt]=n(Ct)),{render:st,hydrate:pe,createApp:X1(st,pe)}}function Pi({effect:t,update:n},r){t.allowRecurse=n.allowRecurse=r}function Im(t,n,r=!1){const o=t.children,a=n.children;if(Ht(o)&&Ht(a))for(let u=0;u<o.length;u++){const f=o[u];let h=a[u];h.shapeFlag&1&&!h.dynamicChildren&&((h.patchFlag<=0||h.patchFlag===32)&&(h=a[u]=oi(a[u]),h.el=f.el),r||Im(f,h)),h.type===lc&&(h.el=f.el)}}function J1(t){const n=t.slice(),r=[0];let o,a,u,f,h;const d=t.length;for(o=0;o<d;o++){const g=t[o];if(g!==0){if(a=r[r.length-1],t[a]<g){n[o]=a,r.push(o);continue}for(u=0,f=r.length-1;u<f;)h=u+f>>1,t[r[h]]<g?u=h+1:f=h;g<t[r[u]]&&(u>0&&(n[o]=r[u-1]),r[u]=o)}}for(u=r.length,f=r[u-1];u-- >0;)r[u]=f,f=n[f];return r}const Q1=t=>t.__isTeleport,ce=Symbol(void 0),lc=Symbol(void 0),Cn=Symbol(void 0),ku=Symbol(void 0),Us=[];let In=null;function at(t=!1){Us.push(In=t?null:[])}function Fm(){Us.pop(),In=Us[Us.length-1]||null}let qo=1;function Gp(t){qo+=t}function qm(t){return t.dynamicChildren=qo>0?In||Ao:null,Fm(),qo>0&&In&&In.push(t),t}function Et(t,n,r,o,a,u){return qm(ht(t,n,r,o,a,u,!0))}function Qt(t,n,r,o,a){return qm(zt(t,n,r,o,a,!0))}function tl(t){return t?t.__v_isVNode===!0:!1}function cr(t,n){return t.type===n.type&&t.key===n.key}const ac="__vInternal",Hm=({key:t})=>t??null,ba=({ref:t,ref_key:n,ref_for:r})=>t!=null?qe(t)||Ee(t)||Wt(t)?{i:Xe,r:t,k:n,f:!!r}:t:null;function ht(t,n=null,r=null,o=0,a=null,u=t===ce?0:1,f=!1,h=!1){const d={__v_isVNode:!0,__v_skip:!0,type:t,props:n,key:n&&Hm(n),ref:n&&ba(n),scopeId:ic,slotScopeIds:null,children:r,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:u,patchFlag:o,dynamicProps:a,dynamicChildren:null,appContext:null,ctx:Xe};return h?(Jf(d,r),u&128&&t.normalize(d)):r&&(d.shapeFlag|=qe(r)?8:16),qo>0&&!f&&In&&(d.patchFlag>0||u&6)&&d.patchFlag!==32&&In.push(d),d}const zt=t_;function t_(t,n=null,r=null,o=0,a=null,u=!1){if((!t||t===R1)&&(t=Cn),tl(t)){const h=gi(t,n,!0);return r&&Jf(h,r),qo>0&&!u&&In&&(h.shapeFlag&6?In[In.indexOf(t)]=h:In.push(h)),h.patchFlag|=-2,h}if(c_(t)&&(t=t.__vccOpts),n){n=e_(n);let{class:h,style:d}=n;h&&!qe(h)&&(n.class=ve(h)),xe(d)&&(am(d)&&!Ht(d)&&(d=Ye({},d)),n.style=kn(d))}const f=qe(t)?1:p1(t)?128:Q1(t)?64:xe(t)?4:Wt(t)?2:0;return ht(t,n,r,o,a,f,u,!0)}function e_(t){return t?am(t)||ac in t?Ye({},t):t:null}function gi(t,n,r=!1){const{props:o,ref:a,patchFlag:u,children:f}=t,h=n?di(o||{},n):o;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:h,key:h&&Hm(h),ref:n&&n.ref?r&&a?Ht(a)?a.concat(ba(n)):[a,ba(n)]:ba(n):a,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:f,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:n&&t.type!==ce?u===-1?16:u|16:u,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&gi(t.ssContent),ssFallback:t.ssFallback&&gi(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx}}function fn(t=" ",n=0){return zt(lc,null,t,n)}function le(t="",n=!1){return n?(at(),Qt(Cn,null,t)):zt(Cn,null,t)}function jn(t){return t==null||typeof t=="boolean"?zt(Cn):Ht(t)?zt(ce,null,t.slice()):typeof t=="object"?oi(t):zt(lc,null,String(t))}function oi(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:gi(t)}function Jf(t,n){let r=0;const{shapeFlag:o}=t;if(n==null)n=null;else if(Ht(n))r=16;else if(typeof n=="object")if(o&65){const a=n.default;a&&(a._c&&(a._d=!1),Jf(t,a()),a._c&&(a._d=!0));return}else{r=32;const a=n._;!a&&!(ac in n)?n._ctx=Xe:a===3&&Xe&&(Xe.slots._===1?n._=1:(n._=2,t.patchFlag|=1024))}else Wt(n)?(n={default:n,_ctx:Xe},r=32):(n=String(n),o&64?(r=16,n=[fn(n)]):r=8);t.children=n,t.shapeFlag|=r}function di(...t){const n={};for(let r=0;r<t.length;r++){const o=t[r];for(const a in o)if(a==="class")n.class!==o.class&&(n.class=ve([n.class,o.class]));else if(a==="style")n.style=kn([n.style,o.style]);else if(Ja(a)){const u=n[a],f=o[a];f&&u!==f&&!(Ht(u)&&u.includes(f))&&(n[a]=u?[].concat(u,f):f)}else a!==""&&(n[a]=o[a])}return n}function sr(t,n,r,o=null){Fn(t,n,7,[r,o])}const n_=zm();let r_=0;function i_(t,n,r){const o=t.type,a=(n?n.appContext:t.appContext)||n_,u={uid:r_++,vnode:t,type:o,parent:n,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,scope:new _x(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(a.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Pm(o,a),emitsOptions:bm(o,a),emit:null,emitted:null,propsDefaults:we,inheritAttrs:o.inheritAttrs,ctx:we,data:we,props:we,attrs:we,slots:we,refs:we,setupState:we,setupContext:null,suspense:r,suspenseId:r?r.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return u.ctx={_:u},u.root=n?n.root:u,u.emit=a1.bind(null,u),t.ce&&t.ce(u),u}let We=null;const cc=()=>We||Xe,Ho=t=>{We=t,t.scope.on()},Ui=()=>{We&&We.scope.off(),We=null};function Bm(t){return t.vnode.shapeFlag&4}let el=!1;function o_(t,n=!1){el=n;const{props:r,children:o}=t.vnode,a=Bm(t);W1(t,r,a,n),G1(t,o);const u=a?s_(t,n):void 0;return el=!1,u}function s_(t,n){const r=t.type;t.accessCache=Object.create(null),t.proxy=qf(new Proxy(t.ctx,z1));const{setup:o}=r;if(o){const a=t.setupContext=o.length>1?Um(t):null;Ho(t),Zo();const u=hi(o,t,0,[t.props,a]);if(Jo(),Ui(),Kv(u)){if(u.then(Ui,Ui),n)return u.then(f=>{Ju(t,f,n)}).catch(f=>{hl(f,t,0)});t.asyncDep=u}else Ju(t,u,n)}else Wm(t,n)}function Ju(t,n,r){Wt(n)?t.type.__ssrInlineRender?t.ssrRender=n:t.render=n:xe(n)&&(t.setupState=hm(n)),Wm(t,r)}let Vp;function Wm(t,n,r){const o=t.type;if(!t.render){if(!n&&Vp&&!o.render){const a=o.template||Yf(t).template;if(a){const{isCustomElement:u,compilerOptions:f}=t.appContext.config,{delimiters:h,compilerOptions:d}=o,g=Ye(Ye({isCustomElement:u,delimiters:h},f),d);o.render=Vp(a,g)}}t.render=o.render||Xn}Ho(t),Zo(),I1(t),Jo(),Ui()}function l_(t){return new Proxy(t.attrs,{get(n,r){return Pn(t,"get","$attrs"),n[r]}})}function Um(t){const n=o=>{t.exposed=o||{}};let r;return{get attrs(){return r||(r=l_(t))},slots:t.slots,emit:t.emit,expose:n}}function uc(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(hm(qf(t.exposed)),{get(n,r){if(r in n)return n[r];if(r in Ws)return Ws[r](t)},has(n,r){return r in n||r in Ws}}))}function a_(t,n=!0){return Wt(t)?t.displayName||t.name:t.name||n&&t.__name}function c_(t){return Wt(t)&&"__vccOpts"in t}const _t=(t,n)=>r1(t,n,el);function u_(){return f_().attrs}function f_(){const t=cc();return t.setupContext||(t.setupContext=Um(t))}function pl(t,n,r){const o=arguments.length;return o===2?xe(n)&&!Ht(n)?tl(n)?zt(t,null,[n]):zt(t,n):zt(t,null,n):(o>3?r=Array.prototype.slice.call(arguments,2):o===3&&tl(r)&&(r=[r]),zt(t,n,r))}const h_=Symbol(""),d_=()=>Pr(h_),p_="3.2.45",g_="http://www.w3.org/2000/svg",Fi=typeof document<"u"?document:null,Kp=Fi&&Fi.createElement("template"),v_={insert:(t,n,r)=>{n.insertBefore(t,r||null)},remove:t=>{const n=t.parentNode;n&&n.removeChild(t)},createElement:(t,n,r,o)=>{const a=n?Fi.createElementNS(g_,t):Fi.createElement(t,r?{is:r}:void 0);return t==="select"&&o&&o.multiple!=null&&a.setAttribute("multiple",o.multiple),a},createText:t=>Fi.createTextNode(t),createComment:t=>Fi.createComment(t),setText:(t,n)=>{t.nodeValue=n},setElementText:(t,n)=>{t.textContent=n},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Fi.querySelector(t),setScopeId(t,n){t.setAttribute(n,"")},insertStaticContent(t,n,r,o,a,u){const f=r?r.previousSibling:n.lastChild;if(a&&(a===u||a.nextSibling))for(;n.insertBefore(a.cloneNode(!0),r),!(a===u||!(a=a.nextSibling)););else{Kp.innerHTML=o?`<svg>${t}</svg>`:t;const h=Kp.content;if(o){const d=h.firstChild;for(;d.firstChild;)h.appendChild(d.firstChild);h.removeChild(d)}n.insertBefore(h,r)}return[f?f.nextSibling:n.firstChild,r?r.previousSibling:n.lastChild]}};function m_(t,n,r){const o=t._vtc;o&&(n=(n?[n,...o]:[...o]).join(" ")),n==null?t.removeAttribute("class"):r?t.setAttribute("class",n):t.className=n}function y_(t,n,r){const o=t.style,a=qe(r);if(r&&!a){for(const u in r)Qu(o,u,r[u]);if(n&&!qe(n))for(const u in n)r[u]==null&&Qu(o,u,"")}else{const u=o.display;a?n!==r&&(o.cssText=r):n&&t.removeAttribute("style"),"_vod"in t&&(o.display=u)}}const Xp=/\s*!important$/;function Qu(t,n,r){if(Ht(r))r.forEach(o=>Qu(t,n,o));else if(r==null&&(r=""),n.startsWith("--"))t.setProperty(n,r);else{const o=b_(t,n);Xp.test(r)?t.setProperty(Zi(o),r.replace(Xp,""),"important"):t[o]=r}}const Yp=["Webkit","Moz","ms"],Cu={};function b_(t,n){const r=Cu[n];if(r)return r;let o=hr(n);if(o!=="filter"&&o in t)return Cu[n]=o;o=ec(o);for(let a=0;a<Yp.length;a++){const u=Yp[a]+o;if(u in t)return Cu[n]=u}return n}const Zp="http://www.w3.org/1999/xlink";function w_(t,n,r,o,a){if(o&&n.startsWith("xlink:"))r==null?t.removeAttributeNS(Zp,n.slice(6,n.length)):t.setAttributeNS(Zp,n,r);else{const u=px(n);r==null||u&&!jv(r)?t.removeAttribute(n):t.setAttribute(n,u?"":r)}}function x_(t,n,r,o,a,u,f){if(n==="innerHTML"||n==="textContent"){o&&f(o,a,u),t[n]=r??"";return}if(n==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=r;const d=r??"";(t.value!==d||t.tagName==="OPTION")&&(t.value=d),r==null&&t.removeAttribute(n);return}let h=!1;if(r===""||r==null){const d=typeof t[n];d==="boolean"?r=jv(r):r==null&&d==="string"?(r="",h=!0):d==="number"&&(r=0,h=!0)}try{t[n]=r}catch{}h&&t.removeAttribute(n)}function Lo(t,n,r,o){t.addEventListener(n,r,o)}function __(t,n,r,o){t.removeEventListener(n,r,o)}function S_(t,n,r,o,a=null){const u=t._vei||(t._vei={}),f=u[n];if(o&&f)f.value=o;else{const[h,d]=k_(n);if(o){const g=u[n]=L_(o,a);Lo(t,h,g,d)}else f&&(__(t,h,f,d),u[n]=void 0)}}const Jp=/(?:Once|Passive|Capture)$/;function k_(t){let n;if(Jp.test(t)){n={};let o;for(;o=t.match(Jp);)t=t.slice(0,t.length-o[0].length),n[o[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Zi(t.slice(2)),n]}let Tu=0;const C_=Promise.resolve(),T_=()=>Tu||(C_.then(()=>Tu=0),Tu=Date.now());function L_(t,n){const r=o=>{if(!o._vts)o._vts=Date.now();else if(o._vts<=r.attached)return;Fn(E_(o,r.value),n,5,[o])};return r.value=t,r.attached=T_(),r}function E_(t,n){if(Ht(n)){const r=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{r.call(t),t._stopped=!0},n.map(o=>a=>!a._stopped&&o&&o(a))}else return n}const Qp=/^on[a-z]/,A_=(t,n,r,o,a=!1,u,f,h,d)=>{n==="class"?m_(t,o,a):n==="style"?y_(t,r,o):Ja(n)?Mf(n)||S_(t,n,r,o,f):(n[0]==="."?(n=n.slice(1),!0):n[0]==="^"?(n=n.slice(1),!1):M_(t,n,o,a))?x_(t,n,o,u,f,h,d):(n==="true-value"?t._trueValue=o:n==="false-value"&&(t._falseValue=o),w_(t,n,o,a))};function M_(t,n,r,o){return o?!!(n==="innerHTML"||n==="textContent"||n in t&&Qp.test(n)&&Wt(r)):n==="spellcheck"||n==="draggable"||n==="translate"||n==="form"||n==="list"&&t.tagName==="INPUT"||n==="type"&&t.tagName==="TEXTAREA"||Qp.test(n)&&qe(r)?!1:n in t}const ni="transition",$s="animation",Qf=(t,{slots:n})=>pl(Sm,N_(t),n);Qf.displayName="Transition";const jm={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};Qf.props=Ye({},Sm.props,jm);const $i=(t,n=[])=>{Ht(t)?t.forEach(r=>r(...n)):t&&t(...n)},tg=t=>t?Ht(t)?t.some(n=>n.length>1):t.length>1:!1;function N_(t){const n={};for(const ut in t)ut in jm||(n[ut]=t[ut]);if(t.css===!1)return n;const{name:r="v",type:o,duration:a,enterFromClass:u=`${r}-enter-from`,enterActiveClass:f=`${r}-enter-active`,enterToClass:h=`${r}-enter-to`,appearFromClass:d=u,appearActiveClass:g=f,appearToClass:v=h,leaveFromClass:b=`${r}-leave-from`,leaveActiveClass:w=`${r}-leave-active`,leaveToClass:S=`${r}-leave-to`}=t,M=O_(a),A=M&&M[0],E=M&&M[1],{onBeforeEnter:T,onEnter:L,onEnterCancelled:$,onLeave:P,onLeaveCancelled:G,onBeforeAppear:V=T,onAppear:rt=L,onAppearCancelled:J=$}=n,dt=(ut,U,z)=>{Di(ut,U?v:h),Di(ut,U?g:f),z&&z()},gt=(ut,U)=>{ut._isLeaving=!1,Di(ut,b),Di(ut,S),Di(ut,w),U&&U()},kt=ut=>(U,z)=>{const k=ut?rt:L,H=()=>dt(U,ut,z);$i(k,[U,H]),eg(()=>{Di(U,ut?d:u),ri(U,ut?v:h),tg(k)||ng(U,o,A,H)})};return Ye(n,{onBeforeEnter(ut){$i(T,[ut]),ri(ut,u),ri(ut,f)},onBeforeAppear(ut){$i(V,[ut]),ri(ut,d),ri(ut,g)},onEnter:kt(!1),onAppear:kt(!0),onLeave(ut,U){ut._isLeaving=!0;const z=()=>gt(ut,U);ri(ut,b),D_(),ri(ut,w),eg(()=>{!ut._isLeaving||(Di(ut,b),ri(ut,S),tg(P)||ng(ut,o,E,z))}),$i(P,[ut,z])},onEnterCancelled(ut){dt(ut,!1),$i($,[ut])},onAppearCancelled(ut){dt(ut,!0),$i(J,[ut])},onLeaveCancelled(ut){gt(ut),$i(G,[ut])}})}function O_(t){if(t==null)return null;if(xe(t))return[Lu(t.enter),Lu(t.leave)];{const n=Lu(t);return[n,n]}}function Lu(t){return Io(t)}function ri(t,n){n.split(/\s+/).forEach(r=>r&&t.classList.add(r)),(t._vtc||(t._vtc=new Set)).add(n)}function Di(t,n){n.split(/\s+/).forEach(o=>o&&t.classList.remove(o));const{_vtc:r}=t;r&&(r.delete(n),r.size||(t._vtc=void 0))}function eg(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let P_=0;function ng(t,n,r,o){const a=t._endId=++P_,u=()=>{a===t._endId&&o()};if(r)return setTimeout(u,r);const{type:f,timeout:h,propCount:d}=$_(t,n);if(!f)return o();const g=f+"end";let v=0;const b=()=>{t.removeEventListener(g,w),u()},w=S=>{S.target===t&&++v>=d&&b()};setTimeout(()=>{v<d&&b()},h+1),t.addEventListener(g,w)}function $_(t,n){const r=window.getComputedStyle(t),o=M=>(r[M]||"").split(", "),a=o(`${ni}Delay`),u=o(`${ni}Duration`),f=rg(a,u),h=o(`${$s}Delay`),d=o(`${$s}Duration`),g=rg(h,d);let v=null,b=0,w=0;n===ni?f>0&&(v=ni,b=f,w=u.length):n===$s?g>0&&(v=$s,b=g,w=d.length):(b=Math.max(f,g),v=b>0?f>g?ni:$s:null,w=v?v===ni?u.length:d.length:0);const S=v===ni&&/\b(transform|all)(,|$)/.test(o(`${ni}Property`).toString());return{type:v,timeout:b,propCount:w,hasTransform:S}}function rg(t,n){for(;t.length<n.length;)t=t.concat(t);return Math.max(...n.map((r,o)=>ig(r)+ig(t[o])))}function ig(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function D_(){return document.body.offsetHeight}const og=t=>{const n=t.props["onUpdate:modelValue"]||!1;return Ht(n)?r=>ma(n,r):n};function R_(t){t.target.composing=!0}function sg(t){const n=t.target;n.composing&&(n.composing=!1,n.dispatchEvent(new Event("input")))}const z_={created(t,{modifiers:{lazy:n,trim:r,number:o}},a){t._assign=og(a);const u=o||a.props&&a.props.type==="number";Lo(t,n?"change":"input",f=>{if(f.target.composing)return;let h=t.value;r&&(h=h.trim()),u&&(h=Io(h)),t._assign(h)}),r&&Lo(t,"change",()=>{t.value=t.value.trim()}),n||(Lo(t,"compositionstart",R_),Lo(t,"compositionend",sg),Lo(t,"change",sg))},mounted(t,{value:n}){t.value=n??""},beforeUpdate(t,{value:n,modifiers:{lazy:r,trim:o,number:a}},u){if(t._assign=og(u),t.composing||document.activeElement===t&&t.type!=="range"&&(r||o&&t.value.trim()===n||(a||t.type==="number")&&Io(t.value)===n))return;const f=n??"";t.value!==f&&(t.value=f)}},I_={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},tf=(t,n)=>r=>{if(!("key"in r))return;const o=Zi(r.key);if(n.some(a=>a===o||I_[a]===o))return t(r)},Gm={beforeMount(t,{value:n},{transition:r}){t._vod=t.style.display==="none"?"":t.style.display,r&&n?r.beforeEnter(t):Ds(t,n)},mounted(t,{value:n},{transition:r}){r&&n&&r.enter(t)},updated(t,{value:n,oldValue:r},{transition:o}){!n!=!r&&(o?n?(o.beforeEnter(t),Ds(t,!0),o.enter(t)):o.leave(t,()=>{Ds(t,!1)}):Ds(t,n))},beforeUnmount(t,{value:n}){Ds(t,n)}};function Ds(t,n){t.style.display=n?t._vod:"none"}const F_=Ye({patchProp:A_},v_);let lg;function q_(){return lg||(lg=Y1(F_))}const Vm=(...t)=>{const n=q_().createApp(...t),{mount:r}=n;return n.mount=o=>{const a=H_(o);if(!a)return;const u=n._component;!Wt(u)&&!u.render&&!u.template&&(u.template=a.innerHTML),a.innerHTML="";const f=r(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),f},n};function H_(t){return qe(t)?document.querySelector(t):t}const Qi=(t,n)=>{const r=t.__vccOpts||t;for(const[o,a]of n)r[o]=a;return r},B_={};function W_(t,n){const r=Vi("RouterView");return at(),Qt(r)}const U_=Qi(B_,[["render",W_]]);const Eo=typeof window<"u";function j_(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const de=Object.assign;function Eu(t,n){const r={};for(const o in n){const a=n[o];r[o]=Zn(a)?a.map(t):t(a)}return r}const js=()=>{},Zn=Array.isArray,G_=/\/$/,V_=t=>t.replace(G_,"");function Au(t,n,r="/"){let o,a={},u="",f="";const h=n.indexOf("#");let d=n.indexOf("?");return h<d&&h>=0&&(d=-1),d>-1&&(o=n.slice(0,d),u=n.slice(d+1,h>-1?h:n.length),a=t(u)),h>-1&&(o=o||n.slice(0,h),f=n.slice(h,n.length)),o=Z_(o??n,r),{fullPath:o+(u&&"?")+u+f,path:o,query:a,hash:f}}function K_(t,n){const r=n.query?t(n.query):"";return n.path+(r&&"?")+r+(n.hash||"")}function ag(t,n){return!n||!t.toLowerCase().startsWith(n.toLowerCase())?t:t.slice(n.length)||"/"}function X_(t,n,r){const o=n.matched.length-1,a=r.matched.length-1;return o>-1&&o===a&&Bo(n.matched[o],r.matched[a])&&Km(n.params,r.params)&&t(n.query)===t(r.query)&&n.hash===r.hash}function Bo(t,n){return(t.aliasOf||t)===(n.aliasOf||n)}function Km(t,n){if(Object.keys(t).length!==Object.keys(n).length)return!1;for(const r in t)if(!Y_(t[r],n[r]))return!1;return!0}function Y_(t,n){return Zn(t)?cg(t,n):Zn(n)?cg(n,t):t===n}function cg(t,n){return Zn(n)?t.length===n.length&&t.every((r,o)=>r===n[o]):t.length===1&&t[0]===n}function Z_(t,n){if(t.startsWith("/"))return t;if(!t)return n;const r=n.split("/"),o=t.split("/");let a=r.length-1,u,f;for(u=0;u<o.length;u++)if(f=o[u],f!==".")if(f==="..")a>1&&a--;else break;return r.slice(0,a).join("/")+"/"+o.slice(u-(u===o.length?1:0)).join("/")}var nl;(function(t){t.pop="pop",t.push="push"})(nl||(nl={}));var Gs;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Gs||(Gs={}));function J_(t){if(!t)if(Eo){const n=document.querySelector("base");t=n&&n.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),V_(t)}const Q_=/^[^#]+#/;function tS(t,n){return t.replace(Q_,"#")+n}function eS(t,n){const r=document.documentElement.getBoundingClientRect(),o=t.getBoundingClientRect();return{behavior:n.behavior,left:o.left-r.left-(n.left||0),top:o.top-r.top-(n.top||0)}}const fc=()=>({left:window.pageXOffset,top:window.pageYOffset});function nS(t){let n;if("el"in t){const r=t.el,o=typeof r=="string"&&r.startsWith("#"),a=typeof r=="string"?o?document.getElementById(r.slice(1)):document.querySelector(r):r;if(!a)return;n=eS(a,t)}else n=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(n):window.scrollTo(n.left!=null?n.left:window.pageXOffset,n.top!=null?n.top:window.pageYOffset)}function ug(t,n){return(history.state?history.state.position-n:-1)+t}const ef=new Map;function rS(t,n){ef.set(t,n)}function iS(t){const n=ef.get(t);return ef.delete(t),n}let oS=()=>location.protocol+"//"+location.host;function Xm(t,n){const{pathname:r,search:o,hash:a}=n,u=t.indexOf("#");if(u>-1){let h=a.includes(t.slice(u))?t.slice(u).length:1,d=a.slice(h);return d[0]!=="/"&&(d="/"+d),ag(d,"")}return ag(r,t)+o+a}function sS(t,n,r,o){let a=[],u=[],f=null;const h=({state:w})=>{const S=Xm(t,location),M=r.value,A=n.value;let E=0;if(w){if(r.value=S,n.value=w,f&&f===M){f=null;return}E=A?w.position-A.position:0}else o(S);a.forEach(T=>{T(r.value,M,{delta:E,type:nl.pop,direction:E?E>0?Gs.forward:Gs.back:Gs.unknown})})};function d(){f=r.value}function g(w){a.push(w);const S=()=>{const M=a.indexOf(w);M>-1&&a.splice(M,1)};return u.push(S),S}function v(){const{history:w}=window;!w.state||w.replaceState(de({},w.state,{scroll:fc()}),"")}function b(){for(const w of u)w();u=[],window.removeEventListener("popstate",h),window.removeEventListener("beforeunload",v)}return window.addEventListener("popstate",h),window.addEventListener("beforeunload",v),{pauseListeners:d,listen:g,destroy:b}}function fg(t,n,r,o=!1,a=!1){return{back:t,current:n,forward:r,replaced:o,position:window.history.length,scroll:a?fc():null}}function lS(t){const{history:n,location:r}=window,o={value:Xm(t,r)},a={value:n.state};a.value||u(o.value,{back:null,current:o.value,forward:null,position:n.length-1,replaced:!0,scroll:null},!0);function u(d,g,v){const b=t.indexOf("#"),w=b>-1?(r.host&&document.querySelector("base")?t:t.slice(b))+d:oS()+t+d;try{n[v?"replaceState":"pushState"](g,"",w),a.value=g}catch(S){console.error(S),r[v?"replace":"assign"](w)}}function f(d,g){const v=de({},n.state,fg(a.value.back,d,a.value.forward,!0),g,{position:a.value.position});u(d,v,!0),o.value=d}function h(d,g){const v=de({},a.value,n.state,{forward:d,scroll:fc()});u(v.current,v,!0);const b=de({},fg(o.value,d,null),{position:v.position+1},g);u(d,b,!1),o.value=d}return{location:o,state:a,push:h,replace:f}}function aS(t){t=J_(t);const n=lS(t),r=sS(t,n.state,n.location,n.replace);function o(u,f=!0){f||r.pauseListeners(),history.go(u)}const a=de({location:"",base:t,go:o,createHref:tS.bind(null,t)},n,r);return Object.defineProperty(a,"location",{enumerable:!0,get:()=>n.location.value}),Object.defineProperty(a,"state",{enumerable:!0,get:()=>n.state.value}),a}function cS(t){return typeof t=="string"||t&&typeof t=="object"}function Ym(t){return typeof t=="string"||typeof t=="symbol"}const ii={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Zm=Symbol("");var hg;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(hg||(hg={}));function Wo(t,n){return de(new Error,{type:t,[Zm]:!0},n)}function Tr(t,n){return t instanceof Error&&Zm in t&&(n==null||!!(t.type&n))}const dg="[^/]+?",uS={sensitive:!1,strict:!1,start:!0,end:!0},fS=/[.+*?^${}()[\]/\\]/g;function hS(t,n){const r=de({},uS,n),o=[];let a=r.start?"^":"";const u=[];for(const g of t){const v=g.length?[]:[90];r.strict&&!g.length&&(a+="/");for(let b=0;b<g.length;b++){const w=g[b];let S=40+(r.sensitive?.25:0);if(w.type===0)b||(a+="/"),a+=w.value.replace(fS,"\\$&"),S+=40;else if(w.type===1){const{value:M,repeatable:A,optional:E,regexp:T}=w;u.push({name:M,repeatable:A,optional:E});const L=T||dg;if(L!==dg){S+=10;try{new RegExp(`(${L})`)}catch(P){throw new Error(`Invalid custom RegExp for param "${M}" (${L}): `+P.message)}}let $=A?`((?:${L})(?:/(?:${L}))*)`:`(${L})`;b||($=E&&g.length<2?`(?:/${$})`:"/"+$),E&&($+="?"),a+=$,S+=20,E&&(S+=-8),A&&(S+=-20),L===".*"&&(S+=-50)}v.push(S)}o.push(v)}if(r.strict&&r.end){const g=o.length-1;o[g][o[g].length-1]+=.7000000000000001}r.strict||(a+="/?"),r.end?a+="$":r.strict&&(a+="(?:/|$)");const f=new RegExp(a,r.sensitive?"":"i");function h(g){const v=g.match(f),b={};if(!v)return null;for(let w=1;w<v.length;w++){const S=v[w]||"",M=u[w-1];b[M.name]=S&&M.repeatable?S.split("/"):S}return b}function d(g){let v="",b=!1;for(const w of t){(!b||!v.endsWith("/"))&&(v+="/"),b=!1;for(const S of w)if(S.type===0)v+=S.value;else if(S.type===1){const{value:M,repeatable:A,optional:E}=S,T=M in g?g[M]:"";if(Zn(T)&&!A)throw new Error(`Provided param "${M}" is an array but it is not repeatable (* or + modifiers)`);const L=Zn(T)?T.join("/"):T;if(!L)if(E)w.length<2&&(v.endsWith("/")?v=v.slice(0,-1):b=!0);else throw new Error(`Missing required param "${M}"`);v+=L}}return v||"/"}return{re:f,score:o,keys:u,parse:h,stringify:d}}function dS(t,n){let r=0;for(;r<t.length&&r<n.length;){const o=n[r]-t[r];if(o)return o;r++}return t.length<n.length?t.length===1&&t[0]===40+40?-1:1:t.length>n.length?n.length===1&&n[0]===40+40?1:-1:0}function pS(t,n){let r=0;const o=t.score,a=n.score;for(;r<o.length&&r<a.length;){const u=dS(o[r],a[r]);if(u)return u;r++}if(Math.abs(a.length-o.length)===1){if(pg(o))return 1;if(pg(a))return-1}return a.length-o.length}function pg(t){const n=t[t.length-1];return t.length>0&&n[n.length-1]<0}const gS={type:0,value:""},vS=/[a-zA-Z0-9_]/;function mS(t){if(!t)return[[]];if(t==="/")return[[gS]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function n(S){throw new Error(`ERR (${r})/"${g}": ${S}`)}let r=0,o=r;const a=[];let u;function f(){u&&a.push(u),u=[]}let h=0,d,g="",v="";function b(){!g||(r===0?u.push({type:0,value:g}):r===1||r===2||r===3?(u.length>1&&(d==="*"||d==="+")&&n(`A repeatable param (${g}) must be alone in its segment. eg: '/:ids+.`),u.push({type:1,value:g,regexp:v,repeatable:d==="*"||d==="+",optional:d==="*"||d==="?"})):n("Invalid state to consume buffer"),g="")}function w(){g+=d}for(;h<t.length;){if(d=t[h++],d==="\\"&&r!==2){o=r,r=4;continue}switch(r){case 0:d==="/"?(g&&b(),f()):d===":"?(b(),r=1):w();break;case 4:w(),r=o;break;case 1:d==="("?r=2:vS.test(d)?w():(b(),r=0,d!=="*"&&d!=="?"&&d!=="+"&&h--);break;case 2:d===")"?v[v.length-1]=="\\"?v=v.slice(0,-1)+d:r=3:v+=d;break;case 3:b(),r=0,d!=="*"&&d!=="?"&&d!=="+"&&h--,v="";break;default:n("Unknown state");break}}return r===2&&n(`Unfinished custom RegExp for param "${g}"`),b(),f(),a}function yS(t,n,r){const o=hS(mS(t.path),r),a=de(o,{record:t,parent:n,children:[],alias:[]});return n&&!a.record.aliasOf==!n.record.aliasOf&&n.children.push(a),a}function bS(t,n){const r=[],o=new Map;n=mg({strict:!1,end:!0,sensitive:!1},n);function a(v){return o.get(v)}function u(v,b,w){const S=!w,M=wS(v);M.aliasOf=w&&w.record;const A=mg(n,v),E=[M];if("alias"in v){const $=typeof v.alias=="string"?[v.alias]:v.alias;for(const P of $)E.push(de({},M,{components:w?w.record.components:M.components,path:P,aliasOf:w?w.record:M}))}let T,L;for(const $ of E){const{path:P}=$;if(b&&P[0]!=="/"){const G=b.record.path,V=G[G.length-1]==="/"?"":"/";$.path=b.record.path+(P&&V+P)}if(T=yS($,b,A),w?w.alias.push(T):(L=L||T,L!==T&&L.alias.push(T),S&&v.name&&!vg(T)&&f(v.name)),M.children){const G=M.children;for(let V=0;V<G.length;V++)u(G[V],T,w&&w.children[V])}w=w||T,(T.record.components&&Object.keys(T.record.components).length||T.record.name||T.record.redirect)&&d(T)}return L?()=>{f(L)}:js}function f(v){if(Ym(v)){const b=o.get(v);b&&(o.delete(v),r.splice(r.indexOf(b),1),b.children.forEach(f),b.alias.forEach(f))}else{const b=r.indexOf(v);b>-1&&(r.splice(b,1),v.record.name&&o.delete(v.record.name),v.children.forEach(f),v.alias.forEach(f))}}function h(){return r}function d(v){let b=0;for(;b<r.length&&pS(v,r[b])>=0&&(v.record.path!==r[b].record.path||!Jm(v,r[b]));)b++;r.splice(b,0,v),v.record.name&&!vg(v)&&o.set(v.record.name,v)}function g(v,b){let w,S={},M,A;if("name"in v&&v.name){if(w=o.get(v.name),!w)throw Wo(1,{location:v});A=w.record.name,S=de(gg(b.params,w.keys.filter(L=>!L.optional).map(L=>L.name)),v.params&&gg(v.params,w.keys.map(L=>L.name))),M=w.stringify(S)}else if("path"in v)M=v.path,w=r.find(L=>L.re.test(M)),w&&(S=w.parse(M),A=w.record.name);else{if(w=b.name?o.get(b.name):r.find(L=>L.re.test(b.path)),!w)throw Wo(1,{location:v,currentLocation:b});A=w.record.name,S=de({},b.params,v.params),M=w.stringify(S)}const E=[];let T=w;for(;T;)E.unshift(T.record),T=T.parent;return{name:A,path:M,params:S,matched:E,meta:_S(E)}}return t.forEach(v=>u(v)),{addRoute:u,resolve:g,removeRoute:f,getRoutes:h,getRecordMatcher:a}}function gg(t,n){const r={};for(const o of n)o in t&&(r[o]=t[o]);return r}function wS(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:xS(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function xS(t){const n={},r=t.props||!1;if("component"in t)n.default=r;else for(const o in t.components)n[o]=typeof r=="boolean"?r:r[o];return n}function vg(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function _S(t){return t.reduce((n,r)=>de(n,r.meta),{})}function mg(t,n){const r={};for(const o in t)r[o]=o in n?n[o]:t[o];return r}function Jm(t,n){return n.children.some(r=>r===t||Jm(t,r))}const Qm=/#/g,SS=/&/g,kS=/\//g,CS=/=/g,TS=/\?/g,t0=/\+/g,LS=/%5B/g,ES=/%5D/g,e0=/%5E/g,AS=/%60/g,n0=/%7B/g,MS=/%7C/g,r0=/%7D/g,NS=/%20/g;function th(t){return encodeURI(""+t).replace(MS,"|").replace(LS,"[").replace(ES,"]")}function OS(t){return th(t).replace(n0,"{").replace(r0,"}").replace(e0,"^")}function nf(t){return th(t).replace(t0,"%2B").replace(NS,"+").replace(Qm,"%23").replace(SS,"%26").replace(AS,"`").replace(n0,"{").replace(r0,"}").replace(e0,"^")}function PS(t){return nf(t).replace(CS,"%3D")}function $S(t){return th(t).replace(Qm,"%23").replace(TS,"%3F")}function DS(t){return t==null?"":$S(t).replace(kS,"%2F")}function Pa(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function RS(t){const n={};if(t===""||t==="?")return n;const o=(t[0]==="?"?t.slice(1):t).split("&");for(let a=0;a<o.length;++a){const u=o[a].replace(t0," "),f=u.indexOf("="),h=Pa(f<0?u:u.slice(0,f)),d=f<0?null:Pa(u.slice(f+1));if(h in n){let g=n[h];Zn(g)||(g=n[h]=[g]),g.push(d)}else n[h]=d}return n}function yg(t){let n="";for(let r in t){const o=t[r];if(r=PS(r),o==null){o!==void 0&&(n+=(n.length?"&":"")+r);continue}(Zn(o)?o.map(u=>u&&nf(u)):[o&&nf(o)]).forEach(u=>{u!==void 0&&(n+=(n.length?"&":"")+r,u!=null&&(n+="="+u))})}return n}function zS(t){const n={};for(const r in t){const o=t[r];o!==void 0&&(n[r]=Zn(o)?o.map(a=>a==null?null:""+a):o==null?o:""+o)}return n}const IS=Symbol(""),bg=Symbol(""),eh=Symbol(""),i0=Symbol(""),rf=Symbol("");function Rs(){let t=[];function n(o){return t.push(o),()=>{const a=t.indexOf(o);a>-1&&t.splice(a,1)}}function r(){t=[]}return{add:n,list:()=>t,reset:r}}function si(t,n,r,o,a){const u=o&&(o.enterCallbacks[a]=o.enterCallbacks[a]||[]);return()=>new Promise((f,h)=>{const d=b=>{b===!1?h(Wo(4,{from:r,to:n})):b instanceof Error?h(b):cS(b)?h(Wo(2,{from:n,to:b})):(u&&o.enterCallbacks[a]===u&&typeof b=="function"&&u.push(b),f())},g=t.call(o&&o.instances[a],n,r,d);let v=Promise.resolve(g);t.length<3&&(v=v.then(d)),v.catch(b=>h(b))})}function Mu(t,n,r,o){const a=[];for(const u of t)for(const f in u.components){let h=u.components[f];if(!(n!=="beforeRouteEnter"&&!u.instances[f]))if(FS(h)){const g=(h.__vccOpts||h)[n];g&&a.push(si(g,r,o,u,f))}else{let d=h();a.push(()=>d.then(g=>{if(!g)return Promise.reject(new Error(`Couldn't resolve component "${f}" at "${u.path}"`));const v=j_(g)?g.default:g;u.components[f]=v;const w=(v.__vccOpts||v)[n];return w&&si(w,r,o,u,f)()}))}}return a}function FS(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function wg(t){const n=Pr(eh),r=Pr(i0),o=_t(()=>n.resolve(j(t.to))),a=_t(()=>{const{matched:d}=o.value,{length:g}=d,v=d[g-1],b=r.matched;if(!v||!b.length)return-1;const w=b.findIndex(Bo.bind(null,v));if(w>-1)return w;const S=xg(d[g-2]);return g>1&&xg(v)===S&&b[b.length-1].path!==S?b.findIndex(Bo.bind(null,d[g-2])):w}),u=_t(()=>a.value>-1&&WS(r.params,o.value.params)),f=_t(()=>a.value>-1&&a.value===r.matched.length-1&&Km(r.params,o.value.params));function h(d={}){return BS(d)?n[j(t.replace)?"replace":"push"](j(t.to)).catch(js):Promise.resolve()}return{route:o,href:_t(()=>o.value.href),isActive:u,isExactActive:f,navigate:h}}const qS=re({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:wg,setup(t,{slots:n}){const r=On(wg(t)),{options:o}=Pr(eh),a=_t(()=>({[_g(t.activeClass,o.linkActiveClass,"router-link-active")]:r.isActive,[_g(t.exactActiveClass,o.linkExactActiveClass,"router-link-exact-active")]:r.isExactActive}));return()=>{const u=n.default&&n.default(r);return t.custom?u:pl("a",{"aria-current":r.isExactActive?t.ariaCurrentValue:null,href:r.href,onClick:r.navigate,class:a.value},u)}}}),HS=qS;function BS(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const n=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(n))return}return t.preventDefault&&t.preventDefault(),!0}}function WS(t,n){for(const r in n){const o=n[r],a=t[r];if(typeof o=="string"){if(o!==a)return!1}else if(!Zn(a)||a.length!==o.length||o.some((u,f)=>u!==a[f]))return!1}return!0}function xg(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const _g=(t,n,r)=>t??n??r,US=re({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:n,slots:r}){const o=Pr(rf),a=_t(()=>t.route||o.value),u=Pr(bg,0),f=_t(()=>{let g=j(u);const{matched:v}=a.value;let b;for(;(b=v[g])&&!b.components;)g++;return g}),h=_t(()=>a.value.matched[f.value]);ya(bg,_t(()=>f.value+1)),ya(IS,h),ya(rf,a);const d=Kt();return Fe(()=>[d.value,h.value,t.name],([g,v,b],[w,S,M])=>{v&&(v.instances[b]=g,S&&S!==v&&g&&g===w&&(v.leaveGuards.size||(v.leaveGuards=S.leaveGuards),v.updateGuards.size||(v.updateGuards=S.updateGuards))),g&&v&&(!S||!Bo(v,S)||!w)&&(v.enterCallbacks[b]||[]).forEach(A=>A(g))},{flush:"post"}),()=>{const g=a.value,v=t.name,b=h.value,w=b&&b.components[v];if(!w)return Sg(r.default,{Component:w,route:g});const S=b.props[v],M=S?S===!0?g.params:typeof S=="function"?S(g):S:null,E=pl(w,de({},M,n,{onVnodeUnmounted:T=>{T.component.isUnmounted&&(b.instances[v]=null)},ref:d}));return Sg(r.default,{Component:E,route:g})||E}}});function Sg(t,n){if(!t)return null;const r=t(n);return r.length===1?r[0]:r}const jS=US;function GS(t){const n=bS(t.routes,t),r=t.parseQuery||RS,o=t.stringifyQuery||yg,a=t.history,u=Rs(),f=Rs(),h=Rs(),d=fl(ii);let g=ii;Eo&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const v=Eu.bind(null,Q=>""+Q),b=Eu.bind(null,DS),w=Eu.bind(null,Pa);function S(Q,tt){let K,st;return Ym(Q)?(K=n.getRecordMatcher(Q),st=tt):st=Q,n.addRoute(st,K)}function M(Q){const tt=n.getRecordMatcher(Q);tt&&n.removeRoute(tt)}function A(){return n.getRoutes().map(Q=>Q.record)}function E(Q){return!!n.getRecordMatcher(Q)}function T(Q,tt){if(tt=de({},tt||d.value),typeof Q=="string"){const O=Au(r,Q,tt.path),F=n.resolve({path:O.path},tt),Z=a.createHref(O.fullPath);return de(O,F,{params:w(F.params),hash:Pa(O.hash),redirectedFrom:void 0,href:Z})}let K;if("path"in Q)K=de({},Q,{path:Au(r,Q.path,tt.path).path});else{const O=de({},Q.params);for(const F in O)O[F]==null&&delete O[F];K=de({},Q,{params:b(Q.params)}),tt.params=b(tt.params)}const st=n.resolve(K,tt),Ct=Q.hash||"";st.params=v(w(st.params));const pe=K_(o,de({},Q,{hash:OS(Ct),path:st.path})),Lt=a.createHref(pe);return de({fullPath:pe,hash:Ct,query:o===yg?zS(Q.query):Q.query||{}},st,{redirectedFrom:void 0,href:Lt})}function L(Q){return typeof Q=="string"?Au(r,Q,d.value.path):de({},Q)}function $(Q,tt){if(g!==Q)return Wo(8,{from:tt,to:Q})}function P(Q){return rt(Q)}function G(Q){return P(de(L(Q),{replace:!0}))}function V(Q){const tt=Q.matched[Q.matched.length-1];if(tt&&tt.redirect){const{redirect:K}=tt;let st=typeof K=="function"?K(Q):K;return typeof st=="string"&&(st=st.includes("?")||st.includes("#")?st=L(st):{path:st},st.params={}),de({query:Q.query,hash:Q.hash,params:"path"in st?{}:Q.params},st)}}function rt(Q,tt){const K=g=T(Q),st=d.value,Ct=Q.state,pe=Q.force,Lt=Q.replace===!0,O=V(K);if(O)return rt(de(L(O),{state:typeof O=="object"?de({},Ct,O.state):Ct,force:pe,replace:Lt}),tt||K);const F=K;F.redirectedFrom=tt;let Z;return!pe&&X_(o,st,K)&&(Z=Wo(16,{to:F,from:st}),At(st,st,!0,!1)),(Z?Promise.resolve(Z):dt(F,st)).catch(nt=>Tr(nt)?Tr(nt,2)?nt:wt(nt):W(nt,F,st)).then(nt=>{if(nt){if(Tr(nt,2))return rt(de({replace:Lt},L(nt.to),{state:typeof nt.to=="object"?de({},Ct,nt.to.state):Ct,force:pe}),tt||F)}else nt=kt(F,st,!0,Lt,Ct);return gt(F,st,nt),nt})}function J(Q,tt){const K=$(Q,tt);return K?Promise.reject(K):Promise.resolve()}function dt(Q,tt){let K;const[st,Ct,pe]=VS(Q,tt);K=Mu(st.reverse(),"beforeRouteLeave",Q,tt);for(const O of st)O.leaveGuards.forEach(F=>{K.push(si(F,Q,tt))});const Lt=J.bind(null,Q,tt);return K.push(Lt),ko(K).then(()=>{K=[];for(const O of u.list())K.push(si(O,Q,tt));return K.push(Lt),ko(K)}).then(()=>{K=Mu(Ct,"beforeRouteUpdate",Q,tt);for(const O of Ct)O.updateGuards.forEach(F=>{K.push(si(F,Q,tt))});return K.push(Lt),ko(K)}).then(()=>{K=[];for(const O of Q.matched)if(O.beforeEnter&&!tt.matched.includes(O))if(Zn(O.beforeEnter))for(const F of O.beforeEnter)K.push(si(F,Q,tt));else K.push(si(O.beforeEnter,Q,tt));return K.push(Lt),ko(K)}).then(()=>(Q.matched.forEach(O=>O.enterCallbacks={}),K=Mu(pe,"beforeRouteEnter",Q,tt),K.push(Lt),ko(K))).then(()=>{K=[];for(const O of f.list())K.push(si(O,Q,tt));return K.push(Lt),ko(K)}).catch(O=>Tr(O,8)?O:Promise.reject(O))}function gt(Q,tt,K){for(const st of h.list())st(Q,tt,K)}function kt(Q,tt,K,st,Ct){const pe=$(Q,tt);if(pe)return pe;const Lt=tt===ii,O=Eo?history.state:{};K&&(st||Lt?a.replace(Q.fullPath,de({scroll:Lt&&O&&O.scroll},Ct)):a.push(Q.fullPath,Ct)),d.value=Q,At(Q,tt,K,Lt),wt()}let ut;function U(){ut||(ut=a.listen((Q,tt,K)=>{if(!ie.listening)return;const st=T(Q),Ct=V(st);if(Ct){rt(de(Ct,{replace:!0}),st).catch(js);return}g=st;const pe=d.value;Eo&&rS(ug(pe.fullPath,K.delta),fc()),dt(st,pe).catch(Lt=>Tr(Lt,12)?Lt:Tr(Lt,2)?(rt(Lt.to,st).then(O=>{Tr(O,20)&&!K.delta&&K.type===nl.pop&&a.go(-1,!1)}).catch(js),Promise.reject()):(K.delta&&a.go(-K.delta,!1),W(Lt,st,pe))).then(Lt=>{Lt=Lt||kt(st,pe,!1),Lt&&(K.delta&&!Tr(Lt,8)?a.go(-K.delta,!1):K.type===nl.pop&&Tr(Lt,20)&&a.go(-1,!1)),gt(st,pe,Lt)}).catch(js)}))}let z=Rs(),k=Rs(),H;function W(Q,tt,K){wt(Q);const st=k.list();return st.length?st.forEach(Ct=>Ct(Q,tt,K)):console.error(Q),Promise.reject(Q)}function et(){return H&&d.value!==ii?Promise.resolve():new Promise((Q,tt)=>{z.add([Q,tt])})}function wt(Q){return H||(H=!Q,U(),z.list().forEach(([tt,K])=>Q?K(Q):tt()),z.reset()),Q}function At(Q,tt,K,st){const{scrollBehavior:Ct}=t;if(!Eo||!Ct)return Promise.resolve();const pe=!K&&iS(ug(Q.fullPath,0))||(st||!K)&&history.state&&history.state.scroll||null;return Qo().then(()=>Ct(Q,tt,pe)).then(Lt=>Lt&&nS(Lt)).catch(Lt=>W(Lt,Q,tt))}const qt=Q=>a.go(Q);let Bt;const Gt=new Set,ie={currentRoute:d,listening:!0,addRoute:S,removeRoute:M,hasRoute:E,getRoutes:A,resolve:T,options:t,push:P,replace:G,go:qt,back:()=>qt(-1),forward:()=>qt(1),beforeEach:u.add,beforeResolve:f.add,afterEach:h.add,onError:k.add,isReady:et,install(Q){const tt=this;Q.component("RouterLink",HS),Q.component("RouterView",jS),Q.config.globalProperties.$router=tt,Object.defineProperty(Q.config.globalProperties,"$route",{enumerable:!0,get:()=>j(d)}),Eo&&!Bt&&d.value===ii&&(Bt=!0,P(a.location).catch(Ct=>{}));const K={};for(const Ct in ii)K[Ct]=_t(()=>d.value[Ct]);Q.provide(eh,tt),Q.provide(i0,On(K)),Q.provide(rf,d);const st=Q.unmount;Gt.add(Q),Q.unmount=function(){Gt.delete(Q),Gt.size<1&&(g=ii,ut&&ut(),ut=null,d.value=ii,Bt=!1,H=!1),st()}}};return ie}function ko(t){return t.reduce((n,r)=>n.then(()=>r()),Promise.resolve())}function VS(t,n){const r=[],o=[],a=[],u=Math.max(n.matched.length,t.matched.length);for(let f=0;f<u;f++){const h=n.matched[f];h&&(t.matched.find(g=>Bo(g,h))?o.push(h):r.push(h));const d=t.matched[f];d&&(n.matched.find(g=>Bo(g,d))||a.push(d))}return[r,o,a]}function Hr(t){return t.split("-")[0]}function $o(t){return t.split("-")[1]}function gl(t){return["top","bottom"].includes(Hr(t))?"x":"y"}function nh(t){return t==="y"?"height":"width"}function kg(t){let{reference:n,floating:r,placement:o}=t;const a=n.x+n.width/2-r.width/2,u=n.y+n.height/2-r.height/2;let f;switch(Hr(o)){case"top":f={x:a,y:n.y-r.height};break;case"bottom":f={x:a,y:n.y+n.height};break;case"right":f={x:n.x+n.width,y:u};break;case"left":f={x:n.x-r.width,y:u};break;default:f={x:n.x,y:n.y}}const h=gl(o),d=nh(h);switch($o(o)){case"start":f[h]=f[h]-(n[d]/2-r[d]/2);break;case"end":f[h]=f[h]+(n[d]/2-r[d]/2);break}return f}const KS=async(t,n,r)=>{const{placement:o="bottom",strategy:a="absolute",middleware:u=[],platform:f}=r;let h=await f.getElementRects({reference:t,floating:n,strategy:a}),{x:d,y:g}=kg({...h,placement:o}),v=o,b={};for(let w=0;w<u.length;w++){const{name:S,fn:M}=u[w],{x:A,y:E,data:T,reset:L}=await M({x:d,y:g,initialPlacement:o,placement:v,strategy:a,middlewareData:b,rects:h,platform:f,elements:{reference:t,floating:n}});if(d=A??d,g=E??g,b={...b,[S]:T??{}},L){typeof L=="object"&&(L.placement&&(v=L.placement),L.rects&&(h=L.rects===!0?await f.getElementRects({reference:t,floating:n,strategy:a}):L.rects),{x:d,y:g}=kg({...h,placement:v})),w=-1;continue}}return{x:d,y:g,placement:v,strategy:a,middlewareData:b}};function XS(t){return{top:0,right:0,bottom:0,left:0,...t}}function o0(t){return typeof t!="number"?XS(t):{top:t,right:t,bottom:t,left:t}}function of(t){return{...t,top:t.y,left:t.x,right:t.x+t.width,bottom:t.y+t.height}}async function hc(t,n){n===void 0&&(n={});const{x:r,y:o,platform:a,rects:u,elements:f,strategy:h}=t,{boundary:d="clippingParents",rootBoundary:g="viewport",elementContext:v="floating",altBoundary:b=!1,padding:w=0}=n,S=o0(w),A=f[b?v==="floating"?"reference":"floating":v],E=await a.getClippingClientRect({element:await a.isElement(A)?A:A.contextElement||await a.getDocumentElement({element:f.floating}),boundary:d,rootBoundary:g}),T=of(await a.convertOffsetParentRelativeRectToViewportRelativeRect({rect:v==="floating"?{...u.floating,x:r,y:o}:u.reference,offsetParent:await a.getOffsetParent({element:f.floating}),strategy:h}));return{top:E.top-T.top+S.top,bottom:T.bottom-E.bottom+S.bottom,left:E.left-T.left+S.left,right:T.right-E.right+S.right}}const YS=Math.min,zi=Math.max;function sf(t,n,r){return zi(t,YS(n,r))}const ZS=t=>({name:"arrow",options:t,async fn(n){const{element:r,padding:o=0}=t??{},{x:a,y:u,placement:f,rects:h,platform:d}=n;if(r==null)return{};const g=o0(o),v={x:a,y:u},b=Hr(f),w=gl(b),S=nh(w),M=await d.getDimensions({element:r}),A=w==="y"?"top":"left",E=w==="y"?"bottom":"right",T=h.reference[S]+h.reference[w]-v[w]-h.floating[S],L=v[w]-h.reference[w],$=await d.getOffsetParent({element:r}),P=$?w==="y"?$.clientHeight||0:$.clientWidth||0:0,G=T/2-L/2,V=g[A],rt=P-M[S]-g[E],J=P/2-M[S]/2+G,dt=sf(V,J,rt);return{data:{[w]:dt,centerOffset:J-dt}}}}),JS={left:"right",right:"left",bottom:"top",top:"bottom"};function $a(t){return t.replace(/left|right|bottom|top/g,n=>JS[n])}function s0(t,n){const r=$o(t)==="start",o=gl(t),a=nh(o);let u=o==="x"?r?"right":"left":r?"bottom":"top";return n.reference[a]>n.floating[a]&&(u=$a(u)),{main:u,cross:$a(u)}}const QS={start:"end",end:"start"};function lf(t){return t.replace(/start|end/g,n=>QS[n])}const tk=["top","right","bottom","left"],ek=tk.reduce((t,n)=>t.concat(n,n+"-start",n+"-end"),[]);function nk(t,n,r){return(t?[...r.filter(a=>$o(a)===t),...r.filter(a=>$o(a)!==t)]:r.filter(a=>Hr(a)===a)).filter(a=>t?$o(a)===t||(n?lf(a)!==a:!1):!0)}const rk=function(t){return t===void 0&&(t={}),{name:"autoPlacement",options:t,async fn(n){var r,o,a,u,f,h;const{x:d,y:g,rects:v,middlewareData:b,placement:w}=n,{alignment:S=null,allowedPlacements:M=ek,autoAlignment:A=!0,...E}=t;if((r=b.autoPlacement)!=null&&r.skip)return{};const T=nk(S,A,M),L=await hc(n,E),$=(o=(a=b.autoPlacement)==null?void 0:a.index)!=null?o:0,P=T[$],{main:G,cross:V}=s0(P,v);if(w!==P)return{x:d,y:g,reset:{placement:T[0]}};const rt=[L[Hr(P)],L[G],L[V]],J=[...(u=(f=b.autoPlacement)==null?void 0:f.overflows)!=null?u:[],{placement:P,overflows:rt}],dt=T[$+1];if(dt)return{data:{index:$+1,overflows:J},reset:{placement:dt}};const gt=J.slice().sort((ut,U)=>ut.overflows[0]-U.overflows[0]),kt=(h=gt.find(ut=>{let{overflows:U}=ut;return U.every(z=>z<=0)}))==null?void 0:h.placement;return{data:{skip:!0},reset:{placement:kt??gt[0].placement}}}}};function ik(t){const n=$a(t);return[lf(t),n,lf(n)]}const ok=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(n){var r,o;const{placement:a,middlewareData:u,rects:f,initialPlacement:h}=n;if((r=u.flip)!=null&&r.skip)return{};const{mainAxis:d=!0,crossAxis:g=!0,fallbackPlacements:v,fallbackStrategy:b="bestFit",flipAlignment:w=!0,...S}=t,M=Hr(a),E=v||(M===h||!w?[$a(h)]:ik(h)),T=[h,...E],L=await hc(n,S),$=[];let P=((o=u.flip)==null?void 0:o.overflows)||[];if(d&&$.push(L[M]),g){const{main:J,cross:dt}=s0(a,f);$.push(L[J],L[dt])}if(P=[...P,{placement:a,overflows:$}],!$.every(J=>J<=0)){var G,V;const J=((G=(V=u.flip)==null?void 0:V.index)!=null?G:0)+1,dt=T[J];if(dt)return{data:{index:J,overflows:P},reset:{placement:dt}};let gt="bottom";switch(b){case"bestFit":{var rt;const kt=(rt=P.slice().sort((ut,U)=>ut.overflows.filter(z=>z>0).reduce((z,k)=>z+k,0)-U.overflows.filter(z=>z>0).reduce((z,k)=>z+k,0))[0])==null?void 0:rt.placement;kt&&(gt=kt);break}case"initialPlacement":gt=h;break}return{data:{skip:!0},reset:{placement:gt}}}return{}}}};function sk(t){let{placement:n,rects:r,value:o}=t;const a=Hr(n),u=["left","top"].includes(a)?-1:1,f=typeof o=="function"?o({...r,placement:n}):o,{mainAxis:h,crossAxis:d}=typeof f=="number"?{mainAxis:f,crossAxis:0}:{mainAxis:0,crossAxis:0,...f};return gl(a)==="x"?{x:d,y:h*u}:{x:h*u,y:d}}const lk=function(t){return t===void 0&&(t=0),{name:"offset",options:t,fn(n){const{x:r,y:o,placement:a,rects:u}=n,f=sk({placement:a,rects:u,value:t});return{x:r+f.x,y:o+f.y,data:f}}}};function ak(t){return t==="x"?"y":"x"}const ck=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(n){const{x:r,y:o,placement:a}=n,{mainAxis:u=!0,crossAxis:f=!1,limiter:h={fn:E=>{let{x:T,y:L}=E;return{x:T,y:L}}},...d}=t,g={x:r,y:o},v=await hc(n,d),b=gl(Hr(a)),w=ak(b);let S=g[b],M=g[w];if(u){const E=b==="y"?"top":"left",T=b==="y"?"bottom":"right",L=S+v[E],$=S-v[T];S=sf(L,S,$)}if(f){const E=w==="y"?"top":"left",T=w==="y"?"bottom":"right",L=M+v[E],$=M-v[T];M=sf(L,M,$)}const A=h.fn({...n,[b]:S,[w]:M});return{...A,data:{x:A.x-r,y:A.y-o}}}}},uk=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(n){var r;const{placement:o,rects:a,middlewareData:u}=n,{apply:f,...h}=t;if((r=u.size)!=null&&r.skip)return{};const d=await hc(n,h),g=Hr(o),v=$o(o)==="end";let b,w;g==="top"||g==="bottom"?(b=g,w=v?"left":"right"):(w=g,b=v?"top":"bottom");const S=zi(d.left,0),M=zi(d.right,0),A=zi(d.top,0),E=zi(d.bottom,0),T={height:a.floating.height-(["left","right"].includes(o)?2*(A!==0||E!==0?A+E:zi(d.top,d.bottom)):d[b]),width:a.floating.width-(["top","bottom"].includes(o)?2*(S!==0||M!==0?S+M:zi(d.left,d.right)):d[w])};return f==null||f({...T,...a}),{data:{skip:!0},reset:{rects:!0}}}}};function rh(t){return(t==null?void 0:t.toString())==="[object Window]"}function mi(t){if(t==null)return window;if(!rh(t)){const n=t.ownerDocument;return n&&n.defaultView||window}return t}function dc(t){return mi(t).getComputedStyle(t)}function Rr(t){return rh(t)?"":t?(t.nodeName||"").toLowerCase():""}function zr(t){return t instanceof mi(t).HTMLElement}function Da(t){return t instanceof mi(t).Element}function fk(t){return t instanceof mi(t).Node}function l0(t){const n=mi(t).ShadowRoot;return t instanceof n||t instanceof ShadowRoot}function pc(t){const{overflow:n,overflowX:r,overflowY:o}=dc(t);return/auto|scroll|overlay|hidden/.test(n+o+r)}function hk(t){return["table","td","th"].includes(Rr(t))}function a0(t){const n=navigator.userAgent.toLowerCase().includes("firefox"),r=dc(t);return r.transform!=="none"||r.perspective!=="none"||r.contain==="paint"||["transform","perspective"].includes(r.willChange)||n&&r.willChange==="filter"||n&&(r.filter?r.filter!=="none":!1)}const Cg=Math.min,Vs=Math.max,Ra=Math.round;function Uo(t,n){n===void 0&&(n=!1);const r=t.getBoundingClientRect();let o=1,a=1;return n&&zr(t)&&(o=t.offsetWidth>0&&Ra(r.width)/t.offsetWidth||1,a=t.offsetHeight>0&&Ra(r.height)/t.offsetHeight||1),{width:r.width/o,height:r.height/a,top:r.top/a,right:r.right/o,bottom:r.bottom/a,left:r.left/o,x:r.left/o,y:r.top/a}}function yi(t){return((fk(t)?t.ownerDocument:t.document)||window.document).documentElement}function gc(t){return rh(t)?{scrollLeft:t.pageXOffset,scrollTop:t.pageYOffset}:{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}}function c0(t){return Uo(yi(t)).left+gc(t).scrollLeft}function dk(t){const n=Uo(t);return Ra(n.width)!==t.offsetWidth||Ra(n.height)!==t.offsetHeight}function pk(t,n,r){const o=zr(n),a=yi(n),u=Uo(t,o&&dk(n));let f={scrollLeft:0,scrollTop:0};const h={x:0,y:0};if(o||!o&&r!=="fixed")if((Rr(n)!=="body"||pc(a))&&(f=gc(n)),zr(n)){const d=Uo(n,!0);h.x=d.x+n.clientLeft,h.y=d.y+n.clientTop}else a&&(h.x=c0(a));return{x:u.left+f.scrollLeft-h.x,y:u.top+f.scrollTop-h.y,width:u.width,height:u.height}}function vc(t){return Rr(t)==="html"?t:t.assignedSlot||t.parentNode||(l0(t)?t.host:null)||yi(t)}function Tg(t){return!zr(t)||getComputedStyle(t).position==="fixed"?null:t.offsetParent}function gk(t){let n=vc(t);for(;zr(n)&&!["html","body"].includes(Rr(n));){if(a0(n))return n;n=n.parentNode}return null}function af(t){const n=mi(t);let r=Tg(t);for(;r&&hk(r)&&getComputedStyle(r).position==="static";)r=Tg(r);return r&&(Rr(r)==="html"||Rr(r)==="body"&&getComputedStyle(r).position==="static"&&!a0(r))?n:r||gk(t)||n}function Lg(t){return{width:t.offsetWidth,height:t.offsetHeight}}function vk(t){let{rect:n,offsetParent:r,strategy:o}=t;const a=zr(r),u=yi(r);if(r===u)return n;let f={scrollLeft:0,scrollTop:0};const h={x:0,y:0};if((a||!a&&o!=="fixed")&&((Rr(r)!=="body"||pc(u))&&(f=gc(r)),zr(r))){const d=Uo(r,!0);h.x=d.x+r.clientLeft,h.y=d.y+r.clientTop}return{...n,x:n.x-f.scrollLeft+h.x,y:n.y-f.scrollTop+h.y}}function mk(t){const n=mi(t),r=yi(t),o=n.visualViewport;let a=r.clientWidth,u=r.clientHeight,f=0,h=0;return o&&(a=o.width,u=o.height,Math.abs(n.innerWidth/o.scale-o.width)<.01&&(f=o.offsetLeft,h=o.offsetTop)),{width:a,height:u,x:f,y:h}}function yk(t){var n;const r=yi(t),o=gc(t),a=(n=t.ownerDocument)==null?void 0:n.body,u=Vs(r.scrollWidth,r.clientWidth,a?a.scrollWidth:0,a?a.clientWidth:0),f=Vs(r.scrollHeight,r.clientHeight,a?a.scrollHeight:0,a?a.clientHeight:0);let h=-o.scrollLeft+c0(t);const d=-o.scrollTop;return dc(a||r).direction==="rtl"&&(h+=Vs(r.clientWidth,a?a.clientWidth:0)-u),{width:u,height:f,x:h,y:d}}function u0(t){return["html","body","#document"].includes(Rr(t))?t.ownerDocument.body:zr(t)&&pc(t)?t:u0(vc(t))}function za(t,n){var r;n===void 0&&(n=[]);const o=u0(t),a=o===((r=t.ownerDocument)==null?void 0:r.body),u=mi(o),f=a?[u].concat(u.visualViewport||[],pc(o)?o:[]):o,h=n.concat(f);return a?h:h.concat(za(vc(f)))}function bk(t,n){const r=n.getRootNode==null?void 0:n.getRootNode();if(t.contains(n))return!0;if(r&&l0(r)){let o=n;do{if(o&&t===o)return!0;o=o.parentNode||o.host}while(o)}return!1}function wk(t){const n=Uo(t),r=n.top+t.clientTop,o=n.left+t.clientLeft;return{top:r,left:o,x:o,y:r,right:o+t.clientWidth,bottom:r+t.clientHeight,width:t.clientWidth,height:t.clientHeight}}function Eg(t,n){return n==="viewport"?of(mk(t)):Da(n)?wk(n):of(yk(yi(t)))}function xk(t){const n=za(vc(t)),o=["absolute","fixed"].includes(dc(t).position)&&zr(t)?af(t):t;return Da(o)?n.filter(a=>Da(a)&&bk(a,o)&&Rr(a)!=="body"):[]}function _k(t){let{element:n,boundary:r,rootBoundary:o}=t;const u=[...r==="clippingParents"?xk(n):[].concat(r),o],f=u[0],h=u.reduce((d,g)=>{const v=Eg(n,g);return d.top=Vs(v.top,d.top),d.right=Cg(v.right,d.right),d.bottom=Cg(v.bottom,d.bottom),d.left=Vs(v.left,d.left),d},Eg(n,f));return h.width=h.right-h.left,h.height=h.bottom-h.top,h.x=h.left,h.y=h.top,h}const Sk={getElementRects:t=>{let{reference:n,floating:r,strategy:o}=t;return{reference:pk(n,af(r),o),floating:{...Lg(r),x:0,y:0}}},convertOffsetParentRelativeRectToViewportRelativeRect:t=>vk(t),getOffsetParent:t=>{let{element:n}=t;return af(n)},isElement:t=>Da(t),getDocumentElement:t=>{let{element:n}=t;return yi(n)},getClippingClientRect:t=>_k(t),getDimensions:t=>{let{element:n}=t;return Lg(n)},getClientRects:t=>{let{element:n}=t;return n.getClientRects()}},kk=(t,n,r)=>KS(t,n,{platform:Sk,...r});var Ck=Object.defineProperty,Tk=Object.defineProperties,Lk=Object.getOwnPropertyDescriptors,Ag=Object.getOwnPropertySymbols,Ek=Object.prototype.hasOwnProperty,Ak=Object.prototype.propertyIsEnumerable,Mg=(t,n,r)=>n in t?Ck(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,Nr=(t,n)=>{for(var r in n||(n={}))Ek.call(n,r)&&Mg(t,r,n[r]);if(Ag)for(var r of Ag(n))Ak.call(n,r)&&Mg(t,r,n[r]);return t},vl=(t,n)=>Tk(t,Lk(n));function f0(t,n){for(const r in n)Object.prototype.hasOwnProperty.call(n,r)&&(typeof n[r]=="object"&&t[r]?f0(t[r],n[r]):t[r]=n[r])}const ji={disabled:!1,distance:5,skidding:0,container:"body",boundary:void 0,instantMove:!1,disposeTimeout:5e3,popperTriggers:[],strategy:"absolute",preventOverflow:!0,flip:!0,shift:!0,overflowPadding:0,arrowPadding:0,arrowOverflow:!0,themes:{tooltip:{placement:"top",triggers:["hover","focus","touch"],hideTriggers:t=>[...t,"click"],delay:{show:200,hide:0},handleResize:!1,html:!1,loadingContent:"..."},dropdown:{placement:"bottom",triggers:["click"],delay:0,handleResize:!0,autoHide:!0},menu:{$extend:"dropdown",triggers:["hover","focus"],popperTriggers:["hover","focus"],delay:{show:0,hide:400}}}};function jo(t,n){let r=ji.themes[t]||{},o;do o=r[n],typeof o>"u"?r.$extend?r=ji.themes[r.$extend]||{}:(r=null,o=ji[n]):r=null;while(r);return o}function Mk(t){const n=[t];let r=ji.themes[t]||{};do r.$extend&&!r.$resetCss?(n.push(r.$extend),r=ji.themes[r.$extend]||{}):r=null;while(r);return n.map(o=>`v-popper--theme-${o}`)}let Go=!1;if(typeof window<"u"){Go=!1;try{const t=Object.defineProperty({},"passive",{get(){Go=!0}});window.addEventListener("test",null,t)}catch{}}let h0=!1;typeof window<"u"&&typeof navigator<"u"&&(h0=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream);const d0=["auto","top","bottom","left","right"].reduce((t,n)=>t.concat([n,`${n}-start`,`${n}-end`]),[]),Ng={hover:"mouseenter",focus:"focus",click:"click",touch:"touchstart"},Og={hover:"mouseleave",focus:"blur",click:"click",touch:"touchend"};function Nk(t,n){const r=t.indexOf(n);r!==-1&&t.splice(r,1)}function Nu(){return new Promise(t=>requestAnimationFrame(()=>{requestAnimationFrame(t)}))}const ur=[];let Co=null,cf=function(){};typeof window<"u"&&(cf=window.Element);function he(t){return function(n){return jo(n.theme,t)}}var p0=()=>re({name:"VPopper",props:{theme:{type:String,required:!0},targetNodes:{type:Function,required:!0},referenceNode:{type:Function,required:!0},popperNode:{type:Function,required:!0},shown:{type:Boolean,default:!1},showGroup:{type:String,default:null},ariaId:{default:null},disabled:{type:Boolean,default:he("disabled")},placement:{type:String,default:he("placement"),validator:t=>d0.includes(t)},delay:{type:[String,Number,Object],default:he("delay")},distance:{type:[Number,String],default:he("distance")},skidding:{type:[Number,String],default:he("skidding")},triggers:{type:Array,default:he("triggers")},showTriggers:{type:[Array,Function],default:he("showTriggers")},hideTriggers:{type:[Array,Function],default:he("hideTriggers")},popperTriggers:{type:Array,default:he("popperTriggers")},popperShowTriggers:{type:[Array,Function],default:he("popperShowTriggers")},popperHideTriggers:{type:[Array,Function],default:he("popperHideTriggers")},container:{type:[String,Object,cf,Boolean],default:he("container")},boundary:{type:[String,cf],default:he("boundary")},strategy:{type:String,validator:t=>["absolute","fixed"].includes(t),default:he("strategy")},autoHide:{type:Boolean,default:he("autoHide")},handleResize:{type:Boolean,default:he("handleResize")},instantMove:{type:Boolean,default:he("instantMove")},eagerMount:{type:Boolean,default:he("eagerMount")},popperClass:{type:[String,Array,Object],default:he("popperClass")},computeTransformOrigin:{type:Boolean,default:he("computeTransformOrigin")},autoMinSize:{type:Boolean,default:he("autoMinSize")},autoMaxSize:{type:Boolean,default:he("autoMaxSize")},preventOverflow:{type:Boolean,default:he("preventOverflow")},overflowPadding:{type:[Number,String],default:he("overflowPadding")},arrowPadding:{type:[Number,String],default:he("arrowPadding")},arrowOverflow:{type:Boolean,default:he("arrowOverflow")},flip:{type:Boolean,default:he("flip")},shift:{type:Boolean,default:he("shift")},shiftCrossAxis:{type:Boolean,default:he("shiftCrossAxis")}},emits:["show","hide","update:shown","apply-show","apply-hide","close-group","close-directive","auto-hide","resize","dispose"],data(){return{isShown:!1,isMounted:!1,skipTransition:!1,classes:{showFrom:!1,showTo:!1,hideFrom:!1,hideTo:!0},result:{x:0,y:0,placement:"",strategy:this.strategy,arrow:{x:0,y:0,centerOffset:0},transformOrigin:null}}},computed:{popperId(){return this.ariaId!=null?this.ariaId:this.randomId},shouldMountContent(){return this.eagerMount||this.isMounted},slotData(){return{popperId:this.popperId,isShown:this.isShown,shouldMountContent:this.shouldMountContent,skipTransition:this.skipTransition,autoHide:this.autoHide,show:this.show,hide:this.hide,handleResize:this.handleResize,onResize:this.onResize,classes:vl(Nr({},this.classes),{popperClass:this.popperClass}),result:this.result}}},watch:Nr({shown:"$_autoShowHide",disabled(t){t?this.dispose():this.init()},async container(){this.isShown&&(this.$_ensureTeleport(),await this.$_computePosition())},triggers(){this.$_isDisposed||(this.$_removeEventListeners(),this.$_addEventListeners())}},["placement","distance","skidding","boundary","strategy","overflowPadding","arrowPadding","preventOverflow","shift","shiftCrossAxis","flip"].reduce((t,n)=>(t[n]="$_computePosition",t),{})),created(){this.$_isDisposed=!0,this.randomId=`popper_${[Math.random(),Date.now()].map(t=>t.toString(36).substring(2,10)).join("_")}`},mounted(){this.init(),this.$_detachPopperNode()},activated(){this.$_autoShowHide()},deactivated(){this.hide()},beforeUnmount(){this.dispose()},methods:{show({event:t=null,skipDelay:n=!1,force:r=!1}={}){(r||!this.disabled)&&(this.$_scheduleShow(t,n),this.$emit("show"),this.$_showFrameLocked=!0,requestAnimationFrame(()=>{this.$_showFrameLocked=!1})),this.$emit("update:shown",!0)},hide({event:t=null,skipDelay:n=!1}={}){this.$_scheduleHide(t,n),this.$emit("hide"),this.$emit("update:shown",!1)},init(){!this.$_isDisposed||(this.$_isDisposed=!1,this.isMounted=!1,this.$_events=[],this.$_preventShow=!1,this.$_referenceNode=this.referenceNode(),this.$_targetNodes=this.targetNodes().filter(t=>t.nodeType===t.ELEMENT_NODE),this.$_popperNode=this.popperNode(),this.$_innerNode=this.$_popperNode.querySelector(".v-popper__inner"),this.$_arrowNode=this.$_popperNode.querySelector(".v-popper__arrow-container"),this.$_swapTargetAttrs("title","data-original-title"),this.$_detachPopperNode(),this.triggers.length&&this.$_addEventListeners(),this.shown&&this.show())},dispose(){this.$_isDisposed||(this.$_isDisposed=!0,this.$_removeEventListeners(),this.hide({skipDelay:!0}),this.$_detachPopperNode(),this.isMounted=!1,this.isShown=!1,this.$_swapTargetAttrs("data-original-title","title"),this.$emit("dispose"))},async onResize(){this.isShown&&(await this.$_computePosition(),this.$emit("resize"))},async $_computePosition(){var t;if(this.$_isDisposed)return;const n={strategy:this.strategy,middleware:[]};(this.distance||this.skidding)&&n.middleware.push(lk({mainAxis:this.distance,crossAxis:this.skidding}));const r=this.placement.startsWith("auto");r?n.middleware.push(rk({alignment:(t=this.placement.split("-")[1])!=null?t:""})):n.placement=this.placement,this.preventOverflow&&(this.shift&&n.middleware.push(ck({padding:this.overflowPadding,boundary:this.boundary,crossAxis:this.shiftCrossAxis})),!r&&this.flip&&n.middleware.push(ok({padding:this.overflowPadding,boundary:this.boundary}))),n.middleware.push(ZS({element:this.$_arrowNode,padding:this.arrowPadding})),this.arrowOverflow&&n.middleware.push({name:"arrowOverflow",fn:({placement:a,rects:u,middlewareData:f})=>{let h;const{centerOffset:d}=f.arrow;return a.startsWith("top")||a.startsWith("bottom")?h=Math.abs(d)>u.reference.width/2:h=Math.abs(d)>u.reference.height/2,{data:{overflow:h}}}}),this.autoMinSize&&n.middleware.push({name:"autoMinSize",fn:({rects:a,placement:u,middlewareData:f})=>{var h;if((h=f.autoMinSize)!=null&&h.skip)return{};let d,g;return u.startsWith("top")||u.startsWith("bottom")?d=a.reference.width:g=a.reference.height,this.$_innerNode.style.minWidth=d!=null?`${d}px`:null,this.$_innerNode.style.minHeight=g!=null?`${g}px`:null,{data:{skip:!0},reset:{rects:!0}}}}),this.autoMaxSize&&n.middleware.push(uk({boundary:this.boundary,padding:this.overflowPadding,apply:({width:a,height:u})=>{this.$_innerNode.style.maxWidth=a!=null?`${a}px`:null,this.$_innerNode.style.maxHeight=u!=null?`${u}px`:null}}));const o=await kk(this.$_referenceNode,this.$_popperNode,n);Object.assign(this.result,{x:o.x,y:o.y,placement:o.placement,strategy:o.strategy,arrow:Nr(Nr({},o.middlewareData.arrow),o.middlewareData.arrowOverflow)})},$_scheduleShow(t=null,n=!1){if(this.$_hideInProgress=!1,clearTimeout(this.$_scheduleTimer),Co&&this.instantMove&&Co.instantMove){Co.$_applyHide(!0),this.$_applyShow(!0);return}n?this.$_applyShow():this.$_scheduleTimer=setTimeout(this.$_applyShow.bind(this),this.$_computeDelay("show"))},$_scheduleHide(t=null,n=!1){this.$_hideInProgress=!0,clearTimeout(this.$_scheduleTimer),this.isShown&&(Co=this),n?this.$_applyHide():this.$_scheduleTimer=setTimeout(this.$_applyHide.bind(this),this.$_computeDelay("hide"))},$_computeDelay(t){const n=this.delay;return parseInt(n&&n[t]||n||0)},async $_applyShow(t=!1){clearTimeout(this.$_disposeTimer),clearTimeout(this.$_scheduleTimer),this.skipTransition=t,!this.isShown&&(this.$_ensureTeleport(),await Nu(),await this.$_computePosition(),await this.$_applyShowEffect())},async $_applyShowEffect(){if(this.$_hideInProgress)return;if(this.computeTransformOrigin){const n=this.$_referenceNode.getBoundingClientRect(),r=this.$_popperNode.querySelector(".v-popper__wrapper"),o=r.parentNode.getBoundingClientRect(),a=n.x+n.width/2-(o.left+r.offsetLeft),u=n.y+n.height/2-(o.top+r.offsetTop);this.result.transformOrigin=`${a}px ${u}px`}this.isShown=!0,this.$_applyAttrsToTarget({"aria-describedby":this.popperId,"data-popper-shown":""});const t=this.showGroup;if(t){let n;for(let r=0;r<ur.length;r++)n=ur[r],n.showGroup!==t&&(n.hide(),n.$emit("close-group"))}ur.push(this),this.$emit("apply-show"),this.classes.showFrom=!0,this.classes.showTo=!1,this.classes.hideFrom=!1,this.classes.hideTo=!1,await Nu(),this.classes.showFrom=!1,this.classes.showTo=!0},async $_applyHide(t=!1){if(clearTimeout(this.$_scheduleTimer),!this.isShown)return;this.skipTransition=t,Nk(ur,this),Co===this&&(Co=null),this.isShown=!1,this.$_applyAttrsToTarget({"aria-describedby":void 0,"data-popper-shown":void 0}),clearTimeout(this.$_disposeTimer);const n=jo(this.theme,"disposeTimeout");n!==null&&(this.$_disposeTimer=setTimeout(()=>{this.$_popperNode&&(this.$_detachPopperNode(),this.isMounted=!1)},n)),this.$emit("apply-hide"),this.classes.showFrom=!1,this.classes.showTo=!1,this.classes.hideFrom=!0,this.classes.hideTo=!1,await Nu(),this.classes.hideFrom=!1,this.classes.hideTo=!0},$_autoShowHide(){this.shown?this.show():this.hide()},$_ensureTeleport(){if(this.$_isDisposed)return;let t=this.container;if(typeof t=="string"?t=window.document.querySelector(t):t===!1&&(t=this.$_targetNodes[0].parentNode),!t)throw new Error("No container for popover: "+this.container);t.appendChild(this.$_popperNode),this.isMounted=!0},$_addEventListeners(){const t=(a,u,f)=>{this.$_events.push({targetNodes:a,eventType:u,handler:f}),a.forEach(h=>h.addEventListener(u,f,Go?{passive:!0}:void 0))},n=(a,u,f,h,d)=>{let g=f;h!=null&&(g=typeof h=="function"?h(g):h),g.forEach(v=>{const b=u[v];b&&t(a,b,d)})},r=a=>{this.isShown&&!this.$_hideInProgress||(a.usedByTooltip=!0,!this.$_preventShow&&this.show({event:a}))};n(this.$_targetNodes,Ng,this.triggers,this.showTriggers,r),n([this.$_popperNode],Ng,this.popperTriggers,this.popperShowTriggers,r);const o=a=>{a.usedByTooltip||this.hide({event:a})};n(this.$_targetNodes,Og,this.triggers,this.hideTriggers,o),n([this.$_popperNode],Og,this.popperTriggers,this.popperHideTriggers,o),t([...za(this.$_referenceNode),...za(this.$_popperNode)],"scroll",()=>{this.$_computePosition()})},$_removeEventListeners(){this.$_events.forEach(({targetNodes:t,eventType:n,handler:r})=>{t.forEach(o=>o.removeEventListener(n,r))}),this.$_events=[]},$_handleGlobalClose(t,n=!1){this.$_showFrameLocked||(this.hide({event:t}),t.closePopover?this.$emit("close-directive"):this.$emit("auto-hide"),n&&(this.$_preventShow=!0,setTimeout(()=>{this.$_preventShow=!1},300)))},$_detachPopperNode(){this.$_popperNode.parentNode&&this.$_popperNode.parentNode.removeChild(this.$_popperNode)},$_swapTargetAttrs(t,n){for(const r of this.$_targetNodes){const o=r.getAttribute(t);o&&(r.removeAttribute(t),r.setAttribute(n,o))}},$_applyAttrsToTarget(t){for(const n of this.$_targetNodes)for(const r in t){const o=t[r];o==null?n.removeAttribute(r):n.setAttribute(r,o)}}},render(){return this.$slots.default(this.slotData)}});typeof document<"u"&&typeof window<"u"&&(h0?(document.addEventListener("touchstart",Pg,Go?{passive:!0,capture:!0}:!0),document.addEventListener("touchend",Pk,Go?{passive:!0,capture:!0}:!0)):(window.addEventListener("mousedown",Pg,!0),window.addEventListener("click",Ok,!0)),window.addEventListener("resize",$k));function Pg(t){for(let n=0;n<ur.length;n++){const r=ur[n],o=r.popperNode();r.$_mouseDownContains=o.contains(t.target)}}function Ok(t){g0(t)}function Pk(t){g0(t,!0)}function g0(t,n=!1){for(let r=0;r<ur.length;r++){const o=ur[r],a=o.popperNode(),u=o.$_mouseDownContains||a.contains(t.target);requestAnimationFrame(()=>{(t.closeAllPopover||t.closePopover&&u||o.autoHide&&!u)&&o.$_handleGlobalClose(t,n)})}}function $k(t){for(let n=0;n<ur.length;n++)ur[n].$_computePosition(t)}function Dk(){var t=window.navigator.userAgent,n=t.indexOf("MSIE ");if(n>0)return parseInt(t.substring(n+5,t.indexOf(".",n)),10);var r=t.indexOf("Trident/");if(r>0){var o=t.indexOf("rv:");return parseInt(t.substring(o+3,t.indexOf(".",o)),10)}var a=t.indexOf("Edge/");return a>0?parseInt(t.substring(a+5,t.indexOf(".",a)),10):-1}let wa;function uf(){uf.init||(uf.init=!0,wa=Dk()!==-1)}var mc={name:"ResizeObserver",props:{emitOnMount:{type:Boolean,default:!1},ignoreWidth:{type:Boolean,default:!1},ignoreHeight:{type:Boolean,default:!1}},emits:["notify"],mounted(){uf(),Qo(()=>{this._w=this.$el.offsetWidth,this._h=this.$el.offsetHeight,this.emitOnMount&&this.emitSize()});const t=document.createElement("object");this._resizeObject=t,t.setAttribute("aria-hidden","true"),t.setAttribute("tabindex",-1),t.onload=this.addResizeHandlers,t.type="text/html",wa&&this.$el.appendChild(t),t.data="about:blank",wa||this.$el.appendChild(t)},beforeUnmount(){this.removeResizeHandlers()},methods:{compareAndNotify(){(!this.ignoreWidth&&this._w!==this.$el.offsetWidth||!this.ignoreHeight&&this._h!==this.$el.offsetHeight)&&(this._w=this.$el.offsetWidth,this._h=this.$el.offsetHeight,this.emitSize())},emitSize(){this.$emit("notify",{width:this._w,height:this._h})},addResizeHandlers(){this._resizeObject.contentDocument.defaultView.addEventListener("resize",this.compareAndNotify),this.compareAndNotify()},removeResizeHandlers(){this._resizeObject&&this._resizeObject.onload&&(!wa&&this._resizeObject.contentDocument&&this._resizeObject.contentDocument.defaultView.removeEventListener("resize",this.compareAndNotify),this.$el.removeChild(this._resizeObject),this._resizeObject.onload=null,this._resizeObject=null)}}};const Rk=c1();wm("data-v-b329ee4c");const zk={class:"resize-observer",tabindex:"-1"};xm();const Ik=Rk((t,n,r,o,a,u)=>(at(),Qt("div",zk)));mc.render=Ik;mc.__scopeId="data-v-b329ee4c";mc.__file="src/components/ResizeObserver.vue";var v0={computed:{themeClass(){return Mk(this.theme)}}},ih=(t,n)=>{const r=t.__vccOpts||t;for(const[o,a]of n)r[o]=a;return r};const Fk=re({name:"VPopperContent",components:{ResizeObserver:mc},mixins:[v0],props:{popperId:String,theme:String,shown:Boolean,mounted:Boolean,skipTransition:Boolean,autoHide:Boolean,handleResize:Boolean,classes:Object,result:Object},emits:["hide","resize"],methods:{toPx(t){return t!=null&&!isNaN(t)?`${t}px`:null}}}),qk=["id","aria-hidden","tabindex","data-popper-placement"],Hk={ref:"inner",class:"v-popper__inner"},Bk=ht("div",{class:"v-popper__arrow-outer"},null,-1),Wk=ht("div",{class:"v-popper__arrow-inner"},null,-1),Uk=[Bk,Wk];function jk(t,n,r,o,a,u){const f=Vi("ResizeObserver");return at(),Et("div",{id:t.popperId,ref:"popover",class:ve(["v-popper__popper",[t.themeClass,t.classes.popperClass,{"v-popper__popper--shown":t.shown,"v-popper__popper--hidden":!t.shown,"v-popper__popper--show-from":t.classes.showFrom,"v-popper__popper--show-to":t.classes.showTo,"v-popper__popper--hide-from":t.classes.hideFrom,"v-popper__popper--hide-to":t.classes.hideTo,"v-popper__popper--skip-transition":t.skipTransition,"v-popper__popper--arrow-overflow":t.result.arrow.overflow}]]),style:kn({position:t.result.strategy,transform:`translate3d(${Math.round(t.result.x)}px,${Math.round(t.result.y)}px,0)`}),"aria-hidden":t.shown?"false":"true",tabindex:t.autoHide?0:void 0,"data-popper-placement":t.result.placement,onKeyup:n[1]||(n[1]=tf(h=>t.autoHide&&t.$emit("hide"),["esc"]))},[ht("div",{class:"v-popper__wrapper",style:kn({transformOrigin:t.result.transformOrigin})},[ht("div",Hk,[t.mounted?(at(),Et(ce,{key:0},[ht("div",null,[Yn(t.$slots,"default")]),t.handleResize?(at(),Qt(f,{key:0,onNotify:n[0]||(n[0]=h=>t.$emit("resize",h))})):le("",!0)],64)):le("",!0)],512),ht("div",{ref:"arrow",class:"v-popper__arrow-container",style:kn({left:t.toPx(t.result.arrow.x),top:t.toPx(t.result.arrow.y)})},Uk,4)],4)],46,qk)}var m0=ih(Fk,[["render",jk]]),y0={methods:{show(...t){return this.$refs.popper.show(...t)},hide(...t){return this.$refs.popper.hide(...t)},dispose(...t){return this.$refs.popper.dispose(...t)},onResize(...t){return this.$refs.popper.onResize(...t)}}};const Gk=re({name:"VPopperWrapper",components:{Popper:p0(),PopperContent:m0},mixins:[y0,v0],inheritAttrs:!1,props:{theme:{type:String,default:null}},computed:{finalTheme(){var t;return(t=this.theme)!=null?t:this.$options.vPopperTheme},popperAttrs(){const t=Nr({},this.$attrs);return delete t.class,delete t.style,t}},methods:{getTargetNodes(){return Array.from(this.$refs.reference.children).filter(t=>t!==this.$refs.popperContent.$el)}}});function Vk(t,n,r,o,a,u){const f=Vi("PopperContent"),h=Vi("Popper");return at(),Qt(h,di({ref:"popper"},t.popperAttrs,{theme:t.finalTheme,"target-nodes":t.getTargetNodes,"reference-node":()=>t.$refs.reference,"popper-node":()=>t.$refs.popperContent.$el}),{default:Zt(({popperId:d,isShown:g,shouldMountContent:v,skipTransition:b,autoHide:w,show:S,hide:M,handleResize:A,onResize:E,classes:T,result:L})=>[ht("div",{ref:"reference",class:ve(["v-popper",[t.$attrs.class,t.themeClass,{"v-popper--shown":g}]]),style:kn(t.$attrs.style)},[Yn(t.$slots,"default",{shown:g,show:S,hide:M}),zt(f,{ref:"popperContent","popper-id":d,theme:t.finalTheme,shown:g,mounted:v,"skip-transition":b,"auto-hide":w,"handle-resize":A,classes:T,result:L,onHide:M,onResize:E},{default:Zt(()=>[Yn(t.$slots,"popper",{shown:g,hide:M})]),_:2},1032,["popper-id","theme","shown","mounted","skip-transition","auto-hide","handle-resize","classes","result","onHide","onResize"])],6)]),_:3},16,["theme","target-nodes","reference-node","popper-node"])}var oh=ih(Gk,[["render",Vk]]);const $g=re(vl(Nr({},oh),{name:"VDropdown",vPopperTheme:"dropdown"})),Dg=re(vl(Nr({},oh),{name:"VMenu",vPopperTheme:"menu"})),Rg=re(vl(Nr({},oh),{name:"VTooltip",vPopperTheme:"tooltip"})),Kk=re({name:"VTooltipDirective",components:{Popper:p0(),PopperContent:m0},mixins:[y0],inheritAttrs:!1,props:{theme:{type:String,default:"tooltip"},html:{type:Boolean,default:t=>jo(t.theme,"html")},content:{type:[String,Number,Function],default:null},loadingContent:{type:String,default:t=>jo(t.theme,"loadingContent")}},data(){return{asyncContent:null}},computed:{isContentAsync(){return typeof this.content=="function"},loading(){return this.isContentAsync&&this.asyncContent==null},finalContent(){return this.isContentAsync?this.loading?this.loadingContent:this.asyncContent:this.content}},watch:{content:{handler(){this.fetchContent(!0)},immediate:!0},async finalContent(){await this.$nextTick(),this.$refs.popper.onResize()}},created(){this.$_fetchId=0},methods:{fetchContent(t){if(typeof this.content=="function"&&this.$_isShown&&(t||!this.$_loading&&this.asyncContent==null)){this.asyncContent=null,this.$_loading=!0;const n=++this.$_fetchId,r=this.content(this);r.then?r.then(o=>this.onResult(n,o)):this.onResult(n,r)}},onResult(t,n){t===this.$_fetchId&&(this.$_loading=!1,this.asyncContent=n)},onShow(){this.$_isShown=!0,this.fetchContent()},onHide(){this.$_isShown=!1}}}),Xk=["innerHTML"],Yk=["textContent"];function Zk(t,n,r,o,a,u){const f=Vi("PopperContent"),h=Vi("Popper");return at(),Qt(h,di({ref:"popper"},t.$attrs,{theme:t.theme,"popper-node":()=>t.$refs.popperContent.$el,onApplyShow:t.onShow,onApplyHide:t.onHide}),{default:Zt(({popperId:d,isShown:g,shouldMountContent:v,skipTransition:b,autoHide:w,hide:S,handleResize:M,onResize:A,classes:E,result:T})=>[zt(f,{ref:"popperContent",class:ve({"v-popper--tooltip-loading":t.loading}),"popper-id":d,theme:t.theme,shown:g,mounted:v,"skip-transition":b,"auto-hide":w,"handle-resize":M,classes:E,result:T,onHide:S,onResize:A},{default:Zt(()=>[t.html?(at(),Et("div",{key:0,innerHTML:t.finalContent},null,8,Xk)):(at(),Et("div",{key:1,textContent:Xt(t.finalContent)},null,8,Yk))]),_:2},1032,["class","popper-id","theme","shown","mounted","skip-transition","auto-hide","handle-resize","classes","result","onHide","onResize"])]),_:1},16,["theme","popper-node","onApplyShow","onApplyHide"])}var Jk=ih(Kk,[["render",Zk]]);const b0="v-popper--has-tooltip";function Qk(t,n){let r=t.placement;if(!r&&n)for(const o of d0)n[o]&&(r=o);return r||(r=jo(t.theme||"tooltip","placement")),r}function w0(t,n,r){let o;const a=typeof n;return a==="string"?o={content:n}:n&&a==="object"?o=n:o={content:!1},o.placement=Qk(o,r),o.targetNodes=()=>[t],o.referenceNode=()=>t,o}let Ou,rl,tC=0;function eC(){if(Ou)return;rl=Kt([]),Ou=Vm({name:"VTooltipDirectiveApp",setup(){return{directives:rl}},render(){return this.directives.map(n=>pl(Jk,vl(Nr({},n.options),{shown:n.shown.value||n.options.shown,key:n.id})))},devtools:{hide:!0}});const t=document.createElement("div");document.body.appendChild(t),Ou.mount(t)}function x0(t,n,r){eC();const o=Kt(w0(t,n,r)),a=Kt(!1),u={id:tC++,options:o,shown:a};return rl.value.push(u),t.classList&&t.classList.add(b0),t.$_popper={options:o,item:u,show(){a.value=!0},hide(){a.value=!1}}}function sh(t){if(t.$_popper){const n=rl.value.indexOf(t.$_popper.item);n!==-1&&rl.value.splice(n,1),delete t.$_popper,delete t.$_popperOldShown,delete t.$_popperMountTarget}t.classList&&t.classList.remove(b0)}function zg(t,{value:n,oldValue:r,modifiers:o}){const a=w0(t,n,o);if(!a.content||jo(a.theme||"tooltip","disabled"))sh(t);else{let u;t.$_popper?(u=t.$_popper,u.options.value=a):u=x0(t,n,o),typeof n.shown<"u"&&n.shown!==t.$_popperOldShown&&(t.$_popperOldShown=n.shown,n.shown?u.show():u.hide())}}var _0={beforeMount:zg,updated:zg,beforeUnmount(t){sh(t)}};function Ig(t){t.addEventListener("click",S0),t.addEventListener("touchstart",k0,Go?{passive:!0}:!1)}function Fg(t){t.removeEventListener("click",S0),t.removeEventListener("touchstart",k0),t.removeEventListener("touchend",C0),t.removeEventListener("touchcancel",T0)}function S0(t){const n=t.currentTarget;t.closePopover=!n.$_vclosepopover_touch,t.closeAllPopover=n.$_closePopoverModifiers&&!!n.$_closePopoverModifiers.all}function k0(t){if(t.changedTouches.length===1){const n=t.currentTarget;n.$_vclosepopover_touch=!0;const r=t.changedTouches[0];n.$_vclosepopover_touchPoint=r,n.addEventListener("touchend",C0),n.addEventListener("touchcancel",T0)}}function C0(t){const n=t.currentTarget;if(n.$_vclosepopover_touch=!1,t.changedTouches.length===1){const r=t.changedTouches[0],o=n.$_vclosepopover_touchPoint;t.closePopover=Math.abs(r.screenY-o.screenY)<20&&Math.abs(r.screenX-o.screenX)<20,t.closeAllPopover=n.$_closePopoverModifiers&&!!n.$_closePopoverModifiers.all}}function T0(t){const n=t.currentTarget;n.$_vclosepopover_touch=!1}var nC={beforeMount(t,{value:n,modifiers:r}){t.$_closePopoverModifiers=r,(typeof n>"u"||n)&&Ig(t)},updated(t,{value:n,oldValue:r,modifiers:o}){t.$_closePopoverModifiers=o,n!==r&&(typeof n>"u"||n?Ig(t):Fg(t))},beforeUnmount(t){Fg(t)}};const rC=_0;function iC(t,n={}){t.$_vTooltipInstalled||(t.$_vTooltipInstalled=!0,f0(ji,n),t.directive("tooltip",_0),t.directive("close-popper",nC),t.component("v-tooltip",Rg),t.component("VTooltip",Rg),t.component("v-dropdown",$g),t.component("VDropdown",$g),t.component("v-menu",Dg),t.component("VMenu",Dg))}const L0={version:"2.0.0-y.0",install:iC,options:ji};var qg;const E0=typeof window<"u",oC=t=>typeof t<"u",A0=t=>typeof t=="function",sC=t=>typeof t=="string",Vo=()=>{};E0&&((qg=window==null?void 0:window.navigator)==null?void 0:qg.userAgent)&&/iP(ad|hone|od)/.test(window.navigator.userAgent);function Ki(t){return typeof t=="function"?t():j(t)}function lh(t,n){function r(...o){return new Promise((a,u)=>{Promise.resolve(t(()=>n.apply(this,o),{fn:n,thisArg:this,args:o})).then(a).catch(u)})}return r}const M0=t=>t();function N0(t,n={}){let r,o,a=Vo;const u=h=>{clearTimeout(h),a(),a=Vo};return h=>{const d=Ki(t),g=Ki(n.maxWait);return r&&u(r),d<=0||g!==void 0&&g<=0?(o&&(u(o),o=null),Promise.resolve(h())):new Promise((v,b)=>{a=n.rejectOnCancel?b:v,g&&!o&&(o=setTimeout(()=>{r&&u(r),o=null,v(h())},g)),r=setTimeout(()=>{o&&u(o),o=null,v(h())},d)})}}function lC(t,n=!0,r=!0,o=!1){let a=0,u,f=!0,h=Vo,d;const g=()=>{u&&(clearTimeout(u),u=void 0,h(),h=Vo)};return b=>{const w=Ki(t),S=Date.now()-a,M=()=>d=b();if(g(),w<=0)return a=Date.now(),M();if(S>w&&(r||!f))a=Date.now(),M();else if(n)return new Promise((A,E)=>{h=o?E:A,u=setTimeout(()=>{a=Date.now(),f=!0,A(M()),g()},w-S)});return!r&&!u&&(u=setTimeout(()=>f=!0,w)),f=!1,d}}function aC(t=M0){const n=Kt(!0);function r(){n.value=!1}function o(){n.value=!0}return{isActive:n,pause:r,resume:o,eventFilter:(...u)=>{n.value&&t(...u)}}}function cC(t){return t}function ah(t){return kx()?(Cx(t),!0):!1}function Hg(t,n=200,r={}){return lh(N0(n,r),t)}function uC(t,n=200,r=!1,o=!0,a=!1){return lh(lC(n,r,o,a),t)}function fC(t,n=200,r=!0,o=!0){if(n<=0)return t;const a=Kt(t.value),u=uC(()=>{a.value=t.value},n,r,o);return Fe(t,()=>u()),a}function hC(t){return typeof t=="function"?_t(t):Kt(t)}function ch(t,n=!0){cc()?dl(t):n?t():Qo(t)}function dC(t=!1,n={}){const{truthyValue:r=!0,falsyValue:o=!1}=n,a=Ee(t),u=Kt(t);function f(h){if(arguments.length)return u.value=h,u.value;{const d=Ki(r);return u.value=u.value===d?Ki(o):d,u.value}}return a?f:[u,f]}var Bg=Object.getOwnPropertySymbols,pC=Object.prototype.hasOwnProperty,gC=Object.prototype.propertyIsEnumerable,vC=(t,n)=>{var r={};for(var o in t)pC.call(t,o)&&n.indexOf(o)<0&&(r[o]=t[o]);if(t!=null&&Bg)for(var o of Bg(t))n.indexOf(o)<0&&gC.call(t,o)&&(r[o]=t[o]);return r};function O0(t,n,r={}){const o=r,{eventFilter:a=M0}=o,u=vC(o,["eventFilter"]);return Fe(t,lh(a,n),u)}var mC=Object.defineProperty,yC=Object.defineProperties,bC=Object.getOwnPropertyDescriptors,Ia=Object.getOwnPropertySymbols,P0=Object.prototype.hasOwnProperty,$0=Object.prototype.propertyIsEnumerable,Wg=(t,n,r)=>n in t?mC(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,wC=(t,n)=>{for(var r in n||(n={}))P0.call(n,r)&&Wg(t,r,n[r]);if(Ia)for(var r of Ia(n))$0.call(n,r)&&Wg(t,r,n[r]);return t},xC=(t,n)=>yC(t,bC(n)),_C=(t,n)=>{var r={};for(var o in t)P0.call(t,o)&&n.indexOf(o)<0&&(r[o]=t[o]);if(t!=null&&Ia)for(var o of Ia(t))n.indexOf(o)<0&&$0.call(t,o)&&(r[o]=t[o]);return r};function SC(t,n,r={}){const o=r,{debounce:a=0,maxWait:u=void 0}=o,f=_C(o,["debounce","maxWait"]);return O0(t,n,xC(wC({},f),{eventFilter:N0(a,{maxWait:u})}))}function kC(t,n,r){const o=Fe(t,(...a)=>(Qo(()=>o()),n(...a)),r)}var CC=Object.defineProperty,TC=Object.defineProperties,LC=Object.getOwnPropertyDescriptors,Fa=Object.getOwnPropertySymbols,D0=Object.prototype.hasOwnProperty,R0=Object.prototype.propertyIsEnumerable,Ug=(t,n,r)=>n in t?CC(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,EC=(t,n)=>{for(var r in n||(n={}))D0.call(n,r)&&Ug(t,r,n[r]);if(Fa)for(var r of Fa(n))R0.call(n,r)&&Ug(t,r,n[r]);return t},AC=(t,n)=>TC(t,LC(n)),MC=(t,n)=>{var r={};for(var o in t)D0.call(t,o)&&n.indexOf(o)<0&&(r[o]=t[o]);if(t!=null&&Fa)for(var o of Fa(t))n.indexOf(o)<0&&R0.call(t,o)&&(r[o]=t[o]);return r};function z0(t,n,r={}){const o=r,{eventFilter:a}=o,u=MC(o,["eventFilter"]),{eventFilter:f,pause:h,resume:d,isActive:g}=aC(a);return{stop:O0(t,n,AC(EC({},u),{eventFilter:f})),pause:h,resume:d,isActive:g}}function NC(t,n,r){let o;Ee(r)?o={evaluating:r}:o=r||{};const{lazy:a=!1,evaluating:u=void 0,onError:f=Vo}=o,h=Kt(!a),d=Kt(n);let g=0;return Vf(async v=>{if(!h.value)return;g++;const b=g;let w=!1;u&&Promise.resolve().then(()=>{u.value=!0});try{const S=await t(M=>{v(()=>{u&&(u.value=!1),w||M()})});b===g&&(d.value=S)}catch(S){f(S)}finally{u&&b===g&&(u.value=!1),w=!0}}),a?_t(()=>(h.value=!0,d.value)):d}function I0(t){var n;const r=Ki(t);return(n=r==null?void 0:r.$el)!=null?n:r}const dr=E0?window:void 0;function Ko(...t){let n,r,o,a;if(sC(t[0])||Array.isArray(t[0])?([r,o,a]=t,n=dr):[n,r,o,a]=t,!n)return Vo;Array.isArray(r)||(r=[r]),Array.isArray(o)||(o=[o]);const u=[],f=()=>{u.forEach(v=>v()),u.length=0},h=(v,b,w)=>(v.addEventListener(b,w,a),()=>v.removeEventListener(b,w,a)),d=Fe(()=>I0(n),v=>{f(),v&&u.push(...r.flatMap(b=>o.map(w=>h(v,b,w))))},{immediate:!0,flush:"post"}),g=()=>{d(),f()};return ah(g),g}const OC=t=>typeof t=="function"?t:typeof t=="string"?n=>n.key===t:Array.isArray(t)?n=>t.includes(n.key):()=>!0;function PC(...t){let n,r,o={};t.length===3?(n=t[0],r=t[1],o=t[2]):t.length===2?typeof t[1]=="object"?(n=!0,r=t[0],o=t[1]):(n=t[0],r=t[1]):(n=!0,r=t[0]);const{target:a=dr,eventName:u="keydown",passive:f=!1}=o,h=OC(n);return Ko(a,u,g=>{h(g)&&r(g)},f)}function F0(t,n=!1){const r=Kt(),o=()=>r.value=Boolean(t());return o(),ch(o,n),r}function $C(t,n={}){const{window:r=dr}=n,o=F0(()=>r&&"matchMedia"in r&&typeof r.matchMedia=="function");let a;const u=Kt(!1),f=()=>{!a||("removeEventListener"in a?a.removeEventListener("change",h):a.removeListener(h))},h=()=>{!o.value||(f(),a=r.matchMedia(hC(t).value),u.value=a.matches,"addEventListener"in a?a.addEventListener("change",h):a.addListener(h))};return Vf(h),ah(()=>f()),u}function DC(t){return JSON.parse(JSON.stringify(t))}const ff=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},hf="__vueuse_ssr_handlers__";ff[hf]=ff[hf]||{};const RC=ff[hf];function q0(t,n){return RC[t]||n}function zC(t){return t==null?"any":t instanceof Set?"set":t instanceof Map?"map":t instanceof Date?"date":typeof t=="boolean"?"boolean":typeof t=="string"?"string":typeof t=="object"?"object":Number.isNaN(t)?"any":"number"}var IC=Object.defineProperty,jg=Object.getOwnPropertySymbols,FC=Object.prototype.hasOwnProperty,qC=Object.prototype.propertyIsEnumerable,Gg=(t,n,r)=>n in t?IC(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,Vg=(t,n)=>{for(var r in n||(n={}))FC.call(n,r)&&Gg(t,r,n[r]);if(jg)for(var r of jg(n))qC.call(n,r)&&Gg(t,r,n[r]);return t};const HC={boolean:{read:t=>t==="true",write:t=>String(t)},object:{read:t=>JSON.parse(t),write:t=>JSON.stringify(t)},number:{read:t=>Number.parseFloat(t),write:t=>String(t)},any:{read:t=>t,write:t=>String(t)},string:{read:t=>t,write:t=>String(t)},map:{read:t=>new Map(JSON.parse(t)),write:t=>JSON.stringify(Array.from(t.entries()))},set:{read:t=>new Set(JSON.parse(t)),write:t=>JSON.stringify(Array.from(t))},date:{read:t=>new Date(t),write:t=>t.toISOString()}};function BC(t,n,r,o={}){var a;const{flush:u="pre",deep:f=!0,listenToStorageChanges:h=!0,writeDefaults:d=!0,mergeDefaults:g=!1,shallow:v,window:b=dr,eventFilter:w,onError:S=rt=>{console.error(rt)}}=o,M=(v?fl:Kt)(n);if(!r)try{r=q0("getDefaultStorage",()=>{var rt;return(rt=dr)==null?void 0:rt.localStorage})()}catch(rt){S(rt)}if(!r)return M;const A=Ki(n),E=zC(A),T=(a=o.serializer)!=null?a:HC[E],{pause:L,resume:$}=z0(M,()=>P(M.value),{flush:u,deep:f,eventFilter:w});return b&&h&&Ko(b,"storage",V),V(),M;function P(rt){try{if(rt==null)r.removeItem(t);else{const J=T.write(rt),dt=r.getItem(t);dt!==J&&(r.setItem(t,J),b&&(b==null||b.dispatchEvent(new StorageEvent("storage",{key:t,oldValue:dt,newValue:J,storageArea:r}))))}}catch(J){S(J)}}function G(rt){const J=rt?rt.newValue:r.getItem(t);if(J==null)return d&&A!==null&&r.setItem(t,T.write(A)),A;if(!rt&&g){const dt=T.read(J);return A0(g)?g(dt,A):E==="object"&&!Array.isArray(dt)?Vg(Vg({},A),dt):dt}else return typeof J!="string"?J:T.read(J)}function V(rt){if(!(rt&&rt.storageArea!==r)){if(rt&&rt.key==null){M.value=A;return}if(!(rt&&rt.key!==t)){L();try{M.value=G(rt)}catch(J){S(J)}finally{rt?Qo($):$()}}}}}function H0(t){return $C("(prefers-color-scheme: dark)",t)}var WC=Object.defineProperty,Kg=Object.getOwnPropertySymbols,UC=Object.prototype.hasOwnProperty,jC=Object.prototype.propertyIsEnumerable,Xg=(t,n,r)=>n in t?WC(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,GC=(t,n)=>{for(var r in n||(n={}))UC.call(n,r)&&Xg(t,r,n[r]);if(Kg)for(var r of Kg(n))jC.call(n,r)&&Xg(t,r,n[r]);return t};function VC(t={}){const{selector:n="html",attribute:r="class",initialValue:o="auto",window:a=dr,storage:u,storageKey:f="vueuse-color-scheme",listenToStorageChanges:h=!0,storageRef:d,emitAuto:g}=t,v=GC({auto:"",light:"light",dark:"dark"},t.modes||{}),b=H0({window:a}),w=_t(()=>b.value?"dark":"light"),S=d||(f==null?Kt(o):BC(f,o,u,{window:a,listenToStorageChanges:h})),M=_t({get(){return S.value==="auto"&&!g?w.value:S.value},set(L){S.value=L}}),A=q0("updateHTMLAttrs",(L,$,P)=>{const G=a==null?void 0:a.document.querySelector(L);if(!!G)if($==="class"){const V=P.split(/\s/g);Object.values(v).flatMap(rt=>(rt||"").split(/\s/g)).filter(Boolean).forEach(rt=>{V.includes(rt)?G.classList.add(rt):G.classList.remove(rt)})}else G.setAttribute($,P)});function E(L){var $;const P=L==="auto"?w.value:L;A(n,r,($=v[P])!=null?$:P)}function T(L){t.onChanged?t.onChanged(L,E):E(L)}return Fe(M,T,{flush:"post",immediate:!0}),g&&Fe(w,()=>T(M.value),{flush:"post"}),ch(()=>T(M.value)),M}var KC=Object.defineProperty,XC=Object.defineProperties,YC=Object.getOwnPropertyDescriptors,Yg=Object.getOwnPropertySymbols,ZC=Object.prototype.hasOwnProperty,JC=Object.prototype.propertyIsEnumerable,Zg=(t,n,r)=>n in t?KC(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,QC=(t,n)=>{for(var r in n||(n={}))ZC.call(n,r)&&Zg(t,r,n[r]);if(Yg)for(var r of Yg(n))JC.call(n,r)&&Zg(t,r,n[r]);return t},tT=(t,n)=>XC(t,YC(n));function eT(t={}){const{valueDark:n="dark",valueLight:r="",window:o=dr}=t,a=VC(tT(QC({},t),{onChanged:(h,d)=>{var g;t.onChanged?(g=t.onChanged)==null||g.call(t,h==="dark"):d(h)},modes:{dark:n,light:r}})),u=H0({window:o});return _t({get(){return a.value==="dark"},set(h){h===u.value?a.value="auto":a.value=h?"dark":"light"}})}var Jg=Object.getOwnPropertySymbols,nT=Object.prototype.hasOwnProperty,rT=Object.prototype.propertyIsEnumerable,iT=(t,n)=>{var r={};for(var o in t)nT.call(t,o)&&n.indexOf(o)<0&&(r[o]=t[o]);if(t!=null&&Jg)for(var o of Jg(t))n.indexOf(o)<0&&rT.call(t,o)&&(r[o]=t[o]);return r};function oT(t,n,r={}){const o=r,{window:a=dr}=o,u=iT(o,["window"]);let f;const h=F0(()=>a&&"ResizeObserver"in a),d=()=>{f&&(f.disconnect(),f=void 0)},g=Fe(()=>I0(t),b=>{d(),h.value&&a&&b&&(f=new ResizeObserver(n),f.observe(b,u))},{immediate:!0,flush:"post"}),v=()=>{d(),g()};return ah(v),{isSupported:h,stop:v}}var Qg;(function(t){t.UP="UP",t.RIGHT="RIGHT",t.DOWN="DOWN",t.LEFT="LEFT",t.NONE="NONE"})(Qg||(Qg={}));var sT=Object.defineProperty,tv=Object.getOwnPropertySymbols,lT=Object.prototype.hasOwnProperty,aT=Object.prototype.propertyIsEnumerable,ev=(t,n,r)=>n in t?sT(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,cT=(t,n)=>{for(var r in n||(n={}))lT.call(n,r)&&ev(t,r,n[r]);if(tv)for(var r of tv(n))aT.call(n,r)&&ev(t,r,n[r]);return t};const uT={easeInSine:[.12,0,.39,0],easeOutSine:[.61,1,.88,1],easeInOutSine:[.37,0,.63,1],easeInQuad:[.11,0,.5,0],easeOutQuad:[.5,1,.89,1],easeInOutQuad:[.45,0,.55,1],easeInCubic:[.32,0,.67,0],easeOutCubic:[.33,1,.68,1],easeInOutCubic:[.65,0,.35,1],easeInQuart:[.5,0,.75,0],easeOutQuart:[.25,1,.5,1],easeInOutQuart:[.76,0,.24,1],easeInQuint:[.64,0,.78,0],easeOutQuint:[.22,1,.36,1],easeInOutQuint:[.83,0,.17,1],easeInExpo:[.7,0,.84,0],easeOutExpo:[.16,1,.3,1],easeInOutExpo:[.87,0,.13,1],easeInCirc:[.55,0,1,.45],easeOutCirc:[0,.55,.45,1],easeInOutCirc:[.85,0,.15,1],easeInBack:[.36,0,.66,-.56],easeOutBack:[.34,1.56,.64,1],easeInOutBack:[.68,-.6,.32,1.6]};cT({linear:cC},uT);function fT(t="history",n={}){const{initialValue:r={},removeNullishValues:o=!0,removeFalsyValues:a=!1,write:u=!0,window:f=dr}=n;if(!f)return On(r);const h=On({});function d(){if(t==="history")return f.location.search||"";if(t==="hash"){const T=f.location.hash||"",L=T.indexOf("?");return L>0?T.slice(L):""}else return(f.location.hash||"").replace(/^#/,"")}function g(T){const L=T.toString();if(t==="history")return`${L?`?${L}`:""}${f.location.hash||""}`;if(t==="hash-params")return`${f.location.search||""}${L?`#${L}`:""}`;const $=f.location.hash||"#",P=$.indexOf("?");return P>0?`${$.slice(0,P)}${L?`?${L}`:""}`:`${$}${L?`?${L}`:""}`}function v(){return new URLSearchParams(d())}function b(T){const L=new Set(Object.keys(h));for(const $ of T.keys()){const P=T.getAll($);h[$]=P.length>1?P:T.get($)||"",L.delete($)}Array.from(L).forEach($=>delete h[$])}const{pause:w,resume:S}=z0(h,()=>{const T=new URLSearchParams("");Object.keys(h).forEach(L=>{const $=h[L];Array.isArray($)?$.forEach(P=>T.append(L,P)):o&&$==null||a&&!$?T.delete(L):T.set(L,$)}),M(T)},{deep:!0});function M(T,L){w(),L&&b(T),f.history.replaceState(f.history.state,f.document.title,f.location.pathname+g(T)),S()}function A(){!u||M(v(),!0)}Ko(f,"popstate",A,!1),t!=="history"&&Ko(f,"hashchange",A,!1);const E=v();return E.keys().next().value?b(E):Object.assign(h,r),h}function hT(t,n,r,o={}){var a,u,f;const{clone:h=!1,passive:d=!1,eventName:g,deep:v=!1,defaultValue:b}=o,w=cc(),S=r||(w==null?void 0:w.emit)||((a=w==null?void 0:w.$emit)==null?void 0:a.bind(w))||((f=(u=w==null?void 0:w.proxy)==null?void 0:u.$emit)==null?void 0:f.bind(w==null?void 0:w.proxy));let M=g;n||(n="modelValue"),M=g||M||`update:${n.toString()}`;const A=T=>h?A0(h)?h(T):DC(T):T,E=()=>oC(t[n])?A(t[n]):b;if(d){const T=E(),L=Kt(T);return Fe(()=>t[n],$=>L.value=A($)),Fe(L,$=>{($!==t[n]||v)&&S(M,$)},{deep:v}),L}else return _t({get(){return E()},set(T){S(M,T)}})}function dT(t={}){const{window:n=dr,initialWidth:r=1/0,initialHeight:o=1/0,listenOrientation:a=!0,includeScrollbar:u=!0}=t,f=Kt(r),h=Kt(o),d=()=>{n&&(u?(f.value=n.innerWidth,h.value=n.innerHeight):(f.value=n.document.documentElement.clientWidth,h.value=n.document.documentElement.clientHeight))};return d(),ch(d),Ko("resize",d,{passive:!0}),a&&Ko("orientationchange",d,{passive:!0}),{width:f,height:h}}const pT=6e4;function gT(t,n){const{post:r,on:o,eventNames:a=[],serialize:u=v=>v,deserialize:f=v=>v,timeout:h=pT}=n,d=new Map,g=new Proxy({},{get(v,b){const w=(...M)=>{r(u({m:b,a:M,t:"q"}))};if(a.includes(b))return w.asEvent=w,w;const S=(...M)=>new Promise((A,E)=>{const T=mT();d.set(T,{resolve:A,reject:E}),r(u({m:b,a:M,i:T,t:"q"})),h>=0&&setTimeout(()=>{E(new Error(`[birpc] timeout on calling "${b}"`)),d.delete(T)},h)});return S.asEvent=w,S}});return o(async(v,...b)=>{const w=f(v);if(w.t==="q"){const{m:S,a:M}=w;let A,E;try{A=await t[S].apply(g,M)}catch(T){E=T}w.i&&r(u({t:"s",i:w.i,r:A,e:E}),...b)}else{const{i:S,r:M,e:A}=w,E=d.get(S);A?E==null||E.reject(A):E==null||E.resolve(M),d.delete(S)}}),g}const vT="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";function mT(t=21){let n="",r=t;for(;r--;)n+=vT[Math.random()*64|0];return n}const{parse:yT,stringify:bT}=JSON,{keys:wT}=Object,il=String,B0="string",nv={},qa="object",W0=(t,n)=>n,xT=t=>t instanceof il?il(t):t,_T=(t,n)=>typeof n===B0?new il(n):n,U0=(t,n,r,o)=>{const a=[];for(let u=wT(r),{length:f}=u,h=0;h<f;h++){const d=u[h],g=r[d];if(g instanceof il){const v=t[g];typeof v===qa&&!n.has(v)?(n.add(v),r[d]=nv,a.push({k:d,a:[t,n,v,o]})):r[d]=o.call(r,d,v)}else r[d]!==nv&&(r[d]=o.call(r,d,g))}for(let{length:u}=a,f=0;f<u;f++){const{k:h,a:d}=a[f];r[h]=o.call(r,h,U0.apply(null,d))}return r},rv=(t,n,r)=>{const o=il(n.push(r)-1);return t.set(r,o),o},j0=(t,n)=>{const r=yT(t,_T).map(xT),o=r[0],a=n||W0,u=typeof o===qa&&o?U0(r,new Set,o,a):o;return a.call({"":u},"",u)},ST=(t,n,r)=>{const o=n&&typeof n===qa?(v,b)=>v===""||-1<n.indexOf(v)?b:void 0:n||W0,a=new Map,u=[],f=[];let h=+rv(a,u,o.call({"":t},"",t)),d=!h;for(;h<u.length;)d=!0,f[h]=bT(u[h++],g,r);return"["+f.join(",")+"]";function g(v,b){if(d)return d=!d,b;const w=o.call(this,v,b);switch(typeof w){case qa:if(w===null)return w;case B0:return a.get(w)||rv(a,u,w)}return w}},kT=t=>typeof AggregateError<"u"&&t instanceof AggregateError?!0:t instanceof Error&&"errors"in t;class G0{constructor(){Ni(this,"filesMap",new Map);Ni(this,"pathsSet",new Set);Ni(this,"collectingPromise");Ni(this,"idMap",new Map);Ni(this,"taskFileMap",new WeakMap);Ni(this,"errorsSet",new Set)}catchError(n,r){if(kT(n))return n.errors.forEach(o=>this.catchError(o,r));n.type=r,this.errorsSet.add(n)}clearErrors(){this.errorsSet.clear()}getUnhandledErrors(){return Array.from(this.errorsSet.values())}getPaths(){return Array.from(this.pathsSet)}getFiles(n){return n?n.map(r=>this.filesMap.get(r)).filter(Boolean):Array.from(this.filesMap.values())}getFilepaths(){return Array.from(this.filesMap.keys())}getFailedFilepaths(){return this.getFiles().filter(n=>{var r;return((r=n.result)==null?void 0:r.state)==="fail"}).map(n=>n.filepath)}collectPaths(n=[]){n.forEach(r=>{this.pathsSet.add(r)})}collectFiles(n=[]){n.forEach(r=>{this.filesMap.set(r.filepath,r),this.updateId(r)})}clearFiles(n=[]){n.forEach(r=>{this.filesMap.delete(r)})}updateId(n){this.idMap.get(n.id)!==n&&(this.idMap.set(n.id,n),n.type==="suite"&&n.tasks.forEach(r=>{this.updateId(r)}))}updateTasks(n){for(const[r,o]of n)this.idMap.has(r)&&(this.idMap.get(r).result=o)}updateUserLog(n){const r=n.taskId&&this.idMap.get(n.taskId);r&&(r.logs||(r.logs=[]),r.logs.push(n))}}function V0(t){return t==null&&(t=[]),Array.isArray(t)?t:[t]}var Xi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function df(t){return t.type==="test"||t.type==="custom"}function K0(t){return V0(t).flatMap(n=>df(n)?[n]:n.tasks.flatMap(r=>df(r)?[r]:K0(r)))}function uh(t=[]){return V0(t).flatMap(n=>df(n)?[n]:[n,...uh(n.tasks)])}function CT(t){const n=[t.name];let r=t;for(;(r==null?void 0:r.suite)||(r==null?void 0:r.file);)r=r.suite||r.file,r!=null&&r.name&&n.unshift(r.name);return n}function yc(t){return K0(t).some(n=>{var r,o;return(o=(r=n.result)==null?void 0:r.errors)==null?void 0:o.some(a=>a.message.match(/Snapshot .* mismatched/))})}function TT(t,n={}){const{handlers:r={},autoReconnect:o=!0,reconnectInterval:a=2e3,reconnectTries:u=10,reactive:f=T=>T,WebSocketConstructor:h=globalThis.WebSocket}=n;let d=u;const g=f({ws:new h(t),state:new G0,waitForConnection:E,reconnect:M});g.state.filesMap=f(g.state.filesMap),g.state.idMap=f(g.state.idMap);let v;const b={onPathsCollected(T){var L;g.state.collectPaths(T),(L=r.onPathsCollected)==null||L.call(r,T)},onCollected(T){var L;g.state.collectFiles(T),(L=r.onCollected)==null||L.call(r,T)},onTaskUpdate(T){var L;g.state.updateTasks(T),(L=r.onTaskUpdate)==null||L.call(r,T)},onUserConsoleLog(T){g.state.updateUserLog(T)},onFinished(T){var L;(L=r.onFinished)==null||L.call(r,T)}},w={post:T=>g.ws.send(T),on:T=>v=T,serialize:ST,deserialize:j0};g.rpc=gT(b,w);let S;function M(T=!1){T&&(d=u),g.ws=new h(t),A()}function A(){S=new Promise(T=>{g.ws.addEventListener("open",()=>{d=u,T()})}),g.ws.addEventListener("message",T=>{v(T.data)}),g.ws.addEventListener("close",()=>{d-=1,o&&d>0&&setTimeout(M,a)})}A();function E(){return S}return g}const X0=fT("hash-params",{initialValue:{file:"",view:null}}),Mr=Bf(X0,"file"),lr=Bf(X0,"view"),LT=()=>{},To=()=>Promise.resolve();function ET(){const t=On({state:new G0,waitForConnection:f,reconnect:a,ws:new EventTarget});t.state.filesMap=On(t.state.filesMap),t.state.idMap=On(t.state.idMap);let n;const r={getFiles:()=>n.files,getPaths:async()=>n.paths,getConfig:()=>n.config,getModuleGraph:async h=>n.moduleGraph[h],getTransformResult:async h=>({code:h,source:""}),readFile:async h=>Promise.resolve(h),onWatcherStart:To,onFinished:To,onCollected:To,onTaskUpdate:LT,writeFile:To,rerun:To,updateSnapshot:To};t.rpc=r;let o;function a(){u()}async function u(){const h=await fetch(window.METADATA_PATH);n=j0(await h.text());const d=new Event("open");t.ws.dispatchEvent(d)}u();function f(){return o}return t}const AT=location.port,MT=[location.hostname,AT].filter(Boolean).join(":"),NT=`${location.protocol==="https:"?"wss:":"ws:"}//${MT}/__vitest_api__`,Ir=!!window.METADATA_PATH,Ha=Kt("idle"),Ue=function(){return Ir?ET():TT(NT,{reactive:On,handlers:{onTaskUpdate(){Ha.value="running"},onFinished(){Ha.value="idle"}}})}(),Y0=fl({}),Hi=Kt("CONNECTING"),Tn=_t(()=>Ue.state.getFiles()),Le=_t(()=>Tn.value.find(t=>t.id===Mr.value)),Z0=_t(()=>uh(Le.value).map(t=>(t==null?void 0:t.logs)||[]).flat()||[]),Ba=t=>Tn.value.find(n=>n.id===t),OT=_t(()=>Hi.value==="OPEN"),Pu=_t(()=>Hi.value==="CONNECTING");_t(()=>Hi.value==="CLOSED");function iv(t=Ue.state.getFiles()){return J0(t)}function J0(t){return t.forEach(n=>{delete n.result,uh(n).forEach(r=>delete r.result)}),Ue.rpc.rerun(t.map(n=>n.filepath))}function PT(){if(Le.value)return J0([Le.value])}Fe(()=>Ue.ws,t=>{Hi.value=Ir?"OPEN":"CONNECTING",t.addEventListener("open",async()=>{Hi.value="OPEN",Ue.state.filesMap.clear();const[n,r]=await Promise.all([Ue.rpc.getFiles(),Ue.rpc.getConfig()]);Ue.state.collectFiles(n),Y0.value=r}),t.addEventListener("close",()=>{setTimeout(()=>{Hi.value==="CONNECTING"&&(Hi.value="CLOSED")},1e3)})},{immediate:!0});const $T={"text-2xl":""},DT=ht("div",{"text-lg":"",op50:""}," Check your terminal or start a new server with `vitest --ui` ",-1),RT=re({__name:"ConnectionOverlay",setup(t){return(n,r)=>j(OT)?le("",!0):(at(),Et("div",{key:0,fixed:"","inset-0":"",p2:"","z-10":"","select-none":"",text:"center sm",bg:"overlay","backdrop-blur-sm":"","backdrop-saturate-0":"",onClick:r[0]||(r[0]=(...o)=>j(Ue).reconnect&&j(Ue).reconnect(...o))},[ht("div",{"h-full":"",flex:"~ col gap-2","items-center":"","justify-center":"",class:ve(j(Pu)?"animate-pulse":"")},[ht("div",{text:"5xl",class:ve(j(Pu)?"i-carbon:renew animate-spin animate-reverse":"i-carbon-wifi-off")},null,2),ht("div",$T,Xt(j(Pu)?"Connecting...":"Disconnected"),1),DT],2)]))}});function bi(){}bi.prototype={diff:function(n,r){var o=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},a=o.callback;typeof o=="function"&&(a=o,o={}),this.options=o;var u=this;function f(A){return a?(setTimeout(function(){a(void 0,A)},0),!0):A}n=this.castInput(n),r=this.castInput(r),n=this.removeEmpty(this.tokenize(n)),r=this.removeEmpty(this.tokenize(r));var h=r.length,d=n.length,g=1,v=h+d;o.maxEditLength&&(v=Math.min(v,o.maxEditLength));var b=[{newPos:-1,components:[]}],w=this.extractCommon(b[0],r,n,0);if(b[0].newPos+1>=h&&w+1>=d)return f([{value:this.join(r),count:r.length}]);function S(){for(var A=-1*g;A<=g;A+=2){var E=void 0,T=b[A-1],L=b[A+1],$=(L?L.newPos:0)-A;T&&(b[A-1]=void 0);var P=T&&T.newPos+1<h,G=L&&0<=$&&$<d;if(!P&&!G){b[A]=void 0;continue}if(!P||G&&T.newPos<L.newPos?(E=IT(L),u.pushComponent(E.components,void 0,!0)):(E=T,E.newPos++,u.pushComponent(E.components,!0,void 0)),$=u.extractCommon(E,r,n,A),E.newPos+1>=h&&$+1>=d)return f(zT(u,E.components,r,n,u.useLongestToken));b[A]=E}g++}if(a)(function A(){setTimeout(function(){if(g>v)return a();S()||A()},0)})();else for(;g<=v;){var M=S();if(M)return M}},pushComponent:function(n,r,o){var a=n[n.length-1];a&&a.added===r&&a.removed===o?n[n.length-1]={count:a.count+1,added:r,removed:o}:n.push({count:1,added:r,removed:o})},extractCommon:function(n,r,o,a){for(var u=r.length,f=o.length,h=n.newPos,d=h-a,g=0;h+1<u&&d+1<f&&this.equals(r[h+1],o[d+1]);)h++,d++,g++;return g&&n.components.push({count:g}),n.newPos=h,d},equals:function(n,r){return this.options.comparator?this.options.comparator(n,r):n===r||this.options.ignoreCase&&n.toLowerCase()===r.toLowerCase()},removeEmpty:function(n){for(var r=[],o=0;o<n.length;o++)n[o]&&r.push(n[o]);return r},castInput:function(n){return n},tokenize:function(n){return n.split("")},join:function(n){return n.join("")}};function zT(t,n,r,o,a){for(var u=0,f=n.length,h=0,d=0;u<f;u++){var g=n[u];if(g.removed){if(g.value=t.join(o.slice(d,d+g.count)),d+=g.count,u&&n[u-1].added){var b=n[u-1];n[u-1]=n[u],n[u]=b}}else{if(!g.added&&a){var v=r.slice(h,h+g.count);v=v.map(function(S,M){var A=o[d+M];return A.length>S.length?A:S}),g.value=t.join(v)}else g.value=t.join(r.slice(h,h+g.count));h+=g.count,g.added||(d+=g.count)}}var w=n[f-1];return f>1&&typeof w.value=="string"&&(w.added||w.removed)&&t.equals("",w.value)&&(n[f-2].value+=w.value,n.pop()),n}function IT(t){return{newPos:t.newPos,components:t.components.slice(0)}}var ov=/^[A-Za-z\xC0-\u02C6\u02C8-\u02D7\u02DE-\u02FF\u1E00-\u1EFF]+$/,sv=/\S/,Q0=new bi;Q0.equals=function(t,n){return this.options.ignoreCase&&(t=t.toLowerCase(),n=n.toLowerCase()),t===n||this.options.ignoreWhitespace&&!sv.test(t)&&!sv.test(n)};Q0.tokenize=function(t){for(var n=t.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/),r=0;r<n.length-1;r++)!n[r+1]&&n[r+2]&&ov.test(n[r])&&ov.test(n[r+2])&&(n[r]+=n[r+2],n.splice(r+1,2),r--);return n};var fh=new bi;fh.tokenize=function(t){var n=[],r=t.split(/(\n|\r\n)/);r[r.length-1]||r.pop();for(var o=0;o<r.length;o++){var a=r[o];o%2&&!this.options.newlineIsToken?n[n.length-1]+=a:(this.options.ignoreWhitespace&&(a=a.trim()),n.push(a))}return n};function FT(t,n,r){return fh.diff(t,n,r)}var qT=new bi;qT.tokenize=function(t){return t.split(/(\S.+?[.!?])(?=\s+|$)/)};var HT=new bi;HT.tokenize=function(t){return t.split(/([{}:;,]|\s+)/)};function xa(t){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?xa=function(n){return typeof n}:xa=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},xa(t)}function $u(t){return BT(t)||WT(t)||UT(t)||jT()}function BT(t){if(Array.isArray(t))return pf(t)}function WT(t){if(typeof Symbol<"u"&&Symbol.iterator in Object(t))return Array.from(t)}function UT(t,n){if(!!t){if(typeof t=="string")return pf(t,n);var r=Object.prototype.toString.call(t).slice(8,-1);if(r==="Object"&&t.constructor&&(r=t.constructor.name),r==="Map"||r==="Set")return Array.from(t);if(r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r))return pf(t,n)}}function pf(t,n){(n==null||n>t.length)&&(n=t.length);for(var r=0,o=new Array(n);r<n;r++)o[r]=t[r];return o}function jT(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var GT=Object.prototype.toString,ol=new bi;ol.useLongestToken=!0;ol.tokenize=fh.tokenize;ol.castInput=function(t){var n=this.options,r=n.undefinedReplacement,o=n.stringifyReplacer,a=o===void 0?function(u,f){return typeof f>"u"?r:f}:o;return typeof t=="string"?t:JSON.stringify(gf(t,null,null,a),a,"  ")};ol.equals=function(t,n){return bi.prototype.equals.call(ol,t.replace(/,([\r\n])/g,"$1"),n.replace(/,([\r\n])/g,"$1"))};function gf(t,n,r,o,a){n=n||[],r=r||[],o&&(t=o(a,t));var u;for(u=0;u<n.length;u+=1)if(n[u]===t)return r[u];var f;if(GT.call(t)==="[object Array]"){for(n.push(t),f=new Array(t.length),r.push(f),u=0;u<t.length;u+=1)f[u]=gf(t[u],n,r,o,a);return n.pop(),r.pop(),f}if(t&&t.toJSON&&(t=t.toJSON()),xa(t)==="object"&&t!==null){n.push(t),f={},r.push(f);var h=[],d;for(d in t)t.hasOwnProperty(d)&&h.push(d);for(h.sort(),u=0;u<h.length;u+=1)d=h[u],f[d]=gf(t[d],n,r,o,d);n.pop(),r.pop()}else f=t;return f}var vf=new bi;vf.tokenize=function(t){return t.slice()};vf.join=vf.removeEmpty=function(t){return t};function VT(t,n,r,o,a,u,f){f||(f={}),typeof f.context>"u"&&(f.context=4);var h=FT(r,o,f);if(!h)return;h.push({value:"",lines:[]});function d(T){return T.map(function(L){return" "+L})}for(var g=[],v=0,b=0,w=[],S=1,M=1,A=function(L){var $=h[L],P=$.lines||$.value.replace(/\n$/,"").split(`
`);if($.lines=P,$.added||$.removed){var G;if(!v){var V=h[L-1];v=S,b=M,V&&(w=f.context>0?d(V.lines.slice(-f.context)):[],v-=w.length,b-=w.length)}(G=w).push.apply(G,$u(P.map(function(z){return($.added?"+":"-")+z}))),$.added?M+=P.length:S+=P.length}else{if(v)if(P.length<=f.context*2&&L<h.length-2){var rt;(rt=w).push.apply(rt,$u(d(P)))}else{var J,dt=Math.min(P.length,f.context);(J=w).push.apply(J,$u(d(P.slice(0,dt))));var gt={oldStart:v,oldLines:S-v+dt,newStart:b,newLines:M-b+dt,lines:w};if(L>=h.length-2&&P.length<=f.context){var kt=/\n$/.test(r),ut=/\n$/.test(o),U=P.length==0&&w.length>gt.oldLines;!kt&&U&&r.length>0&&w.splice(gt.oldLines,0,"\\ No newline at end of file"),(!kt&&!U||!ut)&&w.push("\\ No newline at end of file")}g.push(gt),v=0,b=0,w=[]}S+=P.length,M+=P.length}},E=0;E<h.length;E++)A(E);return{oldFileName:t,newFileName:n,oldHeader:a,newHeader:u,hunks:g}}function KT(t){var n=[];t.oldFileName==t.newFileName&&n.push("Index: "+t.oldFileName),n.push("==================================================================="),n.push("--- "+t.oldFileName+(typeof t.oldHeader>"u"?"":"	"+t.oldHeader)),n.push("+++ "+t.newFileName+(typeof t.newHeader>"u"?"":"	"+t.newHeader));for(var r=0;r<t.hunks.length;r++){var o=t.hunks[r];o.oldLines===0&&(o.oldStart-=1),o.newLines===0&&(o.newStart-=1),n.push("@@ -"+o.oldStart+","+o.oldLines+" +"+o.newStart+","+o.newLines+" @@"),n.push.apply(n,o.lines)}return n.join(`
`)+`
`}function XT(t,n,r,o,a,u,f){return KT(VT(t,n,r,o,a,u,f))}function YT(t,n,r,o,a,u){return XT(t,t,n,r,o,a,u)}function aa(t,n){return t.slice(0,n)+(t.length>n?"…":"")}function ZT(t,n,r={}){if(t===n)return"";const{outputTruncateLength:o=80,outputDiffLines:a,showLegend:u=!0}=r,f="  ",h=a||15,d={"+":0,"-":0};let g=null,v=0;function b(E){if(!E||E.match(/\\ No newline/))return;const T=E[0];if("-+".includes(T)){if(g!==T&&(g=T,v=0),v++,d[T]++,v===h)return`${T} ...`;if(v>h)return}return E}const S=YT("string",n,t).split(`
